...
export default function TradeWarsPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col relative overflow-hidden">
      ...
      <img src={assetUrl("art/special-maps/special-trade-empire-routes.png")} alt="" className="absolute inset-0 w-full h-full object-cover pointer-events-none" style={{ opacity: 0.1, filter: "brightness(0.3) saturate(0.6)" }} />
