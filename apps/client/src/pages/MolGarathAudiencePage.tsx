  ...
  return (
    ...
    >
      ...
      <main className="max-w-3xl mx-auto">
        ...
        <div
          className="rounded-lg border border-stone-700/40 bg-stone-950/30 p-8 cursor-pointer select-none"
          onClick={advance}
          role="button"
          tabIndex={0}
          onKeyDown={(e) => {
          ...
          {!done ? (
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-lg leading-relaxed text-zinc-100 whitespace-pre-line">
                  {cue.text}
                </p>
              </motion.div>
            </AnimatePresence>
...
function AudienceUnlocks() {
  return (
    <div className="mt-8 space-y-4">
      ...
      <div className="rounded-lg border border-stone-700/30 bg-stone-950/40 p-4">
