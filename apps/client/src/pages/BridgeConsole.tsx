    ...
    <div className="min-h-screen animate-fade-in pb-20">
      ...
      <div className="px-4 mb-5">
        ...
        <button
          ...
          className="w-full p-4 rounded border void-bg-canvas border-primary/40 hover:bg-primary/10 transition text-left"
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="font-serif text-base void-text mb-1">
                {state.narrativeFlags?.act_1_complete
                  ? "Casual match"
                  : "Continue Act 1"}
              </p>
              <p className="font-mono text-[10px] void-text tracking-wide">
                {state.narrativeFlags?.act_1_complete
