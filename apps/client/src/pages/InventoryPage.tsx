...
export default function InventoryPage() {
  ...
  if (!isAuthenticated) {
    return (
      ...
      <LivingBackground src="https://dgrsart.s3.us-east-2.amazonaws.com/cdn/client-public/page-backgrounds/INV-001_cargo-hold.jpg" accent="var(--energy-accent)" opacity={0.13} particleCount={4} scanlines={false} />
