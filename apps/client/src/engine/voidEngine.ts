...
const THEMES: Record<string, VoidTheme> = {
  ...
  singularity_core: {
    ...
    palette: {
      ...
      premium: "var(--energy-premium)", system: "#ff4080",
  ...
  crimson_forge: {
    ...
    palette: {
      ...
      accent: "#f87171", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
  ...
  circuit_nexus: {
    ...
    palette: {
      ...
      accent: "#c084fc", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
  ...
  chrome_sentinel: {
    ...
    palette: {
      ...
      accent: "#cbd5e1", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
  ...
  industrial_accent: {
    ...
    palette: {
      ...
      accent: "#a8a29e", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
  ...
  twilight_equilibrium: {
    ...
    palette: {
      canvas: "var(--bg-void)", surface: "#060830", elevated: "#0c1040",
      sunk: "#000018", spotlight: "#101448",
      text: "#e2e8f0", textDim: "#e2e8f0b0", textMuted: "#e2e8f060",
      primary: "var(--energy-primary)", primaryMuted: "var(--energy-primary)40", secondary: "#06b6d4",
      accent: "var(--energy-premium)", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
      border: "var(--energy-primary)20", borderSubtle: "var(--energy-primary)10", glow: "var(--energy-primary)30",
    },
    particleEffect: "data",
  },
  ...
  verdant_growth: {
    ...
    palette: {
      ...
      primary: "var(--energy-success)", primaryMuted: "var(--energy-success)40", secondary: "#16a34a",
      accent: "#4ade80", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
      border: "var(--energy-success)20", borderSubtle: "var(--energy-success)10", glow: "var(--energy-success)30",
    },
  ...
  golden_sanctuary: {
    ...
    palette: {
      ...
      text: "var(--energy-accent)", textDim: "var(--energy-accent)b0", textMuted: "var(--energy-accent)60",
      primary: "var(--energy-accent)", primaryMuted: "var(--energy-accent)40", secondary: "#d97706",
      accent: "#fbbf24", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
      border: "var(--energy-accent)20", borderSubtle: "var(--energy-accent)10", glow: "var(--energy-accent)30",
    },
  ...
  aurora_bloom: {
    ...
    palette: {
      ...
      accent: "#f0abfc", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
  ...
  celestial_garden: {
    ...
    palette: {
      ...
      accent: "#7dd3fc", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
  ...
  ascendant_light: {
    ...
    palette: {
      ...
      primary: "#fbbf24", primaryMuted: "#fbbf2440", secondary: "var(--energy-accent)",
      accent: "var(--energy-accent)", success: "var(--energy-success)", error: "var(--energy-error)",
      premium: "var(--energy-premium)", system: "var(--energy-system)",
