...
const DISCOVERY_VIDEOS: Record<string, DiscoveryVideoEntry> = {
  ...
  "entity_5": {
    videoUrl: assetUrl("videos/epochs/epoch-0/ep02-the-meme.mp4"),
    title: "THE MEME",
  ...
  "entity_23": {
    videoUrl: assetUrl("videos/epochs/epoch-0/ep04-iron-lion.mp4"),
    title: "IRON LION",
  ...
  "entity_24": {
    videoUrl: assetUrl("videos/epochs/epoch-0/ep03-agent-zero.mp4"),
    title: "AGENT ZERO",
  ...
  "entity_22": {
    videoUrl: assetUrl("videos/epochs/epoch-0/ep05-the-spy.mp4"),
    title: "THE EYES",
  ...
  "entity_50": {
    videoUrl: assetUrl("videos/epochs/epoch-0/ep07-the-oracle.mp4"),
    title: "THE ORACLE",
