...
export const MORALITY_TIERS: MoralityTierDef[] = [
  { minScore: -100, maxScore: -80, label: "Machine Ascendant", side: "machine", level: 5, color: "var(--energy-error)", glowColor: "color-mix(in oklch, var(--energy-error) 40%, transparent)", icon: Cpu, description: "You have fully embraced the cold logic of the Machine. Emotion is weakness. Efficiency is truth.", bonuses: ["+25% card draw efficiency", "Machine Overlord ship theme", "Crimson Circuit character aura", "Access to Terminus Protocol items"] },
  ...
  { minScore: -19, maxScore: 19, label: "Balanced", side: "balanced", level: 1, color: "#a855f7", glowColor: "color-mix(in oklch, var(--energy-system) 30%, transparent)", icon: Shield, description: "You walk the line between Machine and Humanity, drawing from both without committing to either.", bonuses: ["+5% to all stats", "Twilight Equilibrium ship theme"] },
  ...
  { minScore: 40, maxScore: 59, label: "Humanity Aligned", side: "humanity", level: 3, color: "var(--energy-success)", glowColor: "color-mix(in oklch, var(--energy-success) 40%, transparent)", icon: Heart, description: "Empathy and connection define your path. The organic spark matters more than cold efficiency.", bonuses: ["+15% Dream Token earnings", "Living Garden ship theme", "Emerald Pulse character effect"] },
  { minScore: 60, maxScore: 79, label: "Humanity Devoted", side: "humanity", level: 4, color: "#3b82f6", glowColor: "color-mix(in oklch, var(--electric-blue) 40%, transparent)", icon: Sparkles, description: "You champion the cause of all organic life. The Machine's order is a cage to be broken.", bonuses: ["+20% fight damage vs Machine", "Celestial Dawn ship theme", "Azure Radiance character aura"] },
