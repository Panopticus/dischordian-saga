...
const ITEM_DATABASE: Record<string, ItemMeta> = {
  ...
  "darren-fessler-artifact": {
    name: "Darren Fessler's Folded Scrap",
    description: "A small folded square of paper taken from a personal-effects drawer in the medical bay. The label on the drawer read D. FESSLER · MAINT. Folded edges, no decoration, no seal — and on every scanner Elara has tried, the paper isn't there at all.",
    elaraAnalysis: "The scrap is in your inventory and I cannot see it. That's the point. Darren Fessler was a maintenance technician — long enough ago that the personnel records have his designation but not his story. He had a habit, the Antiquarian's marginalia says, of writing his meaningful sentences in places the indexing layer would never see. The Shadow Tongue is an indexing doctrine; it can only subtract what it can locate. The scrap is locatable to you, and you alone, by hand. That is what we needed. Bring it to the bridge — the war table's brass plate. Don't unfold it.",
    category: "artifact",
    dangerLevel: "low",
    relatedEntities: ["Darren Fessler", "The Shadow Tongue", "Elara", "The Antiquarian"],
    loreExcerpt: "ANTIQUARIAN MARGINALIA — D. FESSLER ENTRY (PARTIAL)\n\n\"Maintenance tech, Ark 1047, era pre-Severance. Resisted by being unindexable from the start. His meaningful sentences were buried under indexable noise; the Shadow Tongue could not subtract what it could not locate. The principle is generalizable: anyone who structures their meaning so that the meaning is not in the indexing layer is editable only with violence. The Director does not use violence — the doctrine forbids force. Therefore, anyone whose meaning lives outside the indexing layer is, in practice, beyond the Director's reach.\n\nFessler left scraps in drawers, in service panels, in the back covers of manuals. Most of them have decayed. A handful — folded, unread, and physically held — persist. They survive because no system can name them.\n\nThe scrap is not a key. It is a fact the doctrine cannot edit. Used correctly, it stabilizes a substrate that the doctrine has been editing. Used incorrectly, it stabilizes nothing — but neither is it consumed. It is, in this respect, kinder than most artifacts.\"\n\n— A.",
  },
  "captains-final-log": {
