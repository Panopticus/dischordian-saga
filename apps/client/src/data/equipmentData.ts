...
export const RARITY_COLORS: Record<EquipRarity, {
  ...
  rare: {
    ...
    bg: "void-bg-sunk",
    border: "void-border",
    glow: "color-mix(in oklch, var(--electric-blue) 40%, transparent)",
    label: "Rare",
  },
  epic: {
    text: "void-text-system",
    bg: "void-bg-system",
    border: "void-border-system",
    glow: "color-mix(in oklch, var(--energy-system) 40%, transparent)",
    label: "Epic",
  },
  legendary: {
    ...
    bg: "void-bg-sunk",
    border: "void-border",
    glow: "color-mix(in oklch, var(--energy-accent) 50%, transparent)",
    label: "Legendary",
  },
};
...
export const SPECIES_VISUALS: Record<Species, {
  ...
  neyon: {
    ...
    glowColor: "color-mix(in oklch, var(--energy-accent) 50%, transparent)",
    eyeColor: "#fbbf24",
    skinTone: "#c4a882",
...
export const EQUIPMENT_DB: EquipmentItem[] = [
  ...
  { id: "circuit_vest", name: "Circuit Vest", slot: "armor", rarity: "uncommon", stats: { def: 3, hp: 10 }, visualKey: "armor_circuit", glowColor: "var(--energy-primary)", description: "Lightweight armor woven with conductive fibers.", craftTier: 1, source: "craft" },
  ...
  { id: "architects_gauntlet", name: "Architect's Gauntlet", slot: "weapon", rarity: "rare", stats: { atk: 8, def: 2 }, visualKey: "gauntlet_architect", glowColor: "var(--energy-error)", description: "Power gauntlet modeled after The Architect's own design.", craftTier: 2, source: "craft" },
  ...
  // ── EPIC CRAFTABLE GEAR ──
  { id: "crown_of_echoes", name: "Crown of Echoes", slot: "helm", rarity: "epic", stats: { def: 6, hp: 15, atk: 3 }, visualKey: "helm_echoes", glowColor: "var(--energy-accent)", description: "Crown that channels the voices of fallen warriors.", craftTier: 3, source: "craft" },
  ...
  { id: "dreamers_edge", name: "Dreamer's Edge", slot: "weapon", rarity: "epic", stats: { atk: 12, speed: 2 }, visualKey: "blade_dreamer", glowColor: "var(--energy-success)", description: "A blade that cuts through reality itself, forged in the Dreamer's vision.", craftTier: 3, source: "craft" },
  ...
  { id: "architects_crown", name: "The Architect's Crown", slot: "helm", rarity: "legendary", stats: { def: 10, hp: 25, atk: 5, speed: 3 }, visualKey: "helm_architect", glowColor: "var(--energy-error)", description: "The crown of the supreme intelligence. Grants unparalleled tactical awareness.", source: "achievement" },
  { id: "dreamers_mantle", name: "The Dreamer's Mantle", slot: "armor", rarity: "legendary", stats: { def: 15, hp: 50, speed: 5 }, visualKey: "armor_dreamer", glowColor: "var(--energy-success)", description: "Woven from pure dream energy. The Dreamer's own protective garment.", source: "achievement" },
  { id: "iron_lions_mace", name: "Iron Lion's Mace", slot: "weapon", rarity: "legendary", stats: { atk: 18, def: 5 }, visualKey: "mace_iron_lion", glowColor: "var(--energy-accent)", description: "The legendary weapon of Iron Lion, imbued with the strength of a thousand warriors.", source: "achievement" },
  ...
  { id: "collectors_blade", name: "Collector's Blade", slot: "weapon", rarity: "uncommon", stats: { atk: 7 }, visualKey: "blade_collector", glowColor: "var(--energy-error)", description: "Taken from a defeated champion in the Collector's Arena.", source: "drop" },
  { id: "warlords_pauldron", name: "Warlord's Pauldron", slot: "armor", rarity: "uncommon", stats: { def: 4, hp: 8 }, visualKey: "armor_warlord", glowColor: "var(--energy-error)", description: "Shoulder armor from a fallen warlord.", source: "drop" },
