...
export const WELCOME_TO_CELEBRATION_FRAMES: SlideshowFrame[] = [
  {
    imageSrc: "/art/celebration/celebration-town-square.png",
    lyric: "Welcome to Celebration, where dreams don't always shine",
    durationMs: 6000,
  },
  {
    imageSrc: "/art/celebration/celebration-schoolhouse.png",
    lyric: "Step lightly, wander carefully, and watch for every sign",
    durationMs: 5500,
  },
  {
    imageSrc: "/art/celebration/celebration-chorus-pavilion.png",
    lyric: "The Mascoteers are waiting, but be careful where you tread",
    durationMs: 5500,
  },
  {
    imageSrc: "/art/celebration/celebration-eye-garden.png",
    lyric: "Not every game is just for fun, not every word is said",
    durationMs: 5500,
  },
  {
    imageSrc: "/art/celebration/celebration-trading-jars.png",
  ...
  {
    imageSrc: "/art/celebration/celebration-by-night.png",
