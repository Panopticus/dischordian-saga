...
export const DIFFICULTY_COLORS: Record<ConexusGame["difficulty"], string> = {
  beginner: "void-text-energy void-border-success void-bg-success",
  intermediate: "void-text-energy void-border void-bg-sunk",
  advanced: "void-text-accent void-border void-bg-sunk",
  master: "void-text-error void-border-error void-bg-error",
};
