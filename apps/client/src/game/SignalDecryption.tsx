...
export default function SignalDecryption({ onComplete, onClose }: SignalDecryptionProps) {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center void-bg-canvas px-4 py-6 text-white select-none overflow-hidden">
      {/* Background art */}
      <img src={assetUrl("art/minigames/minigame-signal-decryption.png")} alt="" className="absolute inset-0 w-full h-full object-cover pointer-events-none" style={{ opacity: 0.12, filter: "brightness(0.35) saturate(0.7)" }} />
      <StaticNoise />
