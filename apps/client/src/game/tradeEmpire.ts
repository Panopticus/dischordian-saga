...
export const GALACTIC_MAP: GalacticSector[] = [
  ...
  { id: "free_ports", name: "The Free Ports", controlledBy: "independent", resources: { credits: 50, materials: 40, influence: 10, intelligence: 30 }, threat: 40, stability: 60, population: 200, hasRuins: true, hasAnomaly: false, adjacentSectors: ["trade_nexus", "frontier_worlds", "insurgency_haven"], lore: "Independent stations built in the ruins of old Empire outposts. Anything can be bought or sold here — including information.", image: "/art/planets/planet-degens-casino.png", eyesNarrator: "Pier nineteen. Fish stall. Ask for Mira. She was mine. I instructed her to forget my name; she wrote it down and stitched it into her hatband. Good tradecraft — mine, inverted. Say hello. She will pretend not to know you. The pretense is how you know." },
  // Faction territories
