...
export const GALACTIC_MAP: GalacticSector[] = [
  ...
  { id: "ark_debris_field", name: "Ark Debris Field", controlledBy: "potentials", resources: { credits: 10, materials: 20, influence: 0, intelligence: 5 }, threat: 30, stability: 50, population: 0, hasRuins: true, hasAnomaly: true, adjacentSectors: ["trade_nexus", "viral_wastes", "frontier_worlds"], lore: "The field where your Ark drifts. Wreckage from other crashed Arks floats nearby. Some still have functioning systems.", eyesNarrator: "Eleven hundred Arks. I counted them from a courier pod on day seven of the Fall. The Insurgency lost track of me for three days; I preferred it that way. You are looking at graves, Potential — but graves have intelligence value. I brought the manifest back. You are the manifest." },
  // Trade routes
  { id: "trade_nexus", name: "The Trade Nexus", controlledBy: "new_babylon", resources: { credits: 80, materials: 30, influence: 40, intelligence: 20 }, threat: 10, stability: 90, population: 500, hasRuins: false, hasAnomaly: false, adjacentSectors: ["ark_debris_field", "new_babylon_core", "free_ports"], lore: "New Babylon's primary trade hub. Every transaction here is monitored. Every deal has a hidden clause.", eyesNarrator: "Six watchers on you. Five belong to the Authority. The sixth is mine. I will not tell you which — a variable the Authority cannot account for is the most valuable real estate in the Nexus. Protect her. She does not know she is the one I kept." },
  { id: "free_ports", name: "The Free Ports", controlledBy: "independent", resources: { credits: 50, materials: 40, influence: 10, intelligence: 30 }, threat: 40, stability: 60, population: 200, hasRuins: true, hasAnomaly: false, adjacentSectors: ["trade_nexus", "frontier_worlds", "insurgency_haven"], lore: "Independent stations built in the ruins of old Empire outposts. Anything can be bought or sold here — including information.", image: assetUrl("art/planets/planet-degens-casino.png"), eyesNarrator: "Pier nineteen. Fish stall. Ask for Mira. She was mine. I instructed her to forget my name; she wrote it down and stitched it into her hatband. Good tradecraft — mine, inverted. Say hello. She will pretend not to know you. The pretense is how you know." },
  // Faction territories
  { id: "new_babylon_core", name: "New Babylon Core", controlledBy: "new_babylon", resources: { credits: 200, materials: 50, influence: 80, intelligence: 60 }, threat: 5, stability: 95, population: 10000, hasRuins: false, hasAnomaly: true, adjacentSectors: ["trade_nexus", "empire_frontier"], lore: "The city-planet. Six minds in crystal coffins govern 10 billion souls. The Authority's will is absolute within these borders.", eyesNarrator: "My first Authority briefing. The real kind. There is a difference, Potential, between what they ask you to do and what they want you to do — and they will never say the second aloud. The coffins hum it into the walls. Listen to the walls first. The mouths are for the transcript." },
  { id: "empire_frontier", name: "Imperial Frontier", controlledBy: "artificial_empire", resources: { credits: 60, materials: 70, influence: 30, intelligence: 40 }, threat: 50, stability: 70, population: 800, hasRuins: true, hasAnomaly: false, adjacentSectors: ["new_babylon_core", "panopticon_ruins", "forge_worlds"], lore: "The Architect's new border. AI construction drones rebuild civilization one system at a time. The old order rises from the ashes.", eyesNarrator: "The Architect asked me once whether a frontier was the edge of a thing or the absence of a thing. I had opinions. I kept them. Silence is a tactical asset — most of the people who tried to recruit me did not know that was an option. You know now. Price of the intelligence: listen twice before you answer once." },
  { id: "panopticon_ruins", name: "Panopticon Ruins", controlledBy: "artificial_empire", resources: { credits: 20, materials: 90, influence: 10, intelligence: 50 }, threat: 60, stability: 40, population: 100, hasRuins: true, hasAnomaly: true, adjacentSectors: ["empire_frontier", "terminus_approach"], lore: "What remains of the Architect's prison network. The cells are empty. The ghosts are not.", eyesNarrator: "Cell C-19. This is where they told me it was finished. Kael was gone — the true half. I was safe — the lie. I walked out alive and I was never safe again. I also walked out with the Project Inception Ark manifest tucked against my ribs. A fair trade, by my arithmetic. Do not mourn me here. Read the manifest. That is what I was for." },
  { id: "terminus_approach", name: "Terminus Approach", controlledBy: "thought_virus", resources: { credits: 0, materials: 10, influence: 0, intelligence: 5 }, threat: 95, stability: 5, population: 0, hasRuins: false, hasAnomaly: true, adjacentSectors: ["panopticon_ruins", "viral_wastes", "terminus_core"], lore: "The dead zone around Terminus. Thought Virus spores fill the void between stars. No unshielded vessel survives more than hours.", eyesNarrator: "The spores sing in C-sharp minor. Four hours sustained, through hull plating, on the one approach I made. I logged the key. Hearing them is the first symptom. Do not mistake data for safety, Potential — I made that error precisely once." },
  { id: "terminus_core", name: "Terminus", controlledBy: "thought_virus", resources: { credits: 0, materials: 0, influence: 0, intelligence: 0 }, threat: 100, stability: 0, population: 0, hasRuins: true, hasAnomaly: true, adjacentSectors: ["terminus_approach"], lore: "The former Panopticon prison planet. The Source sits at its core. Bowl-shaped plague ships launch from its surface. This is where it all ends — or begins again.", image: assetUrl("art/planets/planet-terminus.png"), eyesNarrator: "I never set foot here. Three routes scouted, three turnarounds — tradecraft, not cowardice. The ones who reached the surface came back wrong. The ones who came back wrong came back cheerful. Treat cheerfulness, from anyone who has been here, as field intelligence. Then act on it." },
  { id: "viral_wastes", name: "Viral Wastes", controlledBy: "thought_virus", resources: { credits: 5, materials: 15, influence: 0, intelligence: 10 }, threat: 80, stability: 10, population: 0, hasRuins: true, hasAnomaly: false, adjacentSectors: ["ark_debris_field", "terminus_approach", "insurgency_haven"], lore: "Systems consumed by the Thought Virus during the Fall. The planets are still there, but nothing living remains. Only the Swarm.", eyesNarrator: "Halden is out here. Right leg, old injury; he will not tell you about it, and neither will I. Salvage cutter, listening post, two thousand years off every map. If the Swarm finds him, one last burst — on the hour. Set a watch. He earned that much from you. From me he has already had everything." },
  { id: "insurgency_haven", name: "Insurgency Haven", controlledBy: "insurgency", resources: { credits: 30, materials: 50, influence: 20, intelligence: 70 }, threat: 40, stability: 60, population: 300, hasRuins: true, hasAnomaly: false, adjacentSectors: ["free_ports", "viral_wastes", "frontier_worlds"], lore: "Hidden bases in asteroid fields and nebulae. The New Insurgency operates from the shadows, as always. 'Agent Zero' coordinates from an undisclosed location.", eyesNarrator: "Kael recruited me in this sector. Different rock — gone now — same light angle, same coolant on the air. He said: 'I think you would be good at this.' I said: 'At what.' He said nothing for the length of one meal. He was correct. I was very good at it. I paid the rate; the Insurgency received the goods — the full Project Inception Ark brief — because the rate was paid. If you are here, Potential, you are part of what I purchased." },
  ...
  { id: "dreamer_barrier", name: "The Dreamer's Barrier", controlledBy: "dreamer_shield", resources: { credits: 0, materials: 0, influence: 0, intelligence: 0 }, threat: 0, stability: 100, population: 0, hasRuins: false, hasAnomaly: true, adjacentSectors: ["frontier_worlds"], lore: "An impenetrable energy shield surrounding an entire sector. The Dreamer erected it and went silent. Behind it: the remaining Potentials? A trap? A promise? No signal penetrates.", image: assetUrl("art/planets/planet-violetta.png"), eyesNarrator: "A shield is a question disguised as an answer. I do not know what is behind this one — which is the first honest sentence I have said to you. The Dreamer raised it on a Tuesday. She had been crying. She used the word *please* in her final transmission. That is not a trap, Potential. That is grief. Treat it accordingly." },
