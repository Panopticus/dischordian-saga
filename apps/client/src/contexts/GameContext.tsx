...
export const ROOM_DEFINITIONS: RoomDef[] = [
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "storm-dossier-quote", name: "Storm Dossier — Operational Sentence", description: "On the cosmic-archaeology shelf: the Storm's dossier open at its operational sentence. Older than every active Ne-Yon; the dossier does not record who first wrote it.", x: 50, y: 8, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-dossier-quote" },
      { id: "storm-polarity-lyric-record", name: "Polarity — Lyric Record", description: "On the lyric-records shelf: the Book of Daniel 2:47 'Polarity' record, signed in the Enigma's hand. The 12th Ne-Yon's endorsement of the Storm/Silence pairing.", x: 58, y: 8, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-polarity-lyric-record" },
      { id: "storm-dreamers-noted-entry", name: "Dreamer's One-Word Entry on the Storm", description: "On the Dreamer-archive shelf: the Dreamer's library carries one entry on the Storm — 'noted.' Nothing else. The Dreamer's most-documented archive falls silent here.", x: 22, y: 8, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-dreamers-noted-entry" },
      { id: "storm-eternal-active-status", name: "Storm Dossier Status: Active", description: "On the dossier-status board: the Storm reads Active despite the Degen-bible's 'only one still awake.' A productive ambiguity the case does not resolve.", x: 30, y: 8, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-eternal-active-status" },
