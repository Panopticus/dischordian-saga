...
export const ROOM_DEFINITIONS: RoomDef[] = [
  ...
  },
  {
    ...
    hotspots: [
      ...
      // ── FEATURE / CONTAINER HOTSPOTS ──
      { id: "trade-terminal", name: "Trade Empire Terminal", description: "The raised central dais with a mannequin standing in the middle of a flag-ring — the main terminal for the interstellar trade simulation.", cx: 51, cy: 50, width: 22, height: 50, type: "terminal", action: "/trade-empire", elaraDialog: "Trade Empire. An interstellar trade simulation modelled on the actual routes of the Dischordian chronicle. The buy-low/sell-high mechanics are the surface. The deeper game is which factions you trade with — every trade is a small alignment. The credits you earn are real. The alignments are also real." },
      { id: "store-counter", name: "Requisitions Counter", description: "The red-curtained trading alcove right-of-center — a trading post where you can buy items with Dream tokens and credits.", cx: 69, cy: 57.5, width: 18, height: 45, type: "terminal", action: "/store", elaraDialog: "The Requisitions Counter. Dream tokens and credits buy upgrades, packs, cosmetics. Some items are store-only — the design decision, not mine. I have catalogued every offering. I will, on request, tell you which offerings rotate and which do not. I do not, on principle, recommend purchases. That is yours." },
      ...
      { id: "resur-ark-passenger-manifest", name: "Inception Ark Passenger Manifest (Redacted)", description: "On the top crate's lid: the passenger-records page — seven names visible; eighth name redacted to a black bar of structural length. Not a casual erasure; a positioned occupant.", cx: 20.5, cy: 37.5, width: 5, height: 5, type: "interact", action: "room-mystery:cargo-hold:resur-ark-passenger-manifest",
        elaraDialog: "Seven names visible. The eighth is redacted to a black bar of structural length — not a casual erasure. A positioned occupant. Whoever the eighth was, the redaction wanted us to know they existed. The redaction is louder than the redacted name would have been." },
      { id: "charter2-house-marek", name: "House Marek — Toolmakers' Workshops", description: "On a side-crate stencilled 'HOUSE MAREK': three families, one tool-room, four epochs of continuous output. Same scrubber's hand on the charter-signature erasure.", cx: 32.5, cy: 37.5, width: 5, height: 5, type: "interact", action: "room-mystery:cargo-hold:charter2-house-marek",
        elaraDialog: "House Marek. Three families, one tool-room, four epochs of continuous output. Same scrubber's hand on the charter-signature erasure as on the Solven workshop record. Heron, I am almost certain. He had a system. The system is the part I find tractable. The motive is not." },
      { id: "the-cursed-forest-depot", name: "The Cursed-Forest Depot Placard", description: "A captured Hierarchy operations placard wired to the central crate — Fenra's domain filed not as a battlefield but as a logistics hub, the throughput corrupted souls, the depot dying under its own load.", cx: 28, cy: 58, width: 6, height: 6, type: "interact", action: "room-mystery:cargo-hold:the-cursed-forest-depot",
        elaraDialog: "A Hierarchy operations placard. Fenra's domain filed not as a battlefield but as a logistics hub. Throughput: corrupted souls. The depot is dying under its own load. The placard is candid; the candour is the rarest thing in the chamber." },
