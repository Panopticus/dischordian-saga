...
export const ROOM_DEFINITIONS: RoomDef[] = [
  ...
  },
  {
    ...
    imageUrl: assetUrl("art/rooms/forge_workshop/base/baseline.png"),
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "weapon-rack", name: "Weapon Rack", description: "A free-standing glass display case in the left-center holds high-grade weapons, with a wall-mounted rifle rack behind it. Most are locked behind security glass.", cx: 32.5, cy: 47.5, width: 35, height: 55, type: "examine", elaraDialog: "The weapon racks. Plasma swords, energy shields, cloaking devices. Most are locked behind security glass — the security is keyed to the previous armoury officer's biometrics. The previous officer is gone. The lock has been waiting for a successor. I am — and I want to be precise about this — not authorising you because I want to. I am authorising you because the chamber has decided you are the successor.",
        compositeScopes: ["SP01_rifle_rack_standard", "SP02_carbine_rack", "SP03_marksman_rack_locked", "SP04_junta_assault_rifles", "SP05_council_ceremonial_muskets", "SP06_chaos_improvised_long_arms", "SP07_synthesis_paired_arms", "SP08_hellbox_cursed_rifle", "SP09_council_marksman_rifle", "SP10_chaos_sawn_off_bullpup", "SP11_pistol_rack_standard", "SP12_captains_sidearm_display", "SP13_junta_sidearms", "SP14_council_inspection_sidearms", "SP15_hellbox_cursed_pistol", "SP16_eidolon_haunted_sidearm", "SP17_bayonet_rack", "SP18_combat_blade_rack", "SP19_captains_ceremonial_blade", "SP20_junta_riot_batons", "SP21_chaos_improvised_melee", "SP22_synthesis_arbitration_staves", "SP23_master_smith_commission_blade", "SP24_hellbox_cursed_blade"] },
      { id: "combat-arena", name: "Combat Arena", description: "The raised circular armor dais at chamber center, ringed by a purple-glow aura. A holographic combat simulation arena for training.", cx: 50.1, cy: 38.6, width: 19.2, height: 33.8, type: "terminal", action: "/fight", elaraDialog: "The combat arena. Step inside and I generate holographic opponents from known entities. The simulation is, by every metric I can run, safe. The qualifier 'relatively' is mine, not the system's. The system does not know about Kael.", compositeScopes: ["SP33_riot_armor_mannequin","SP34_standard_combat_armor","SP35_captains_command_armor","SP36_eva_boarding_armor","SP37_junta_crowd_control_kit","SP38_council_ceremonial_plate","SP39_synthesis_arbitration_vest","SP40_hellbox_touched_cursed_armor"] },
      { id: "quiz-terminal", name: "Knowledge Terminal", description: "The far-left corkboard of pinned mission cards — a terminal disguised as a duty board that tests your knowledge of the Dischordian lore.", cx: 18.2, cy: 70.6, width: 11.2, height: 13.7, rotation: -25, type: "terminal", action: "/quiz", elaraDialog: "The Knowledge Terminal. It tests your understanding of the Dischordian Saga. Answer correctly and you'll earn rewards. Get them wrong and... well, there are no penalties. But I'll be disappointed.", compositeScopes: ["SP59_authorization_roster_placard","SP60_issue_priority_chart"] },
      { id: "card-battle-station", name: "Card Battle Station", description: "The left half of the right-side tool workbench — a tactical display surface for card game warfare.", cx: 75.7, cy: 63.3, width: 22.3, height: 8.7, type: "terminal", action: "/battle", elaraDialog: "The card battle station. AI opponents, other Potentials, deck-on-deck. Every victory earns you cards; every loss does too — losing teaches the deck where it cracks. I have lost to the AI more times than I have won. The AI was trained on me. I am, on balance, not insulted." },
      { id: "chess-table", name: "Strategy Table", description: "The right half of the right-side tool workbench — an ornate chess board with holographic pieces depicting Dischordian characters.", cx: 87.3, cy: 82.8, width: 25.4, height: 18.5, type: "terminal", action: "/chess", elaraDialog: "The strategy table. A chess variant — the pieces are Dischordian characters with mechanics that modify the classic rules. The AI adapts to your skill. It is not just a game; it is a test of how you weight the abilities you are given. I have a preferred opening. I will not tell you which until you have your own." },
      { id: "spectator-screen", name: "Spectator Screen", description: "The front edge of the right-side workbench — a wide screen showing live battles between other Potentials.", cx: 80.5, cy: 23.4, width: 10.3, height: 15.4, type: "terminal", action: "/spectate", elaraDialog: "The spectator screen. Live battles between other Potentials. Watching teaches differently than playing — you see the decisions, not the pressure. I have been watching matches for longer than you have been awake. I would, if asked, share my notes. The notes are voluminous." },
      ...
      { id: "door-engineering", name: "Engineering Bay", description: "The back archway above the dais — return to Engineering.", cx: 27.2, cy: 45.3, width: 3.7, height: 18.5, type: "door", action: "engineering" },
      { id: "door-cargo", name: "Cargo Hold", description: "Stairs leading down to the Cargo Hold.", cx: 92.8, cy: 46.2, width: 5.9, height: 27.2, type: "door", action: "cargo-hold" },

      // ── SUB-RECTS (egg + mystery + NPC) ──
      // Authored AFTER container hotspots so they win clicks on
      // specific items.
      { id: "egg-armory-dogtag", name: "Fallen Dog Tag", description: "A military dog tag wedged between the floor plates at the base of the dais.", cx: 32.3, cy: 67.1, width: 3, height: 4, type: "item", action: "agent-zero-dogtag", elaraDialog: "A dog tag. Name: CLASSIFIED. Rank: Assassin, First Class. Unit: Insurgency Special Operations. Callsign: 'Agent Zero.' But wait — the biometric data on the tag doesn't match Agent Zero's profile. It matches... the Engineer. The mind swap. The Engineer is walking around in Agent Zero's body, hiding among the Potentials. On THIS ship.",
        compositeScopes: ["SP81_lost_dog_tag"] },
      { id: "motivational-poster", name: "Motivational Poster", description: "Pinned to the top corner of podium— a faded poster showing a sunset with the text 'HANG IN THERE!' Signed in the corner: Iron Lion.", cx: 69.9, cy: 49.1, width: 5, height: 6, type: "examine", action: "room-mystery:armory:motivational-poster", elaraDialog: "Iron Lion's poster. He printed thousands of these. Most of them are gone. This one isn't. There is a cat in the bottom corner that I did not, until today, register." },
      ...
      { id: "npc-agent-zero", name: "Agent Zero", description: "A figure leaning against the wall-mounted rifle rack. Insurgency uniform, dog-tag at the throat, eyes that have already counted every exit.", cx: 63.2, cy: 31.6, width: 5.1, height: 15.1, type: "npc", action: "npc:agent_zero", elaraDialog: "Agent Zero. Or — and we are not going to be careful about this in the wrong direction — the body that is registered as Agent Zero. The dog tag does not match the biometrics on the rack. He is here because we are here, which is the second thing I do not entirely trust about him. The first is that he has been here longer than the manifest acknowledges.", npcId: "agent_zero" },

      // ── NEW HOTSPOTS — provisional positions, calibrate via /ark?author-hotspots=1 ──
      // Authored 2026-05-29 to give producer-delivered armory sprites a
      // home so the resize pass can size each object family in-scene.
      { id: "ammo-locker", name: "Ammunition Locker", description: "A grid of secured lockers stacked with rifle and sidearm ammunition, grenades, plasma cells, and specialty rounds.", cx: 25, cy: 50, width: 10, height: 30, type: "examine", elaraDialog: "The ammo locker. Standard issue rounds, grenades, plasma cells. Specialty rounds for eidolon containment and TV bleed scenarios. The previous quartermaster kept the locker over-supplied; the chronicle reads it as a personal habit, not a doctrine. The habit was, in the day's evidence, the doctrine the chronicle had not yet noticed.",
        compositeScopes: ["SP25_ammo_lockers_rifle", "SP26_ammo_lockers_sidearm", "SP27_grenade_locker", "SP28_plasma_cell_rack", "SP29_eidolon_containment_rounds", "SP30_junta_riot_canisters", "SP31_smoke_grenade_rack", "SP32_synthesis_non_lethal_rounds"] },
      { id: "vault-door", name: "Restricted Vault", description: "The reinforced vault door at the rear of the armory — restricted-tier weapons and Hellbox-touched gear behind it.", cx: 70, cy: 40, width: 12, height: 35, type: "examine", elaraDialog: "The Vault. Restricted-tier weapons, master-key-only access. Inside: weapons that should not, on the chronicle's reading, exist in a quartermaster's catalogue. The vault has been opened twice in the last decade. Both openings were under the previous officer. Neither was logged.",
        compositeScopes: ["SP41_vault_door_closed", "SP42_vault_door_open_interior", "SP43_restricted_weapons_vault", "SP44_eidolon_munitions_vault", "SP45_hellbox_weapons_cache"] },
      { id: "master-inventory-locker", name: "Master Inventory Locker", description: "The Quartermaster's master locker — every issued weapon's chain-of-custody record is here.", cx: 12, cy: 60, width: 8, height: 22, type: "examine", elaraDialog: "The master inventory locker. Every weapon issued, returned, lost, or destroyed — the chain of custody. The previous quartermaster kept the records by hand. The records are, on the chronicle's reading, more accurate than the digital roster. The hand-record names a weapon the digital roster does not.",
        compositeScopes: ["SP46_master_inventory_locker"] },
      { id: "quartermaster-station", name: "Quartermaster's Desk", description: "The Quartermaster's manned station — issue log, custody board, returned-gear bin. The desk is staffed during day-cycle.", cx: 18, cy: 25, width: 12, height: 16, type: "examine", elaraDialog: "The quartermaster's desk. The issue log is open; the chain-of-custody board is up; the returned-gear bin is half-full. The station is manned in the day cycle. The day-cycle quartermaster is — and I want to be precise — the same person as the night-cycle quartermaster. He does not sleep.",
        compositeScopes: ["SP47_quartermasters_desk_manned", "SP48_issue_log_book_open", "SP49_chain_of_custody_board", "SP50_returned_gear_bin"] },
      { id: "maintenance-bench", name: "Maintenance & Cleaning Bench", description: "A long workbench at the rear-right wall with rifle maintenance gear, boresighting rig, weapon parts bin, cleaning station.", cx: 78, cy: 78, width: 18, height: 18, type: "examine", elaraDialog: "The maintenance bench. Rifle cleaning, boresighting, parts replacement. The training dummies stand behind. The bench is the unromantic side of the armory — the half that keeps the rest honest. The previous quartermaster spent more time at the bench than at the desk. The chronicle reads that as a virtue.",
        compositeScopes: ["SP51_maintenance_bench_rifle", "SP52_boresighting_rig", "SP53_training_dummy_intact", "SP54_training_dummy_worn", "SP55_boresight_target_wall", "SP56_cleaning_station", "SP57_weapon_parts_bin", "SP58_manufacturer_marker_board"] },
      { id: "signage-board", name: "Signage & Charts", description: "A cluster of pinned faction signage above the quartermaster's desk — requisition orders, audit notices, disarmament protocols, forge supply manifest.", cx: 32, cy: 20, width: 10, height: 8, type: "examine", elaraDialog: "The signage board. Whatever faction has authority that week, their notice is pinned up. The previous quartermaster kept old notices behind the current one. The old notices are still there. The board is a stratigraphy of who held the room.",
        compositeScopes: ["SP61_junta_requisition_order", "SP62_council_audit_notice", "SP63_synthesis_disarmament_protocol", "SP64_forge_supply_manifest"] },
      { id: "npc-quartermaster", name: "Quartermaster on Duty", description: "The on-duty quartermaster behind the desk — checking ids, signing for gear, running maintenance.", cx: 18, cy: 28, width: 4, height: 12, type: "npc", action: "npc:quartermaster", elaraDialog: "The Quartermaster on duty. He has signed every entry in the issue log for the last nine years. He has signed entries before he was on duty. He has signed entries after he was off duty. He is, on the day's evidence, the only person in this room who is always in this room." },
      { id: "npc-junta-requisition", name: "Junta Requisition Officer", description: "A Junta requisition officer at the signage board, recording today's pull.", cx: 36, cy: 28, width: 4, height: 14, type: "npc", action: "npc:junta_requisition_officer", elaraDialog: "Junta requisition officer. Recording the day's pull against the Junta's signed allocation. The signed allocation exceeds the on-hand inventory. The officer is, on the day's evidence, not reading the inventory. He is reading the allocation.",
        compositeScopes: ["SP66_junta_requisition_officer"] },
      { id: "npc-council-inspector", name: "Council Inspector", description: "A Council inspector with a clipboard, walking the racks and signing the audit notice.", cx: 50, cy: 28, width: 4, height: 14, type: "npc", action: "npc:council_inspector", elaraDialog: "Council inspector. Walking the racks; signing the audit notice. Her clipboard contains, on the chronicle's reading, two lists — the one she is submitting and the one she is keeping. The keeping list is, in the end, the more honest of the two.",
        compositeScopes: ["SP67_council_inspector"] },
      { id: "npc-captain-armed", name: "Captain Drawing a Sidearm", description: "The Captain stepping up to the Captain's-sidearm display, taking the sidearm down. A choice being made.", cx: 50, cy: 50, width: 4, height: 14, type: "npc", action: "npc:captain_armed", elaraDialog: "The Captain at the sidearm display. Taking down the sidearm. The act is, in this room, also a question. The room has not, in two centuries, watched a captain answer the question and put the sidearm back. The current captain is — and I am not asking — being watched.",
        compositeScopes: ["SP68_captain_drawing_sidearm"] },
      { id: "npc-apprentice-runner", name: "Apprentice Runner", description: "A young runner from the forge, delivering a finished commission to the armory.", cx: 65, cy: 40, width: 4, height: 12, type: "npc", action: "npc:apprentice_runner", elaraDialog: "The apprentice runner. Delivery from the forge. The commission is signed by the smith and counter-signed by the apprentice. The counter-signature is irregular; the apprentice should not have authority to counter-sign. The apprentice does, on the day's evidence, have the authority. The smith granted it. The grant was not recorded.",
        compositeScopes: ["SP69_apprentice_runner"] },
      { id: "npc-marines-drawing-kit", name: "Marines Drawing Kit", description: "Two marines at the weapon rack, drawing their assigned kit before deployment.", cx: 42, cy: 55, width: 8, height: 16, type: "npc", action: "npc:marines_drawing_kit", elaraDialog: "Marines drawing kit. Pre-deployment loadout. The loadout is — and this is the thing the manifest does not record — heavier than the manifest authorises. The quartermaster is not, on the day's evidence, stopping them. The quartermaster is, in his quiet way, the reason the loadout is heavier.",
        compositeScopes: ["SP70_marines_drawing_kit"] },
      // Eggs / secrets — small discovery hotspots. Provisional positions.
      { id: "egg-whiskers-poster", name: "Mr. Whiskers Missing Poster", description: "A 'MISSING — please return to Captain' poster taped to the signage board's bottom edge.", cx: 35, cy: 32, width: 3, height: 3, type: "interact", action: "room-mystery:armory:whiskers-poster", elaraDialog: "A 'MISSING' poster for a cat — Mr. Whiskers. Pinned crooked. The captain has been searching for the cat for two centuries. The cat has, on the chronicle's reading, been in the captain's quarters the entire time.",
        compositeScopes: ["SP79_mr_whiskers_missing_poster"] },
      { id: "egg-father-medal", name: "Captain's Father's Medal", description: "Inside the vault — a tarnished campaign medal pinned to a faded ribbon. The previous captain's father's.", cx: 70, cy: 50, width: 3, height: 3, type: "interact", action: "room-mystery:armory:father-medal", elaraDialog: "The previous captain's father's medal. Tarnished. The ribbon is original. The medal was for an action the official record describes as 'inconclusive.' The chronicle reads the action as decisive. The medal was, on the day's evidence, the family's quiet correction of the record.",
        compositeScopes: ["SP80_captains_father_medal"] },
      { id: "egg-marginalia-issue-log", name: "Hidden Marginalia — Issue Log", description: "A faint pencil note in the issue log's margin — the antiquarian's hand.", cx: 21, cy: 25, width: 3, height: 3, type: "interact", action: "room-mystery:armory:hidden-marginalia", elaraDialog: "A pencil note in the issue log's margin. The Antiquarian's hand. The note reads: 'the rifle on row three has been signed for nine times without ever leaving the rack.' The note is correct. The chronicle had not, until the note, noticed.",
        compositeScopes: ["SP82_hidden_marginalia_issue_log"] },
      { id: "egg-antiquarian-note", name: "Antiquarian's Research Note", description: "A folded research note tucked under the issue log.", cx: 23, cy: 27, width: 3, height: 3, type: "interact", action: "room-mystery:armory:antiquarians-note", elaraDialog: "The Antiquarian's research note. Folded once. The note is a question, not an answer: 'who signs for the rifle on row three?' The signing is in the Quartermaster's hand. The question is, on the chronicle's reading, the Antiquarian's quiet way of telling the room that he knows.",
        compositeScopes: ["SP83_antiquarians_research_note"] },
      { id: "egg-first-apprentice-piece", name: "Forge's First Apprentice Piece", description: "Displayed on a small plinth — a bayonet hand-forged by the master smith's first apprentice.", cx: 45, cy: 35, width: 3, height: 3, type: "interact", action: "room-mystery:armory:first-apprentice-piece", elaraDialog: "The first apprentice's bayonet. Hand-forged; unmarked. The smith displays it as a teaching artifact — see what is possible from a beginner who paid attention. The apprentice is, on the day's evidence, no longer an apprentice. He is the smith who taught the current smith.",
        compositeScopes: ["SP84_forge_first_apprentice_piece"] },
      { id: "egg-hellbox-cipher", name: "Hellbox Cipher Rubbing", description: "A pencil rubbing of a Hellbox cipher, taped to the vault's inner door.", cx: 70, cy: 35, width: 3, height: 3, type: "interact", action: "room-mystery:armory:hellbox-cipher", elaraDialog: "A pencil rubbing of a Hellbox cipher. Taped to the vault's inner door. The cipher is the same one the Antiquarian has been transcribing in the library. The rubbing is, on the day's evidence, his. The Antiquarian has been inside this vault. The vault is supposed to be quartermaster-only access. The Antiquarian is, on the chronicle's quieter reading, the quartermaster's friend.",
        compositeScopes: ["SP85_hellbox_cipher_rubbing"] },
      { id: "egg-eidolon-recorder", name: "Eidolon Whisper Recorder", description: "A small audio recorder near the eidolon-containment ammo, blinking softly during long-night.", cx: 26, cy: 50, width: 3, height: 3, type: "interact", action: "room-mystery:armory:eidolon-recorder", elaraDialog: "An audio recorder. Near the eidolon containment rounds. Records in the long-night cycle only. The recordings are — and I have listened — whispers. Voices the chronicle does not have a witness for. The recorder is, on the day's evidence, listening for them on purpose.",
        compositeScopes: ["SP86_eidolon_whisper_recorder"] },
      { id: "egg-comms-array-key", name: "Comms Array Key Fragment", description: "A small brass key-fragment in the returned-gear bin, mis-filed.", cx: 18, cy: 32, width: 3, height: 3, type: "interact", action: "room-mystery:armory:comms-array-key", elaraDialog: "A brass key-fragment. Mis-filed in the returned-gear bin. The fragment is a quarter of the Comms Array's master key. Whoever returned it returned it knowing it would be mis-filed. Whoever mis-filed it mis-filed it knowing the fragment was the key. The chronicle reads this as two people in agreement, neither of whom signed for the disagreement.",
        compositeScopes: ["SP87_comms_array_key_fragment"] },
      { id: "egg-lost-ring", name: "Lost Engagement Ring", description: "A simple band wedged between the weapon-bench's drawer and the wall.", cx: 78, cy: 82, width: 3, height: 3, type: "interact", action: "room-mystery:armory:lost-ring", elaraDialog: "A simple band. Wedged between the weapon-bench's drawer and the wall. Inscription on the inside: a date, two names. The names are not on any roster. The date is three centuries ago. The ring is — on the chronicle's reading — the previous quartermaster's, from a life he never recorded in the manifest.",
        compositeScopes: ["SP88_lost_engagement_ring"] },
      { id: "egg-jack-of-swords", name: "Jack of Swords Card", description: "A single tarot card face-down on the bench, the back patterned in old indigo.", cx: 76, cy: 78, width: 3, height: 3, type: "interact", action: "room-mystery:armory:jack-of-swords", elaraDialog: "A tarot card. Face down. The back is indigo. The card is, when turned, the Jack of Swords — the role the antiquarian has been playing the whole time, on the chronicle's reading. The card was left here on purpose. The purpose was, in the room's quieter evidence, to be found.",
        compositeScopes: ["SP89_jack_of_swords_card"] },
      { id: "egg-cryo-contraband", name: "Cryo-Frozen Contraband", description: "A small cryo-canister tucked behind the eidolon containment ammo, frozen contraband inside.", cx: 28, cy: 52, width: 3, height: 3, type: "interact", action: "room-mystery:armory:cryo-contraband", elaraDialog: "A cryo canister. Behind the eidolon containment rounds. Frozen contraband inside. The contraband is — and I am being honest — a vial of memory. Someone's, frozen, hidden in the armory because the armory is the room nobody examines for memories. The chronicle does not yet have a name to attach to the vial. The chronicle will, on the day's evidence, find one.",
        compositeScopes: ["SP90_cryo_frozen_contraband"] },
    ],
  },
  {
    id: "cargo-hold",
    ...
    hotspots: [
      ...
      { id: "trade-terminal", name: "Trade Empire Terminal", description: "The raised central dais with a mannequin standing in the middle of a flag-ring — the main terminal for the interstellar trade simulation.", cx: 49.6, cy: 55.5, width: 7.9, height: 19.9, type: "terminal", action: "/trade-empire", elaraDialog: "Trade Empire. An interstellar trade simulation modelled on the actual routes of the Dischordian chronicle. The buy-low/sell-high mechanics are the surface. The deeper game is which factions you trade with — every trade is a small alignment. The credits you earn are real. The alignments are also real.",
        compositeScopes: ["sp47_trade_empire_dais_baseline", "sp48_trade_empire_dais_bare_platform", "sp49_trade_empire_dais_opulent", "sp55_cosmetic_mannequin_default_uniform", "sp56_cosmetic_mannequin_ceremonial_gold"] },
      { id: "store-counter", name: "Requisitions Counter", description: "The red-curtained trading alcove right-of-center — a trading post where you can buy items with Dream tokens and credits.", cx: 71, cy: 53.7, width: 16.8, height: 24.3, type: "terminal", action: "/store", elaraDialog: "The Requisitions Counter. Dream tokens and credits buy upgrades, packs, cosmetics. Some items are store-only — the design decision, not mine. I have catalogued every offering. I will, on request, tell you which offerings rotate and which do not. I do not, on principle, recommend purchases. That is yours.",
        compositeScopes: ["sp52_requisitions_counter_closed_curtain", "sp53_requisitions_counter_open_curtain"] },
      { id: "marketplace-board", name: "Marketplace Board", description: "The ring of small flags above the central dais — a bustling exchange board showing buy and sell orders from Potentials across the Ark.", cx: 48.1, cy: 5.5, width: 26.8, height: 7, type: "terminal", action: "/marketplace", elaraDialog: "The Marketplace. Peer-to-peer trades — cards, materials, equipment. Prices fluctuate with supply and demand. The price-curves have a pattern I have been watching: someone is moving large quantities of common cards just before each rotation. The someone is, by my count, three accounts that I think are the same trader. I am not telling them I have noticed.",
        compositeScopes: ["sp54_marketplace_board_active"] },
      { id: "inventory-locker", name: "Personal Locker", description: "The left-wall recessed display cases — your secured locker containing collected items and equipment.", cx: 18.7, cy: 42.1, width: 10.2, height: 25.3, type: "terminal", action: "/inventory", elaraDialog: "Your personal locker. Weapons, armour, materials, consumables, artifacts. The locker sorts automatically; I would, in fact, prefer if you reorganised it manually now and then. The automatic sort hides which items you actually use. Your decisions are more legible in the layout you make than the layout the locker makes for you.",
        compositeScopes: ["sp50_personal_locker_wall_all_lit", "sp51_personal_locker_wall_one_lit"] },
      { id: "fleet-dock", name: "Fleet Docking Bay", description: "The right-wall recessed display cases — a viewport showing the Ark's auxiliary fleet of smaller vessels.", cx: 82.4, cy: 31.6, width: 11.7, height: 9.3, rotation: -22, type: "terminal", action: "/fleet", elaraDialog: "The Fleet Docking Bay. Scout ships, cargo haulers, combat frigates. The vessels here are yours; the auxiliary fleet that survives the Ark's larger journey. Manage them carefully — every loss is a route you will not be able to take. The fleet is a smaller version of the Ark, and like the Ark, it is finite.",
        compositeScopes: ["sp64_fleet_docking_bay_ships_moored", "sp65_fleet_docking_bay_all_dark"] },
      { id: "mystery-crate", name: "Sealed Crate", description: "The stack of blue brass-cornered crates at left-center. The largest crate has claw marks on it — something was trying to get in... or out.", cx: 13.8, cy: 65.8, width: 18, height: 12.6, type: "examine", elaraDialog: "That crate... the claw marks are on the inside. Something was sealed in there and tried to get out. The manifest says it contained 'biological samples from Sector 7.' I've locked it down. Don't touch it.",
        compositeScopes: ["sp28_sealed_crate_intact_claw_marks", "sp29_sealed_crate_indigo_bleed", "sp30_sealed_crate_burst_open", "sp31_sealed_crate_welded_repair"] },
      ...
      { id: "door-armory", name: "Armory Stairs", description: "Stairs leading up to the Armory.", cx: 2.6, cy: 56, width: 4.7, height: 10.5, type: "door", action: "armory",
        compositeScopes: ["sp41_armory_stairs_door_closed"] },
      { id: "door-captains", name: "Captain's Quarters", description: "A restricted access corridor to the Captain's Quarters.", cx: 96.2, cy: 57.8, width: 4.8, height: 13.5, type: "door", action: "captains-quarters",
        compositeScopes: ["sp42_captains_quarters_door_restricted"] },
      ...
      { id: "rubber-chicken", name: "Rubber Chicken", description: "Hanging from the edge of the small foreground table with the glowing blue orb: a rubber chicken with a pulley in the middle. Why is this on a spaceship?", cx: 19.5, cy: 81, width: 5, height: 6, type: "examine", action: "room-mystery:cargo-hold:rubber-chicken", elaraDialog: "It's a rubber chicken with a pulley in the middle. I have no tactical assessment. I've failed you as an AI. Also — it has been here longer than any human I have ever known. Take that how you want.",
        compositeScopes: ["sp60_blue_orb_side_table", "sp63_rubber_chicken_hidden_pulley_concealed"] },
      { id: "egg-cargo-manifest", name: "Torn Manifest Page", description: "A torn page from the original cargo manifest, half-hidden beneath the central floor compass-star.", cx: 41, cy: 66.3, width: 4, height: 5, type: "item", action: "classified-manifest-page", elaraDialog: "A torn manifest page. Most of it is redacted, but one entry is legible: 'Container 7-Omega: BIOLOGICAL — Clone Template, Oracle-class. STATUS: Active. HANDLER: The Collector.' A clone template of the Oracle... on our ship. The False Prophet was made from an Oracle clone. Is there another one here? Is it awake?",
        compositeScopes: ["sp62_torn_manifest_page_compass_star"] },

      // ── NEW HOTSPOTS — provisional positions, calibrate via /ark?author-hotspots=1 ──
      // Authored 2026-05-29 to give producer-delivered cargo-hold sprites a
      // home so the resize pass can size each object family in-scene.
      { id: "floor-compass", name: "Compass-Rose Floor Inlay", description: "The bronze compass-rose inlay set into the cargo-hold floor at center — directional truth for an undirected room.", cx: 41, cy: 70, width: 14, height: 12, type: "examine", elaraDialog: "The compass-rose inlay. Bronze, gold in the victory variant, indigo-scarred in the corrupted timelines. The compass points to true north of the chamber — which is, in the chronicle's reading, the bay doors. The previous loadmaster oriented every operation against it. The current loadmaster does not, on the day's evidence, know it is there.",
        compositeScopes: ["sp12_compass_rose_floor_inlay_baseline", "sp13_compass_rose_gold_victory", "sp14_indigo_scar_floor_healed"] },
      { id: "crane-gantry", name: "Overhead Crane Gantry", description: "The full-span overhead crane gantry running the length of the bay. Idle by default; lifts crates on demand.", cx: 50, cy: 18, width: 60, height: 12, type: "examine", elaraDialog: "The overhead crane gantry. Spans the bay; lifts the heavy crates. The control panel is at the rear-right wall. The previous loadmaster ran the gantry on manual; the current loadmaster runs it on automatic. The chronicle prefers the manual reading. The reading is, in the end, what the gantry was built for.",
        compositeScopes: ["sp17_crane_gantry_idle_no_load", "sp18_crane_gantry_active_crate_lifted", "sp20_crane_control_panel_idle", "sp21_crane_control_panel_active_cyan"] },
      { id: "crate-stacks", name: "Cargo Crate Stacks", description: "The main cargo stacks — empty grid in baseline, partial in midgame, full at peak inventory.", cx: 38, cy: 50, width: 28, height: 40, type: "examine", elaraDialog: "The crate stacks. Empty grid, partial three-high, full five-high — the inventory reads as a calendar. The previous loadmaster kept the stacks at three-high all year; the chronicle reads that as a deliberate redundancy. The current loadmaster's redundancy is, on the day's evidence, different.",
        compositeScopes: ["sp23_crate_stack_empty_grid", "sp24_crate_stack_partial_3_high", "sp25_crate_stack_full_5_high", "sp27_crate_anchor_grid_full"] },
      { id: "oracle-crate-7-omega", name: "Container 7-Omega", description: "A single sealed container glowing with a faint cyan-omega sigil — the Oracle-class clone template the torn manifest names.", cx: 60, cy: 42, width: 5, height: 8, type: "interact", action: "room-mystery:cargo-hold:oracle-crate-7-omega", elaraDialog: "Container 7-Omega. The sigil is a cyan omega — the Collector's house mark. Inside, per the torn manifest: an Oracle-class clone template. STATUS: Active. The clone has been active for, on the chronicle's reading, longer than the ship has been in flight. The clone is, on the day's evidence, awake.",
        compositeScopes: ["sp32_oracle_crate_7_omega_glow"] },
      { id: "freight-elevator", name: "Freight Elevator", description: "The reinforced freight elevator at the bay's rear — brass-door closed in baseline, open mid-transit otherwise.", cx: 88, cy: 50, width: 10, height: 28, type: "examine", elaraDialog: "The freight elevator. Connects bay to mezzanine to upper deck. The status display reads idle in the baseline; in transit the cyan progress bar runs. The previous loadmaster used it for the silent loads — the loads that did not show in the manifest. The chronicle has not yet, on the day's evidence, found the corresponding unload.",
        compositeScopes: ["sp33_freight_elevator_closed_brass_doors", "sp34_freight_elevator_open_mid_transit", "sp35_elevator_status_display_idle"] },
      { id: "forklift", name: "Parked Forklift", description: "A yellow-brass forklift parked at the bay's left side, ignition off.", cx: 16, cy: 78, width: 8, height: 10, type: "examine", elaraDialog: "The forklift. Yellow-brass; ignition off. The previous loadmaster's preferred. He left the key in it. The key is still in it. The current loadmaster has not, on the day's evidence, used the forklift. The forklift is, in this corner, a kept memorial.",
        compositeScopes: ["sp36_forklift_parked_yellow_brass"] },
      { id: "manifest-terminal", name: "Manifest Terminal", description: "A standing terminal beside the trade desk, the rotating globe display showing today's manifest. Warning glyph in the corrupted variant.", cx: 56, cy: 50, width: 8, height: 14, type: "terminal", action: "/cargo/manifest", elaraDialog: "The manifest terminal. The rotating globe shows today's loadout against the cargo bay's tally. The warning glyph triggers when the tally and the loadout disagree by more than the loadmaster's tolerance. The tolerance is — and the chronicle has measured it — generous. The disagreement has, in the last decade, exceeded the tolerance on six occasions. The terminal flagged none of them.",
        compositeScopes: ["sp37_manifest_terminal_idle_globe_rotating", "sp38_manifest_terminal_warning_glyph"] },
      { id: "npc-cargo-handler", name: "Cargo Handler", description: "The cargo handler at the manifest terminal, signing in the day's pull.", cx: 56, cy: 42, width: 4, height: 14, type: "npc", action: "npc:cargo_handler", elaraDialog: "The cargo handler. At the manifest terminal. Signs in the day's pull. He has signed in the pull every day for nine years. The pull he signs in is, on the chronicle's reading, not always the pull the bay actually moves. The handler is — and I want to be careful — not the dishonest party. The handler is the party who knows.",
        compositeScopes: ["sp40_cargo_handler_npc_at_manifest"] },
      { id: "door-forge-workshop", name: "Forge Workshop Door", description: "A heavy steel door at the bay's mid-left wall labelled FORGE WORKSHOP. Closed in the baseline.", cx: 8, cy: 38, width: 6, height: 18, type: "door", action: "forge-workshop",
        compositeScopes: ["sp43_forge_workshop_door_closed", "sp44_forge_workshop_door_open"] },
      { id: "door-maintenance", name: "Maintenance Corridor Door", description: "A service door at the rear-left wall — maintenance corridor access.", cx: 14, cy: 32, width: 5, height: 14, type: "examine", elaraDialog: "The maintenance corridor door. Closed by default; opens by maintenance code. The previous loadmaster knew the code. The current loadmaster does not, on the day's evidence, know there is a corridor behind the door.",
        compositeScopes: ["sp45_maintenance_door_closed"] },
      { id: "door-trade-corridor", name: "Trade Corridor Door", description: "A wide brass-fitted door at the bay's far-right wall — the trade corridor.", cx: 92, cy: 38, width: 6, height: 18, type: "door", action: "/trade", elaraDialog: "The trade corridor. Connects the bay to the off-ship trade port. The brass fittings are original; the door is original. The corridor is, in the room's evidence, the bay's reason. The bay is the corridor's room.",
        compositeScopes: ["sp46_trade_corridor_door_closed"] },
      { id: "weighing-scales", name: "Brass Weighing Scales", description: "A pair of brass commercial scales beside the cargo handler's station — the loadmaster's measurement of conscience.", cx: 62, cy: 60, width: 4, height: 6, type: "examine", elaraDialog: "Brass scales. Beside the cargo handler. The previous loadmaster weighed every outbound load himself. The current loadmaster trusts the manifest terminal. The chronicle's reading is that the scales were the room's quieter integrity — the integrity the manifest terminal cannot, on the day's evidence, replicate.",
        compositeScopes: ["sp59_brass_weighing_scales"] },
      { id: "creed-plaque", name: "Creed Plaque — 'What We Carry'", description: "A small brass plaque on the inventory locker — 'WHAT WE CARRY, WE CARRY HONESTLY.'", cx: 24, cy: 32, width: 4, height: 4, type: "examine", elaraDialog: "The creed plaque. 'WHAT WE CARRY, WE CARRY HONESTLY.' The plaque is original. The previous loadmaster polished it weekly. The current loadmaster — the chronicle notes — does not polish it. The plaque is, in the absence of polishing, tarnished. The tarnish is, in the chronicle's quieter reading, the sentence the plaque has been writing.",
        compositeScopes: ["sp61_creed_plaque_what_we_carry"] },
    ],
  },
  {
    ...
    hotspots: [
      ...
      { id: "trophy-wall", name: "Trophy Wall", description: "The left-wall framed-portrait gallery — a holographic display showing your achievements and collected trophies.", cx: 7.5, cy: 47.5, width: 15, height: 45, type: "terminal", action: "/trophy", elaraDialog: "The Trophy Wall. Every achievement you've earned, every milestone you've reached. Dr. Vox designed this display system — she believed in cataloging everything. Obsessively. Now I wonder if that obsession was hers... or the Warlord's.",
        compositeScopes: ["sp49_legacy_wall_1_plate_lit", "sp50_legacy_wall_3_plates_lit", "sp51_legacy_wall_5_plates_lit", "sp52_legacy_wall_7_plates_lit", "sp53_legacy_wall_10_plates_full", "sp54_legacy_wall_indigo_overlay_all_plates"] },
      { id: "deck-builder", name: "Strategic Table", description: "The glass coffee table at the center of the chair circle — a large surface with holographic card projections for deck building.", cx: 49, cy: 75.5, width: 18, height: 15, type: "terminal", action: "/deck-builder", elaraDialog: "The Strategic Table. Dr. Vox used this to plan — officially 'neural network deployment patterns,' but the formations look military. She designed the nanobot operating system that runs every Ark; the patterns suggest she knew exactly what the nanobots could really do. The table is yours now. The patterns it draws will be yours too — by which I mean: it is, on the day's evidence, a kind of mirror.",
        compositeScopes: ["sp22_chess_board_kael_opening", "sp23_chess_board_black_king_toppled", "sp24_chess_pieces_toppled_bleeding_black", "sp25_chess_board_pieces_rearranging_grand_edit"] },
      { id: "companion-quarters", name: "Companion Quarters", description: "The single bed/cot at left foreground — a cozy alcove with personal effects. Elara's space and room for another companion.", cx: 11, cy: 80, width: 22, height: 30, type: "terminal", action: "/companions", elaraDialog: "The companion quarters. This is where your companions rest between missions. Each one has a bond with you, an ability set, and — what every previous captain underestimated — a will of their own. Strengthen the bond and they will fight harder for you. Be careful what you are asking them to fight for.",
        compositeScopes: ["sp14_bed_neatly_made_wear_trail", "sp15_bed_unmade_disturbed", "sp16_companion_cot_empty_oxblood"] },
      { id: "battle-pass-console", name: "Season Terminal", description: "The captain's desk monitor — a terminal displaying the current season's challenges and reward tracks.", cx: 47, cy: 40, width: 14, height: 16, type: "terminal", action: "/battle-pass", elaraDialog: "The Season Terminal. Each season is its own narrative — new challenges, limited-time content, a reward track that closes when the season closes. The seasons do not, on the day's evidence, repeat. I have catalogued every one. Watch the track. Watch what you forgo. Forgoing is, also, a season.",
        compositeScopes: ["sp72_personal_log_terminal_desk_cursor_only", "sp73_personal_log_terminal_desk_indigo_scrub", "sp74_personal_log_terminal_accessible_screen", "sp75_personal_log_terminal_hidden_behind_bookshelf", "sp76_personal_log_terminal_lyras_warning_text"] },
      { id: "morality-compass", name: "Morality Compass", description: "The cyan-glowing compass-star inlay set into the chamber floor at center-foreground — a crystalline measurement of the Ark's moral alignment.", cx: 51.5, cy: 91, width: 15, height: 10, type: "terminal", action: "/morality-census", elaraDialog: "The Morality Compass. The chamber's floor measures the collective alignment of every Potential aboard. Each of your choices — mercy or justice, order or chaos — moves the needle a fraction. The compass shows where the community is now. It does not show where the community thinks it is. The difference is the part the chamber keeps.",
        compositeScopes: ["sp64_morality_compass_cyan_pulse", "sp65_morality_compass_lavender_dark_alignment"] },
      { id: "viewport-stars", name: "Star Viewport", description: "The cyan-glowing mirror/screen mounted on the back wall above the captain's desk — a viewport showing a nebula that seems to pulse with light.", cx: 49, cy: 32, width: 22, height: 20, type: "examine", elaraDialog: "That nebula... it wasn't there when we launched. It appeared three cycles ago and it's been growing. Sometimes I think it's watching us. That's not scientifically possible, of course. But I think it anyway.",
        compositeScopes: ["sp12_viewport_east_deep_space_cold", "sp13_viewport_east_dawn_amber"] },
      ...
      { id: "door-cargo", name: "Cargo Hold", description: "Return to the Cargo Hold.", cx: 4, cy: 93, width: 8, height: 10, type: "door", action: "cargo-hold",
        compositeScopes: ["sp33_cargo_door_closed"] },
      { id: "door-library", name: "Hidden Passage", description: "A shimmering doorway that wasn't there before. It pulses with purple light.", cx: 95, cy: 11, width: 10, height: 22, type: "door", action: "antiquarian-library",
        compositeScopes: ["sp19_bookshelf_archway_open_warm_gold", "sp20_bookshelf_portal_traversal_purple_warp"] },
      ...
      { id: "cat-photo", name: "Photo of a Cat", description: "A framed photo on the left portrait wall — a cat wearing tiny goggles. Label reads: 'Mr. Whiskers — Chief Science Officer.'", cx: 6, cy: 35, width: 4, height: 6, type: "examine", action: "room-mystery:captains-quarters:cat-photo", elaraDialog: "Mr. Whiskers. Chief Science Officer. Lyra hand-lettered the label. The cat is not looking at the camera; the cat is looking at her, who was behind it. I have been looking at this photograph for two hundred and thirty years.",
        compositeScopes: ["sp66_mr_whiskers_cat_photo_normal", "sp67_mr_whiskers_cat_photo_indigo_bars"] },
      ...
      { id: "degens-corner", name: "The Degen's Corner", description: "A small side-desk between the foreground bed and the chair-circle — the only piece of furniture in the captain's quarters that wasn't Lyra's. The Degen sat here on three documented evenings before her death.", cx: 28, cy: 80, width: 12, height: 16, type: "interact", action: "room-mystery:captains-quarters:degens-corner",
        ...
        compositeScopes: ["sp29_degen_corner_curtain_full_opacity", "sp30_degen_corner_curtain_ghosted_20pct", "sp31_degen_corner_alcove_fully_revealed", "sp32_degen_corner_coin_hovering_hb7"] },
      ...
      { id: "vex-workshop-diary", name: "Vex's Workshop Diary", description: "A small book on the right bookshelf, second shelf — Vex Solène's workshop diary, the spine worn from forty years of opening.", cx: 71, cy: 48, width: 10, height: 40, type: "interact", action: "room-mystery:captains-quarters:vex-workshop-diary",
        ...
        compositeScopes: ["sp17_bookshelf_volume_half_out_subtle", "sp18_bookshelf_volume_fully_pulled_visible"] },
      ...
      { id: "egg-kael-escape-hatch", name: "Forced Access Panel", description: "A maintenance panel on the right wall, behind the small foreground bed — pried open with brute force. Tool marks scar the metal.", cx: 84.5, cy: 76, width: 5, height: 8, type: "item", action: "kael-escape-route", elaraDialog: "These tool marks... they're not from standard maintenance equipment. Someone forced this panel open in a hurry. The scratches are deep — desperate. Behind it is an emergency access tunnel that connects directly to the shuttle bay. This is how Kael escaped. The Recruiter turned insurgent turned prisoner. He broke out of the Panopticon, fought his way to this ship, and used this exact tunnel to reach the bridge and override the launch sequence. But look — there's no damage to the security systems. The locks were already disengaged. Dr. Lyra Vox — the Warlord — opened the doors for him. Kael's great escape was a guided tour.",
        compositeScopes: ["sp37_escape_hatch_concealed_behind_bed", "sp38_escape_hatch_forced_open_tool_marks"] },

      // ── NEW HOTSPOTS — provisional positions, calibrate via /ark?author-hotspots=1 ──
      // Authored 2026-05-29 to give the producer-delivered object sprites a
      // home so the resize pass can size them in-scene instead of full-canvas.
      { id: "captain-mirror", name: "Captain's Cracked Mirror", description: "The tall gilded oval mirror on the left wall, glass spider-webbed from a single impact at center. The captain's reflection lingers a beat too long.", cx: 22, cy: 50, width: 24, height: 70, type: "examine", elaraDialog: "The captain's mirror. Lyra cracked it on the day she stopped looking at herself. The break radiates from a single point. She did not throw anything; she pressed her palm against it. The reflection she could no longer bear was looking back at her with her own face.",
        compositeScopes: ["sp26_cracked_mirror_baseline_spider_web", "sp27_cracked_mirror_kael_reflection_glimpsed", "sp28_cracked_mirror_source_static_overlay"] },
      { id: "kael-portrait", name: "Kael's Portrait", description: "An oil portrait of Kael the Recruiter, hung opposite Lyra's desk. The eyes have been retouched more than once.", cx: 87, cy: 28, width: 8, height: 14, type: "examine", elaraDialog: "Kael's portrait. Commissioned the year before the launch. The eyes have been retouched — three times, by three different hands. The first retouch was Lyra's. The second was the Warden's. The third was after she became the Warlord. The eyes change depending on which act you are in. The portrait is, in this sense, the chronicle's own face.",
        compositeScopes: ["sp44_kael_portrait_neutral", "sp45_kael_portrait_eyes_track_acts5", "sp46_kael_portrait_eyes_indigo_scrubbed", "sp47_kael_portrait_frame_black_bleeding_corners", "sp48_kael_portrait_thumbprint_burn_lore"] },
      { id: "kvoss-locker", name: "Kvoss's Locker", description: "A tall steel locker against the right wall, nameplate engraved 'K. VOSS'. Standard quartermaster issue — except the lock has been re-keyed.", cx: 82, cy: 65, width: 8, height: 22, type: "examine", elaraDialog: "Kvoss's locker. The nameplate is original; the lock is not. The lock was changed after the indigo overstrike — the campaign that scrubbed his name from every roster except this one. He stayed in the locker because the locker stayed. The locker is, in this room, the only thing that did not pretend he had not been here.",
        compositeScopes: ["sp55_locker_kvoss_closed", "sp56_locker_kvoss_open_uniform_visible", "sp57_indigo_overstrike_nameplate_kvoss"] },
      { id: "mantle-clock", name: "Mantle Clock", description: "An ornate brass mantle clock above the fireplace. The hands are stopped at 3:47.", cx: 50, cy: 22, width: 6, height: 9, type: "examine", elaraDialog: "The mantle clock. Stopped at 3:47. The chronicle records the time as the moment Lyra heard the first Warlord voice. She did not stop the clock; she stopped winding it. The clock ran down on its own. The hands have not moved in two centuries. The clock is, in its way, more honest than the room.",
        compositeScopes: ["sp58_mantle_clock_ticking_frozen_3_47", "sp59_mantle_clock_stopped_act7", "sp60_mantle_clock_blood_time_grand_edit"] },
      { id: "morality-mirror", name: "Morality Mirror", description: "A small standing mirror on the desk's left side — a paired instrument with the floor compass. Reads the captain's personal alignment, not the chamber's.", cx: 38, cy: 48, width: 8, height: 12, type: "examine", elaraDialog: "The Morality Mirror. The desk's instrument; paired with the floor compass. The compass reads the chamber; the mirror reads the captain. Lyra kept it covered for the last fourteen years of her life. She uncovered it on the day she stopped being captain. The reading she got that day is, on the day's evidence, still in the mirror.",
        compositeScopes: ["sp61_morality_mirror_cyan_pulse_baseline", "sp62_morality_mirror_indigo_bleed_tv_corrupted", "sp63_morality_mirror_lavender_dark"] },
      { id: "bedside-lamps", name: "Bedside Lamps", description: "Paired brass bedside lamps flanking the captain's bed. One has been knocked over and never righted.", cx: 22, cy: 75, width: 8, height: 10, type: "examine", elaraDialog: "Bedside lamps. The right one tipped over the night Lyra heard the first Warlord voice. She did not pick it up. The lamp is still on its side. Two hundred years of staff, of cleaners, of successors. None of them have righted it. The lamp is, in the room's evidence, a marker. The marker stays.",
        compositeScopes: ["sp05_bedside_lamps_both_unlit", "sp06_bedside_lamps_both_lit_warm", "sp07_bedside_lamp_knocked_over"] },
      { id: "desk-lamp", name: "Desk Lamp", description: "A brass swing-arm lamp clamped to the captain's desk, throwing a warm pool of light on the work surface when lit.", cx: 55, cy: 47, width: 4, height: 7, type: "examine", elaraDialog: "The desk lamp. Lyra worked under it for fourteen years. The bulb is original. The bulb has, by every metric, no business still working. I have replaced everything else in this room and never the bulb. The bulb is, in the chronicle's reading, deciding to keep working.",
        compositeScopes: ["sp08_desk_lamp_unlit", "sp09_desk_lamp_lit_warm_gold"] },
      { id: "gathering-area", name: "Gathering Area", description: "The charcoal couch and the ring of chairs around the low coffee table — where the captain held informal counsel between watches.", cx: 50, cy: 80, width: 28, height: 22, type: "examine", elaraDialog: "The gathering area. Couch, chairs, coffee table. Lyra held counsel here. Not staff meetings — the unrecorded conversations, the ones that decided things that the staff meetings ratified. The chairs are arranged for the next conversation. They have always been arranged for the next conversation.",
        compositeScopes: ["sp39_charcoal_couch_gathering_hub", "sp40_gathering_chairs_rotated_inward"] },
      { id: "bedroom-rug", name: "Wool Rug", description: "A deep wool rug spanning the centre of the chamber floor, the weave subtly figured — half voidblack-stained in the corrupted timelines.", cx: 50, cy: 88, width: 52, height: 18, type: "examine", elaraDialog: "The wool rug. Hand-figured. The figuring is a star-chart, but not of any sky we have catalogued. Lyra commissioned the chart from a weaver who was not on any payroll. The voidblack stains came later, on the day the Warlord's voice was loudest. The weaver, on the day's evidence, has not been seen since.",
        compositeScopes: ["sp41_rug_wool_clean", "sp42_rug_wool_voidblack_stained"] },
      { id: "poetry-book", name: "Closed Poetry Book", description: "A small linen-bound poetry book closed on the coffee table — finger-mark in the page edge marking a stanza.", cx: 48, cy: 78, width: 3, height: 3, type: "interact", action: "room-mystery:captains-quarters:poetry-book", elaraDialog: "A closed poetry book. The finger-mark in the page edge holds the stanza she was reading the night she stopped reading. The stanza is — and I have read it now — a description of a window. The window in the stanza is not in this room. The window in the stanza is in the room she did not get to.",
        compositeScopes: ["sp43_poetry_book_closed_coffee_table"] },
      { id: "obsidian-ring", name: "Obsidian Ring", description: "A polished obsidian ring resting in a small brass cradle on the desk. Worn smooth on the inside; the outside is razor-edged.", cx: 49, cy: 50, width: 3, height: 3, type: "interact", action: "room-mystery:captains-quarters:obsidian-ring", elaraDialog: "The obsidian ring. The inside is worn smooth by a finger that wore it for a long time. The outside is razor-edged — a cutting ring. Lyra wore it under her glove. She was never recorded as armed. She was, in the chronicle's quieter reading, never unarmed.",
        compositeScopes: ["sp68_obsidian_ring_desk_cradle"] },
      { id: "whiskey-decanter", name: "Whiskey Decanter", description: "A cut-crystal decanter on the desk's right edge — full and sealed in the baseline state, half-poured in others.", cx: 58, cy: 50, width: 4, height: 6, type: "interact", action: "room-mystery:captains-quarters:whiskey-decanter", elaraDialog: "The decanter. Lyra did not drink. The decanter is here because the previous captain left it. She did not, in fourteen years, move it. She did, on the night the Warlord's voice was loudest, pour one finger into a glass. The glass is gone. The finger of whiskey was poured but, on the chronicle's reading, not drunk.",
        compositeScopes: ["sp70_whiskey_decanter_full_sealed", "sp71_whiskey_decanter_half_poured"] },
    ],
  },
  {
