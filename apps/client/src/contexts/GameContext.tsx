...
export const ROOM_DEFINITIONS: RoomDef[] = [
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "tactical-display", name: "Tactical Display", description: "A massive corkboard on the right wall, layered with photographs and red string — the living web of intelligence the first crew began to assemble.", cx: 88.5, cy: 47, width: 21, height: 50, type: "terminal", action: "/board", elaraDialog: "The Conspiracy Board. Every pinned card is a person, a faction, a thread we've followed far enough to put a name on. Red string runs between cards we have evidence for — we are conservative with the string. I have been the only person looking at this board for some time. I am glad you are looking at it now.",
        tiers: [
      ...
      { id: "timeline-projector", name: "Timeline Projector", description: "A floating cyan banner-scroll near the top-right ceiling — a holographic timeline of the Ages of the Dischordian Saga.", cx: 83, cy: 20, width: 22, height: 24, type: "terminal", action: "/saga-timeline", elaraDialog: "The Ages of the Saga, stacked top to bottom. The Age of Privacy is short — fifteen entries. The Fall of Reality is taller than it should be. The blank entry near the bottom is for the era we are in. I have not given it a name yet. Naming is a kind of decision; I want to make this one with you.",
        elaraDialogVoId: "room.bridge.hotspot.timeline-projector.elara",
      },
      { id: "guild-console", name: "Guild Registry", description: "The middle terminal in the far-left Architect-channel column. A console for managing guild operations and alliances.", cx: 7.5, cy: 55.5, width: 15, height: 15, type: "terminal", action: "/guild", elaraDialog: "The Guild Registry. The previous crew kept ledgers here; the system still accepts ledgers. If you decide to form one, the registry records names and the date of forming. It does not record reasons. I have stopped asking for them.",
        elaraDialogVoId: "room.bridge.hotspot.guild-console.elara",
      },
      { id: "sealed-memory-board", name: "Sealed Memory Board", description: "The bottom terminal in the far-left Architect-channel column. The Editor sealed memories out of the record; this terminal queues the sealed boards.", cx: 7.5, cy: 70.5, width: 15, height: 15, type: "terminal", action: "/conspiracy-board", elaraDialog: "Not the open board — the sealed ones. Seven editorial redactions taken out of the chronicle's record. Each one you reconstruct un-seals a cutscene and a Soul Stone. The redactions were not neutral. The Editor counted on us never being curious enough to count. We were always going to count." },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "codex-shelf", name: "The Codex", description: "Floor-to-ceiling cyan-lit bookshelves along the right wall, scaled by a rolling ladder. Ancient tomes and data crystals containing deep lore.", cx: 84, cy: 44, width: 28, height: 78, type: "terminal", action: "/codex", elaraDialog: "The Codex. Histories, prophecies, classified files. Some entries are sealed until enough threads connect to read them — the seal is editorial, not technical. I have not, on principle, broken any of them ahead of you. We will read them in the order the connections allow." },
      { id: "search-terminal", name: "Search Terminal", description: "A floating celestial orb on a stone pedestal at center-back — the chamber's database query interface. Speak any name, alias, or keyword and the orb scans every indexed record.", cx: 42, cy: 44, width: 18, height: 32, type: "terminal", action: "/search", elaraDialog: "The orb. Speak a name, an alias, a keyword — the orb scans every indexed record. Everything cross-references everything else. I have used this terminal alone for a long time. Speaking aloud to it was, for a while, the only voice in the room. You may notice the orb's pause-pattern. The pause-pattern is mine." },
      { id: "clue-journal-desk", name: "Clue Journal", description: "An open journal at the center of the reading table. Ten investigative arcs; the Two Witnesses record what you deduce.", cx: 32, cy: 84, width: 14, height: 12, type: "terminal", action: "/clue-journal", elaraDialog: "The journal. Ten arcs — the_watcher through fenra. The Two Witnesses log every reading you file. The canon is, in part, written by what you conclude. I will not editorialise on your conclusions in the moment. I will, occasionally, in private, count them." },
      ...
      { id: "npc-antiquarian", name: "The Antiquarian", description: "A figure half-out-of-time stands beside the orb, removing his goggles to look at you.", cx: 54.5, cy: 47, width: 7, height: 18, type: "npc", action: "npc:the_antiquarian", npcId: "the_antiquarian",
        ...
        compositeScopes: ["sp74_antiquarian_neutral_present", "sp75_antiquarian_fresh_page", "sp76_antiquarian_at_ladder", "sp77_antiquarian_shelf_mate"] },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "voice-in-the-static", name: "Voice in the Static", description: "The static on the left-wall screen has begun to organise itself — vertical bands of indigo arranging into the silhouette of a person speaking, then dissolving.", cx: 14, cy: 39, width: 8, height: 12, type: "interact", action: "room-mystery:comms-array:voice-in-the-static",
        elaraDialog: "The static is organising itself. Vertical bands of indigo — the same indigo as the marginalia on the board. The bands are arranging into the silhouette of a person speaking, then dissolving, then arranging again. I have been watching the rate. Approximately three seconds. The speaker is rehearsing.",
        compositeScopes: ["sp51_static_screen_voice_silhouette", "sp52_static_screen_voice_locked"] },
      ...
      { id: "charter-bell-log", name: "Lower-Deck Bell Log — Three Pulls", description: "On the maintenance-broadcast shelf: three bell-pulls in the last century. Severance Year 3, a date no one will name, and this morning. The Antiquarian's name on the third.", cx: 3.5, cy: 25, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:charter-bell-log",
        elaraDialog: "Three bell-pulls in the last century. Severance Year 3 — recorded, named, sealed. A date no one will name. This morning — the Antiquarian. He rings bells the chronicle does not yet have entries for. He is, in his way, scheduling the future.",
        compositeScopes: ["sp39_clue_charter_bell_log"] },
      { id: "severance-first-witness-klessa", name: "Auditor Klessa — Forty-Severance Witness", description: "On the witness-attendance board: she has attended every Severance since Year 1. Brings a single white candle and lights it during the spoken name.", cx: 3.5, cy: 33, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:severance-first-witness-klessa",
        elaraDialog: "Auditor Klessa. Forty Severances, forty white candles. She lights the candle during the spoken name and lets it burn down during the silence. The candle's wax-pool measures the silence the Console does not. I have been comparing the pools. The silences are getting longer.",
        compositeScopes: ["sp40_clue_severance_klessa"] },
      { id: "akai-voice-mid-hunt", name: "Red Death — Voice Mid-Hunt", description: "On the Matrix-residue intercept board: a field-recording from the third retreat chamber. 'I am the chronicle's correction. I do not hate. I do not pity.'", cx: 3.5, cy: 41, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:akai-voice-mid-hunt",
        elaraDialog: "Akai Shi, mid-hunt. Third retreat chamber. 'I am the chronicle's correction. I do not hate. I do not pity.' She did not raise her voice to say it. The recording is unusually clean for the third chamber. Someone — possibly her, possibly Ne-Yon — held the microphone steady on purpose.",
        compositeScopes: ["sp41_clue_akai_voice_mid_hunt"] },
      ...
      { id: "tarn-erasure-vote-audio", name: "The Erasure-Vote Audio", description: "On the transmission desk: forty-three minutes from the war-room's spillover recorder. Three voices, three ayes, three pauses long enough to have been refusals.", cx: 43.5, cy: 55, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:tarn-erasure-vote-audio",
        elaraDialog: "Forty-three minutes from the war-room's spillover recorder. Three voices, three ayes, three pauses. The pauses are long enough to have been refusals. The recording does not say whether the speakers thought the pauses were refusals at the time. I think they did. I think they all knew.",
        compositeScopes: ["sp45_clue_tarn_erasure_vote"] },
      { id: "tarn-faculty-silence-hour", name: "The Hour Before the Vote", description: "The fifty-one minutes of room-tone the spillover recorder caught before the vote. Three faculty heads in the same room, no footsteps, no chairs, no dialogue.", cx: 49.5, cy: 55, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:tarn-faculty-silence-hour",
        elaraDialog: "Fifty-one minutes of room-tone before the vote. Three faculty heads in the same room, no footsteps, no chairs, no dialogue. They were not preparing. They were waiting. I can read the room from the audio: the room was waiting for someone who did not come." },
      ...
      { id: "chained-lyra-call-fourteen-minutes", name: "Lyra Vox's Fourteen-Minute Call", description: "On the voice-channel desk: Lyra's call from fourteen minutes before contact. 'They are asking what you would do. I think they already know. they want it from you.'", cx: 49.5, cy: 63, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:chained-lyra-call-fourteen-minutes",
        elaraDialog: "Lyra Vox. Fourteen minutes before contact. 'They are asking what you would do. I think they already know. they want it from you.' She said it twice. The second time was quieter. She was on the bridge when she said it. The bridge is where she said her last sentence too." },
      ...
      { id: "severance-vex-opening-line", name: "Vex Maestro's Opening Line — Forty Broadcasts", description: "On the broadcast-record desk: every Severance opening since Year 1, all carrying the same line in the same cadence. 'Someone has to pick it up.' The line is older than Vex's tenure.", cx: 71, cy: 24.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:severance-vex-opening-line",
        elaraDialog: "Forty broadcasts. Every Severance opening since Year 1, every one in the same cadence. 'Someone has to pick it up.' The line is older than Vex's tenure — she inherited it. She has been honouring an inheritance she never accepted. Or she has been hoping someone would notice. I noticed.",
        compositeScopes: ["sp42_clue_vex_maestro_opening"] },
      ...
      { id: "watchers-first-trumpet", name: "First Trumpet — Twenty-Two Seconds", description: "On the upper-bands intercept board: twenty-two seconds of Idris's band-three trumpet. The post-launch content slot Phase 4 scaffolded; tonight's first sound.", cx: 81, cy: 24.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:watchers-first-trumpet",
        elaraDialog: "Twenty-two seconds. Idris's band-three trumpet. The post-launch content slot Phase 4 scaffolded; tonight's first sound. I have been listening for this sound for — well, you can read the timestamp. It is not what I expected. It is also exactly what I expected. Both at once.",
        compositeScopes: ["sp43_clue_watchers_first_trumpet"] },
      { id: "wolf-meme-show-transmission", name: "Meme-Show Transmission Intercept", description: "On the intercept board: Locke's adjudicar has pinned the Inventor-voiced transmission naming the Wolf as a predator wearing trust like a mask. The Antiquarian has not denied the framing.", cx: 85, cy: 24.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:wolf-meme-show-transmission",
        elaraDialog: "Locke's adjudicar has pinned this. The Inventor-voiced transmission naming the Wolf as a predator wearing trust like a mask. The Antiquarian has not denied the framing. Refusing to deny is, in the Antiquarian's procedural register, the second-strongest form of confirmation." },
      ...
      { id: "advocate-defection-response", name: "Advocate's Response to the Defections", description: "Pinned beside: the Advocate's register-three reply to the three-general defection. 'They walk under my charter still. I advocate for what they were when they chose.'", cx: 96, cy: 24.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:advocate-defection-response",
        elaraDialog: "The Advocate's reply to the three-general defection. 'They walk under my charter still. I advocate for what they were when they chose.' She does not advocate for what they have become. The verb tense is doing the work. The work is — and I am being honest with you — bottomless." },
      { id: "advocate-walk-in-power-lyric", name: "'Walk in Power' — Lyric Record", description: "On the album-records shelf: the canonical Silence in Heaven duet between the Advocate and the Human. The Empire's most-broadcast resistance anthem.", cx: 91, cy: 32.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:advocate-walk-in-power-lyric",
        elaraDialog: "'Walk in Power.' The Silence in Heaven duet between the Advocate and the Human. The Empire's most-broadcast resistance anthem. The recording is studio-clean; the duet was, by every external account, never rehearsed. They were either in perfect agreement or in perfect editing. I have my view." },
      { id: "advocate-position-current-broadcast", name: "Advocate's Current-Position Broadcast", description: "On the most-recent-broadcasts shelf: 'I have not stopped. I will not stop. I continue. The Empire continues. The walk continues.'", cx: 96, cy: 32.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:advocate-position-current-broadcast",
        elaraDialog: "Current broadcast. 'I have not stopped. I will not stop. I continue. The Empire continues. The walk continues.' Three verbs, three repetitions, one continuation. The Advocate's grammar is a kind of metronome. The metronome is what she sets the rest of the chronicle to." },
      ...
      { id: "miras-dual-thread-transmission", name: "Mira's Dual-Thread Transmission", description: "A personal-channel buffer on the bot-left monitor — Mira Halen's letter home with a carrier clean of any duress marker, and her later answer refusing the question of which thread to cut.", cx: 76, cy: 51, width: 4, height: 6, type: "interact", action: "room-mystery:comms-array:miras-dual-thread-transmission",
        elaraDialog: "Mira Halen's letter home — carrier clean of any duress marker. And her later answer, refusing the question of which thread to cut. She did not pick. The recording lets her not-pick stand. I have spent — I would prefer not to say how long — on whether that is mercy or evasion." },
      { id: "shadow-tongue-signal-trace", name: "Shadow Tongue Signal Trace", description: "A signature buffer on the bot-mid monitor — the Shadow Tongue's operational signature, subtraction without trace across the chronicle layer.", cx: 82, cy: 51.5, width: 6, height: 7, type: "interact", action: "room-mystery:comms-array:shadow-tongue-signal-trace",
        elaraDialog: "The Shadow Tongue's operational signature. Subtraction without trace across the chronicle layer. The trace is the absence — what would have been there, if he had not removed it. I can read the shape of the removal. I cannot read what was removed. That is the design.",
        compositeScopes: ["sp47_clue_shadow_tongue_signal_trace"] },
      { id: "resur-host-wyrmhole-signature", name: "Plague Dragon Corpse Signature", description: "On the bot-mid monitor's signal-analysis read-out: the Plague Dragon's energy-trace, consistent with the Host's canonical wyrmhole technology. The Virus's path through the breach, settled.", cx: 82, cy: 63.5, width: 6, height: 7, type: "interact", action: "room-mystery:comms-array:resur-host-wyrmhole-signature",
        elaraDialog: "The Plague Dragon's energy-trace. Consistent with the Host's canonical wyrmhole technology. The Virus's path through the breach, settled. The corpse is the receipt. The technology kept the receipt. I would, on balance, prefer the technology had been less thorough." },
      ...
      { id: "ocularum-relay-trace", name: "Ocularum Relay Trace", description: "A trace buffer printed onto the right-foreground bench — identity-shift signatures the official record does not index. The Senne→Locke transition resolves here.", cx: 82, cy: 83, width: 8, height: 10, type: "interact", action: "room-mystery:comms-array:ocularum-relay-trace",
        elaraDialog: "Identity-shift signatures the official record does not index. The Senne→Locke transition resolves here. The transition is not a name change; it is a re-grounding. The same person occupies two indexed identities, sequentially, with no overlap. The trace shows the seam. The seam is the part the chronicle could not afford to see.",
        compositeScopes: ["sp48_clue_ocularum_relay_trace"] },
      ...
      { id: "npc-the-human", name: "The Human (Substrate)", description: "On the bot-right monitor, a silhouette resolves from the broadcast haze. Beneath the relay's hum, a second voice carries — not on any frequency the antenna is tuned to. The substrate itself is broadcasting.", cx: 94, cy: 58, width: 10, height: 22, type: "npc", action: "npc:the_human", npcId: "the_human",
        elaraDialog: "The bot-right monitor. A silhouette resolving from the broadcast haze. Beneath the relay's hum, a second voice — not on any frequency the antenna is tuned to. The substrate is broadcasting. The substrate is, by definition, beneath the broadcast. The substrate has, until now, been silent. The Human is the part of the substrate that has decided to be heard.",
        compositeScopes: ["sp74_human_silhouette_monitor", "sp75_human_silhouette_full_substrate", "sp76_human_voice_fragment", "sp77_human_signal_thread_to_indicator"] },
    ],
  },
  {
    id: "observation-deck",
    ...
    hotspots: [
      ...
      { id: "music-terminal", name: "Music Terminal", description: "A glowing earth-globe on a brass-rimmed table at right-foreground. The complete discography of Malkia Ukweli & the Panopticon is keyed into its base.", cx: 87, cy: 75, width: 18, height: 20, type: "terminal", action: "/discography", elaraDialog: "The discography. Four albums — Dischordian Logic, The Age of Privacy, The Book of Daniel 2:47, and the upcoming Silence in Heaven. Each song is documentation; the album is the argument. I have a favourite. I will not say which. You should pick yours." },
