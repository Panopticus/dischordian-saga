...
export const ROOM_DEFINITIONS: RoomDef[] = [
  ...
  },
  {
    ...
    hotspots: [
      // Mystery wiring — charter.missing_signatory · e1 + e2 (the
      // two clues the arc authored to be found in this room, each
      // surfaced as its own thematic artifact rather than bundled
      // into a single "dlc index" hotspot.)
      { id: "charter-silt-fragment", name: "The Charter Fragment", description: "On the central reading table, under archival glass — a scrap of hand-cured vellum. Six legible signatures; the seventh sealed under a black blister of mineralised wax.", x: 28, y: 56, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-silt-fragment" },
      { id: "charter-advocate-signature", name: "The Advocate's Marginalia", description: "Beside the charter fragment on the reading table — a high-resolution rubbing of the charter's reverse. The Advocate's counter-signature carries the only witness annotation on the founding document.", x: 36, y: 56, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-advocate-signature" },
      ...
      { id: "charter-mirror-charter", name: "The Mirror Charter", description: "A second pane of glass on the reading table — the four-house delegation's mirror of the founding charter, brought in this morning. Eight signatures, not seven.", x: 6, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-mirror-charter" },
      { id: "charter-eighth-clause", name: "The Eighth Clause Overlay", description: "A transparency overlay sliding from the catalog drawer — the mirror charter's body text laid against the founding charter's, exposing the thirty-four line clause one copy carries and the other never did.", x: 14, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-eighth-clause" },
      // Mystery wiring — severance.infernal_clause · e1 (contract + clause)
      { id: "infernal-epoch-one-contract", name: "Zyr'Koth's Epoch-One Contract", description: "Spread on the reading table: the DMC season contract Zyr'Koth produced at Nilmorg's ceremony. Front in standard form; back carrying a paragraph that has been quietly enforceable for forty seasons.", x: 27, y: 41, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:infernal-epoch-one-contract" },
      { id: "infernal-clause-back-page", name: "The Infernal Clause", description: "Under archival glass: the back-page paragraph itself. 'In the event of the champion's death, the soul-bond may be claimed by the Hierarchy in lieu of the second-cycle prize.'", x: 35, y: 41, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:infernal-clause-back-page" },
      // Mystery wiring — mechronis.chained_lesson · e1–e4 (the four
      // clues this arc authored to be found in the antiquarian
      // library: the apprentice's file, the league-vs-Academy
      // curriculum diff, Auro's hand-written folio, and Tarn's
      // year-eight retraction.)
      { id: "chained-apprentice-history", name: "Your Apprentice's File", description: "The catalog's apprentice drawer — your sponsored apprentice's enrolment, transcript, and roof-assignment. Top of cohort for two terms; countersigned by the Dean and by an off-faculty instructor named Auro.", x: 36, y: 38, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:chained-apprentice-history" },
      { id: "chained-curriculum-diff", name: "Curriculum Diff — League vs Academy", description: "Two curricula on the reading table: the league's tower-defense drill curriculum beside the Academy's. The cipher-den has done the diff; one module is missing from the Academy side and only one.", x: 44, y: 38, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:chained-curriculum-diff" },
      { id: "chained-auro-folio", name: "Auro's Module 17 Folio", description: "An eleven-page folio Sergeant Auro brought in at second bell — 'Module 17 — Feint Recognition,' written from memory and combat experience by a teacher the Academy has refused to pay.", x: 36, y: 46, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:chained-auro-folio" },
      { id: "tarn-year-eight-marginalia", name: "Tarn's Year-Eight Retraction", description: "The last leaf of the Antiquarian's marginalia compendium, in Tarn's hand at Year 8 — six lines retracting her Year-One curriculum argument and naming the cost. The Dean has not turned this leaf in six years.", x: 44, y: 46, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:tarn-year-eight-marginalia" },
      // Mystery wiring — memorial.seven_watchers · e4 (Per. M.'s confirmation)
      { id: "watchers-per-m-confirms", name: "Per. M.'s Confirmation of the Seventh Role", description: "In the central reading dome: the Antiquarian's signed minute of the conversation with Per. M. — confirming the seventh Watcher and the Closer-of-the-charter are the same role.", x: 41, y: 63, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:watchers-per-m-confirms" },
      // Mystery wiring — severance.infernal_clause · color (antiquarian-library)
      { id: "infernal-first-clause-date", name: "Forty Clauses — Contemporaneous Dates", description: "On the contract-cross-reference shelf: every clause's date matches the contract's signing week — within a seven-day window. So is every clause.", x: 86, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:infernal-first-clause-date" },
      { id: "infernal-solene-recollection", name: "Solène's Audit-Witness Recollection", description: "On the audit-witness shelf: 'the contracts came back from the season-end audit with the clauses already on them. I never saw the clauses being written.'", x: 6, y: 56, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:infernal-solene-recollection" },
      { id: "infernal-atalin-status", name: "Atalin's Current Status", description: "On the staff-roster annex shelf: Atalin is alive. Eighty-six. Lower-deck sector eleven. Has not spoken to anyone from the league in forty seasons.", x: 14, y: 56, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:infernal-atalin-status" },
      { id: "infernal-atalin-account", name: "Atalin's Forty-Year Account", description: "On the closer's-room recording: 'I wrote them because the Hierarchy would have written them if I refused. I wrote them with a flaw. I have been making myself easy to find for forty seasons.'", x: 22, y: 56, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:infernal-atalin-account" },
      { id: "infernal-atalin-at-rite", name: "Atalin at the Closing Rite", description: "On the closing-rite seating chart: Atalin sits beside Solène. They have not been in a public room in forty seasons. They cry once when the Advocate names them. They do not cry again.", x: 30, y: 56, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:infernal-atalin-at-rite" },
      // Mystery wiring — charter.second_signatory · color (antiquarian-library)
      { id: "charter2-solven-kept-record", name: "Solven Household Ledger", description: "On the reading-dome's delegation table: continuous Solven workshop records from founding to today. Customers the Architect has on no roster.", x: 54, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter2-solven-kept-record" },
      { id: "charter2-per-m-meeting", name: "Per. M.'s Closer Office — Year-Two Meeting", description: "In Per. M.'s office annex: the closer is older. The lamp still burns. The drawer is still locked. Per. M. listens for thirty-three minutes before speaking.", x: 62, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter2-per-m-meeting" },
      { id: "charter2-per-m-clarification", name: "Per. M.'s Silence-as-Vote Clarification", description: "Beside the meeting record: 'The seventh did not sign the scrub. The seventh has been holding the silence as a kind of vote. The Council has been counting the silence wrong.'", x: 70, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter2-per-m-clarification" },
      { id: "charter2-charter-addendum", name: "Charter Addendum — Eight Again", description: "On the closing-rite shelf: the folio sewn to both charters. 'We eight signed; we six scrubbed; we four kept; we eight again.'", x: 78, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter2-charter-addendum" },
      // Mystery wiring — charter.missing_signatory · color (antiquarian-library)
      { id: "charter-signatory-almir", name: "Almir of the Bow — First Signature", description: "On the founding-signatures rubbing wall: Almir's signature. The first crown-bearer. Plain, almost bored — signed last because Almir was the rider.", x: 6, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-signatory-almir" },
      { id: "charter-signatory-house-quill", name: "Three Sisters of House Quill", description: "Beside Almir's: sigils two, three, four. A ladder, eldest at the top; the youngest's loop runs into where the seventh signature should begin.", x: 14, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-signatory-house-quill" },
      { id: "charter-witness-annotation", name: "Advocate's Marginalia — 'Six Speak'", description: "On the back of the charter, the Advocate's annotation: 'six speak; one listens; one of us is the silence.' Read correctly for the first time.", x: 22, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-witness-annotation" },
      { id: "charter-archivist-office", name: "Per. M.'s Office (Four Corridors Down)", description: "Four corridors down: door unlocked, desk occupied. The lamp has burned for twenty-two unbroken epochs — its filament mineralised the same way the wax is.", x: 30, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-archivist-office" },
      { id: "charter-staff-roster", name: "Library Staff Roster — Per. M. Absent", description: "Per. M. does not appear on any roster. Key, office, desk, lamp, signature on every preservation order — but not paid, hired, or registered.", x: 38, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-staff-roster" },
      { id: "charter-player-inscribes", name: "Seventh-Signature Inscription Choice", description: "On the closing-rite scroll: the empty seventh signature line is open for inscription. The player chooses whether to inscribe a name or leave it blank.", x: 46, y: 48, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:charter-player-inscribes" },
      // Mystery wiring — severance.bound_champion · color (antiquarian-library)
      { id: "severance-second-witness-broker", name: "Broker of Nilmorg — Profile", description: "In the back-room observation alcove: the aging Broker who lives in the back rooms of the Trade Empire's Nilmorg sector. Will not give a name. Pays for the candle.", x: 6, y: 40, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:severance-second-witness-broker" },
      { id: "severance-back-room-chairs", name: "Forty-One Chairs (Back Room Photograph)", description: "In the Severance-reliquary alcove: forty-one mismatched chairs, each facing a shelf at eye-height holding a glass jar with a faint blue glow.", x: 14, y: 40, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:severance-back-room-chairs" },
      { id: "severance-broker-first-chair", name: "Chair One — Reserved Annotation", description: "Beside the chairs photograph: 'Chair One is reserved. I sit there each season after the bond is poured. I have not yet failed to stand.'", x: 22, y: 40, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:severance-broker-first-chair" },
      { id: "severance-jar-inventory", name: "Forty-One-Jar Inventory", description: "On the jar-inventory shelf: forty-one jars. The first jar is heaviest; its glow is steadier. The most recent jar is empty, waiting for tonight's bond.", x: 30, y: 40, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:severance-jar-inventory" },
      { id: "severance-first-chair-log", name: "First-Chair Hidden Ledger", description: "Pulled from inside Chair One's cushion: a small ledger. Forty entries. Each a date and one word: 'stood.'", x: 38, y: 40, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:severance-first-chair-log" },
      { id: "severance-player-choice-record", name: "Apprentice First-Refusal Record", description: "On the apprentice-choice display: 'sit if you can. don't if you can't. either way, the protocol is written tonight.'", x: 46, y: 40, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:severance-player-choice-record" },
      // Mystery wiring — memorial.forgotten_names · color (antiquarian-library)
      { id: "memorial-first-volume", name: "Year of the Lost — First Volume", description: "On the chronicle-shelf: hand-bound, leather-quilted, 812 pages. Seven hundred ninety-eight names inscribed; fourteen pages blank with 'unwitnessed' in pencil.", x: 62, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:memorial-first-volume" },
      { id: "memorial-torn-page", name: "Keeper's Log — Torn Page", description: "In the log fragment-drawer: the keeper's log torn at the page that should contain the fourteenth imprint's id. The tear is old; the keeper does not remember.", x: 70, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:memorial-torn-page" },
      { id: "memorial-fourteen-inscribed", name: "Closing-Rite Volume — All Inscribed", description: "Beside the first volume: the volume closed at last bell. Eight hundred and twelve names — and one folio of additional inscriptions for I-1.", x: 78, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:memorial-fourteen-inscribed" },
      { id: "memorial-player-carrier-choice", name: "Carrier-Choice — Volume Disposition", description: "The Antiquarian's question: 'will you leave the volume in the library, or carry it back, by hand, to the imprint room? both are honest.' The choice is the player's.", x: 86, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:memorial-player-carrier-choice" },
      // Mystery wiring — mechronis.missing_professor · color (antiquarian-library)
      { id: "tarn-lore-proposal", name: "Lore Faculty Proposal — Veth", description: "On the Lore-faculty submissions shelf: six modules, archive-heavy, citing Tarn's seminar series on the Antiquarian's marginalia.", x: 30, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:tarn-lore-proposal" },
      { id: "tarn-binder-recovered", name: "Tarn's Binder, Recovered", description: "On Tarn's desk: twenty-two pages, weighted by a pebble. Page one is the resignation. Page twenty-two reads: 'vote on the curriculum, not on me.'", x: 38, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:tarn-binder-recovered" },
      { id: "tarn-curriculum-on-desk", name: "Tarn's Curriculum — Cleaned for Council", description: "Beside the binder: twenty pages copied for the Council. Tarn's authorship line is left blank by Roen. The blank is the choice the player will resolve.", x: 46, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:tarn-curriculum-on-desk" },
      { id: "tarn-pebble", name: "Tarn's Pebble", description: "On Tarn's desk under the binder: a grey, water-smoothed lower-deck stone. The pebble is heavier than it looks. The Dean has been weighing it during the vote-prep.", x: 54, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:tarn-pebble" },
      // Mystery wiring — memorial.seven_watchers · color (antiquarian-library)
      { id: "watchers-communique-appendix", name: "Communiqué Appendix — Year-Two", description: "On the communiqué-appendix shelf: the Antiquarian's single-page addition to the year's Council communiqué. One year to consider what the seventh's role might be named.", x: 50, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:watchers-communique-appendix" },
      { id: "watchers-seventh-appendix", name: "Memorial Plaza Volume — Seventh Appendix", description: "In the final folio: 'I will not be named until the Ark has named what I am for.' A blank page sewn beside six.", x: 14, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:watchers-seventh-appendix" },
      { id: "watchers-six-lines-inscribed", name: "Six Watcher-Lines, Inscribed", description: "On the Memorial Plaza shelf: six Watcher-role descriptions hand-copied by the Antiquarian, sewn between Aren's name and Year-3 inscriptions.", x: 22, y: 32, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:watchers-six-lines-inscribed" },
      // Mystery wiring — resurrectionist.cycle_walker · color (antiquarian-library)
      { id: "resur-antiquarians-unknown-entry", name: "Antiquarian's 'Unknown' Entry", description: "On the chronicle-open-archive shelf: 'unknown — case shelved at last review.' A small later annotation in a different hand: 'kept current.' The annotator is not named.", x: 70, y: 24, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:resur-antiquarians-unknown-entry" },
      { id: "resur-cult-curated-terminus-map", name: "Cult-Curated Terminus Map", description: "On the chronicle-reference wall: seven walking figures around the Source Kael. Six match first-wave Potential silhouettes. The seventh wears a long-beaked mask.", x: 78, y: 24, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:resur-cult-curated-terminus-map" },
      // Mystery wiring — akai_shi.red_death · color (antiquarian-library)
      { id: "akai-jericho-witness-page", name: "Jericho's Witness Page", description: "On the Thaloria-archive shelf: Jericho Jones's hour-after-mercy witness page. 'Akai Shi was already gone. I did the work she would have asked me to do.'", x: 50, y: 24, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:akai-jericho-witness-page" },
      { id: "akai-targets-list", name: "Red Death — Open Targets List", description: "In the case-files drawer: fourteen entities the Red Death has eliminated. Each entry carries a date, a place, and the chronicler's note.", x: 58, y: 24, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:akai-targets-list" },
      { id: "akai-kill-record", name: "Necromancer Kill — Day 15 of Fracture", description: "On the case-closure shelf: the Antiquarian's record entry for Day 15 of Fracture, Year 117,046 A.A. The kind of mercy chosen: clean.", x: 22, y: 24, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:akai-kill-record" },
      { id: "akai-red-death-returns", name: "Red Death Returns from the Matrix", description: "Beside the kill record: twelve cycles after the kill, the Red Death exits the Matrix through the same fold. Unchanged. Time-displacement band intact. Targets list now closed.", x: 30, y: 24, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:akai-red-death-returns" },
      { id: "akai-case-closes", name: "Case File Closes", description: "The Antiquarian's closing seal: 'The case being closed does not mean the case-bearer is.' The arc the Resurrectionist authored is complete.", x: 38, y: 24, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:akai-case-closes" },
      // Mystery wiring — advocate.blood_weave · e5 (closing Walk-in-Power broadcast)
      { id: "advocate-closing-walk-in-power-broadcast", name: "Closing 'Walk in Power' Broadcast", description: "In the case-closure playback alcove: the duet's final cadence, captured live from a current Empire-of-Shadows transmission tower. The Antiquarian's canonical closure for the arc.", x: 62, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:advocate-closing-walk-in-power-broadcast" },
      // Mystery wiring — wolf.anara_hunt · color (antiquarian-library)
      { id: "wolf-journal-xxxviii", name: "Antiquarian's Journal Entry XXXVIII", description: "On the chronicle-current shelf: 'Anara. My creation. My refuge. My failure.' The Antiquarian's hand-written admission of his pocket-universe's design flaw.", x: 50, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-journal-xxxviii" },
      { id: "wolf-corruption-ledger", name: "Wolf's Predator-Ledger", description: "In the Anara-affairs drawer: the Quarchon-hand ledger matching Lycos's archived sample. Four entries, three 'mercy: n', one 'mercy: y'.", x: 58, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-corruption-ledger" },
      { id: "wolf-antiquarians-admission", name: "Antiquarian's Design-Failure Admission", description: "On the Anara design-failure shelf: the Antiquarian's pressed admission of moving heroes into Anara without verifying the Wolf's containment.", x: 22, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-antiquarians-admission" },
      { id: "wolf-first-words-recording", name: "Wolf's First Words (Reanimation)", description: "In the cosmic-archaeology audio drawer: the Wolf's first words at reanimation. 'I will give the chronicle the kind of mercy I was given: clean.'", x: 30, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-first-words-recording" },
      { id: "wolf-current-position", name: "Wolf's Current Position (Hall of Disappearances)", description: "On the Anara live-tracking board: the Wolf in the Hall of Disappearances for three cycles. Three more heroes scheduled to enter.", x: 38, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-current-position" },
      { id: "wolf-antiquarians-concession", name: "Antiquarian's Closing Concession", description: "On the case-closure shelf: 'I cannot ask the chronicle's reader to resolve what I designed wrong. I can only ask: walk into the Hall.'", x: 46, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-antiquarians-concession" },
      { id: "wolf-hall-threshold", name: "Hall of Disappearances — Diagram", description: "On the threshold-record shelf: a circular chamber with twelve niches, each holding an empty pedestal. The chamber's ceremonial geometry annotated.", x: 54, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-hall-threshold" },
      // Mystery wiring — storm.architect_of_flux · color (antiquarian-library)
      { id: "storm-dossier-quote", name: "Storm Dossier — Operational Sentence", description: "On the right-wall upper bookshelf (cosmic-archaeology section): the Storm's dossier open at its operational sentence. Older than every active Ne-Yon.", x: 90, y: 14, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-dossier-quote" },
      { id: "storm-polarity-lyric-record", name: "Polarity — Lyric Record", description: "On the right-wall upper bookshelf (lyric-records row): the Book of Daniel 2:47 'Polarity' record, signed in the Enigma's hand. The 12th Ne-Yon's endorsement of the Storm/Silence pairing.", x: 90, y: 22, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-polarity-lyric-record" },
      { id: "storm-dreamers-noted-entry", name: "Dreamer's One-Word Entry on the Storm", description: "On the right-wall upper bookshelf (Dreamer-archive section): the Dreamer's library carries one entry on the Storm — 'noted.' Nothing else.", x: 76, y: 14, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-dreamers-noted-entry" },
      { id: "storm-eternal-active-status", name: "Storm Dossier Status: Active", description: "On the right-wall upper bookshelf (dossier-status row): the Storm reads Active despite the Degen-bible's 'only one still awake.' A productive ambiguity the case does not resolve.", x: 83, y: 14, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-eternal-active-status" },
      // Mystery wiring — mechronis.chained_lesson · color (antiquarian-library)
      { id: "chained-tarn-residency-marginalia", name: "Tarn's Residency Marginalia", description: "On the marginalia shelf: Tarn's Year-Two notebook annotation naming Module 17 as the module the Academy will not teach.", x: 52, y: 38, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:chained-tarn-residency-marginalia" },
      { id: "chained-auro-at-rite", name: "Auro at the Closing Rite", description: "In the case-rite annex: the Antiquarian's hand-written note on Auro's attendance. She nods once when Tarn's name is read. She does not nod when the Dean apologises.", x: 60, y: 38, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:chained-auro-at-rite" },
      // Mystery wiring — wolf.anara_hunt · e1 + e2 (League hall reproduction + chair pattern)
      { id: "wolf-empty-chair", name: "Anara League-Hall Reproduction (Empty Chair)", description: "In a quiet annex off the central dome: the Antiquarian's scaled twelve-chair reproduction of Anara's League hall. One chair stands empty; the Antiquarian has annotated it 'WHO TOOK THEM.'", x: 48, y: 74, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-empty-chair" },
      { id: "wolf-three-empty-chairs", name: "The Cataloguer's Pattern Wall", description: "On the wall behind the reading dome: three more re-coloured chairs. Medic, signals officer, tactician, residue-specialist healer. The pattern stopped being absence the morning the healer's chair emptied.", x: 56, y: 74, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-three-empty-chairs" },
      // Mystery wiring — akai_shi.red_death · e2 (Resurrectionist's seal)
      { id: "akai-resurrectionist-seal", name: "Resurrectionist's Recovery Seal", description: "On the central reading table: the Cycle Walker's wheel-and-thread seal pulled from Akai Shi's recovery manifest. The same seal appears on the Wolf's reanimation centuries later.", x: 55, y: 85, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:akai-resurrectionist-seal" },
      // Mystery wiring — resurrectionist.cycle_walker · e1 + e4 (plague-mask seal + twin-text)
      { id: "resur-plague-mask-seal", name: "Resurrectionist Case-File Seal", description: "In the cosmic-archaeology drawer: forty case-files, every one stamped with the same long-beaked plague-mask seal. The cult calls the seal ceremonial; the pre-Empire references catalogue it as a worn object.", x: 62, y: 18, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:resur-plague-mask-seal" },
      { id: "resur-pre-empire-twin-text", name: "Pre-Empire Twin-Ne-Yon Fragment", description: "Under archival glass on the cosmic-archaeology shelf: 'the death-bound and the cycle-bound walk in pairs.' The cult reads metaphor; the pre-Empire references read literal taxonomy.", x: 70, y: 18, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:resur-pre-empire-twin-text" },
      // Mystery wiring — advocate.blood_weave · e1 + e4 (founding charter + humanity-trade spec)
      { id: "advocate-founding-charter", name: "Empire of Shadows Founding Charter", description: "Under archival glass: the founding charter, the Advocate's signature at the foot, six co-signatures following — five legible, the sixth self-redacted in her own hand.", x: 69, y: 29, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:advocate-founding-charter" },
      { id: "advocate-humanity-trade-spec", name: "Humanity-Trade Operational Specification", description: "On the Empire-of-Shadows shelf: the Advocate's itemised trade spec — three components surrendered to power the Weave, charter, and the unconditional shelter. Authored by her, in register three.", x: 77, y: 29, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:advocate-humanity-trade-spec" },
      // Re-anchored 2026-05-24 against the AAA Final antiquarian-library
      // render (14-variant audit; manifest zipDir is `antiquarians_library`,
      // plural). Visible features: floor-to-ceiling bookshelves on every
      // wall, brass mannequin/bust on a pedestal LEFT-foreground, lectern
      // with open book LEFT-CENTER, central back BRASS-FRAMED DOOR with
      // seal/sigil, card-catalog drawers right-of-door, BRONZE CANDLE-
      // LAMP on the central reading table, 6 chairs around the table,
      // right-wall brass lamp on a bookshelf.
      //
      // Major re-anchors for the 4 feature hotspots:
      //   • loredex-lectern → actual visible lectern with open book
      //     left-center (30,32,12,22)
      //   • orb-of-worlds → central bronze candle-lamp on reading
      //     table (45,38,10,18)
      //   • ancient-tomes → left-wall bookshelves only (0,5,15,85)
      //   • door-captains → actual brass-framed back-center door
      //     (43,22,16,30)
      //
      // The 100+ architect-channel mystery rectangles span y=8 through
      // y=86 across the chamber. Most map to the visually dense
      // bookshelf walls + central table + card-catalog drawers, so
      // their existing positions are workable click targets. A full
      // per-rect re-anchor of all 100+ mysteries would be a separate
      // audit pass; the 4 feature re-anchors above are the highest-
      // impact fixes.
      ...
      // Mystery wiring — Riri'Ahlia arc: the case synthesis and the genuine tri-verdict closing question
      { id: "riri-ahlia-closing-ledger", name: "The Taskmaster's Closing Ledger", description: "A case-synthesis ledger under the glyph for a portfolio entry that never closed — the siege filed as a quarter assembled in one hand, and the genuine tri-verdict closing question the archive pre-judges none of.", x: 78, y: 58, width: 7, height: 9, type: "interact", action: "room-mystery:antiquarian-library:riri-ahlia-closing-ledger" },
      // Mystery wiring — Fenra arc: the door/engine pairing folio and the case-synthesis ledger closing the §XVI roster
      { id: "fenra-door-and-engine", name: "The Door-and-Engine Folio", description: "A cross-catalogued folio filed beside the Varkul vigil cross-catalogue — the Necromancer's two senior creations as one design, and the asymmetry that Varkul receives the maker's signal and Fenra does not.", x: 30, y: 46, width: 7, height: 9, type: "interact", action: "room-mystery:antiquarian-library:fenra-door-and-engine" },
      { id: "fenra-closing-ledger", name: "The Fenra Closing Ledger", description: "The case-synthesis ledger under the glyph for an engine that does not stop — the Fenra arc assembled in one hand, and the genuine tri-verdict closing question that closes the §XVI Mystery Engine roster, pre-judging none.", x: 38, y: 46, width: 7, height: 9, type: "interact", action: "room-mystery:antiquarian-library:fenra-closing-ledger" },
    ],
  },
  ...
  },
  {
    ...
    connections: ["bridge"],
    hotspots: [
      // Mystery wiring — severance.infernal_clause · e2 (forty ledger-keepers)
      { id: "infernal-forty-ledger-keepers", name: "League Ledger-Keeper Wall", description: "The personnel display: forty seasons of ledger-keepers, forty handwriting samples, none matching the clause-writing hand. One anomaly — a Year-One name that does not appear on the wall.", x: 6, y: 8, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:infernal-forty-ledger-keepers" },
      // Mystery wiring — mechronis.chained_lesson · e1 + e2
      { id: "chained-wave-telemetry", name: "Festival-Roof Wave Telemetry", description: "The main holo-tank's reading of the apprentice's incoming Terminus wave. Standard pattern, fourteen carriers, fully winnable — fourteen years of fully winnable waves the apprentices have failed to win.", x: 13, y: 19, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:chained-wave-telemetry" },
      { id: "chained-feint-pattern", name: "League Feint-Pattern Annotation", description: "The league tower-defense desk's annotation pinned to the tank as cross-reference, naming the third-minute formation feint apprentices have not been taught to wait out.", x: 21, y: 19, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:chained-feint-pattern" },
      // Mystery wiring — mechronis.chained_lesson · color clues (war-room)
      { id: "chained-dean-admits", name: "Dean's Admission Recording", description: "On the curriculum-affairs board: the Dean's recorded admission. 'I knew Module 17 was absent. The apprentices were not the failures. The curriculum was.'", x: 29, y: 19, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:chained-dean-admits" },
      { id: "chained-trade-empire-employment", name: "Auro's Trade-Empire Employment Record", description: "Trade-Empire intelligence board: Auro on payroll as a 'route-safety contractor' for nine years — since Year 5, since the first apprentice failure.", x: 37, y: 19, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:chained-trade-empire-employment" },
      { id: "chained-dean-full-admission", name: "Dean's Full Admission", description: "Pinned beside Auro's record: the Dean's full admission of deferring to Tarn for fourteen years, with no excuse for the last six.", x: 45, y: 19, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:chained-dean-full-admission" },
      { id: "chained-amendment-three-options", name: "Three-Amendment Council Options", description: "On the council-vote display: the three amendment options — restore named, restore anonymously, or refuse and fund Auro's Trade-Empire role permanently.", x: 53, y: 19, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:chained-amendment-three-options" },
      // Mystery wiring — memorial.seven_watchers · e3 (Council communiqué)
      { id: "watchers-council-communique", name: "Council Communiqué of the Six", description: "On the chronicle-public display: the Antiquarian's communiqué naming all six Watchers by band and audience, thanking the seventh for the silence — the Ark's first public statement on the founding Watchers in eight epochs.", x: 20, y: 30, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:watchers-council-communique" },
      // Mystery wiring — resurrectionist.cycle_walker · e2 (Second Fall casualty count)
      { id: "resur-second-fall-casualty-count", name: "Second Fall Casualty Count", description: "On the New-Babylon-affairs board: the Second Fall's casualty count. Millions among the populace; zero among Potentials; zero among awake Ne-Yons. The cult calls it miraculous; the Architect did not intervene.", x: 27, y: 41, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:resur-second-fall-casualty-count" },
      // Mystery wiring — storm.architect_of_flux · e3 + e4 (Advocate's Weave + calm-event table)
      { id: "storm-advocates-blood-weave", name: "Advocate's Blood-Weave Journals", description: "On the Empire-of-Shadows display: the Advocate's operational journals — every Weave deployment within a Storm-active window, the Storm credited as 'a patron of opportunity, indifferent to outcome.'", x: 34, y: 52, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:storm-advocates-blood-weave" },
      { id: "storm-event-correlation-table", name: "Calm-Event Correlation Table", description: "The war-room's correlation table mapping the Storm's nine calms onto the chronicle's most consequential planning events. Seven matched; two unrecorded; the chronicle's gap, not the cadence's.", x: 42, y: 52, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:storm-event-correlation-table" },
      // Mystery wiring — severance.infernal_clause · color (war-room)
      { id: "infernal-zyrkoth-arrival", name: "Zyr'Koth's Council-Chamber Arrival", description: "On the arrival log: the hall does not go silent. The hall goes quieter — the kind of quiet a room makes when it remembers a story it would rather not tell.", x: 38, y: 79, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:infernal-zyrkoth-arrival" },
      { id: "infernal-advocate-brief", name: "Advocate's Six-Page Brief", description: "On the Council-brief board: every infernal clause cites a non-existent prize from the date of writing. Every clause is voidable as a matter of contract law. Includes Atalin's signed witness statement.", x: 46, y: 79, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:infernal-advocate-brief" },
      { id: "infernal-atalin-apology", name: "Atalin's Council-Floor Apology", description: "On the Council-floor recording: Atalin apologises to the league for forty seasons of unease, and to the Hierarchy for the trap. The Hierarchy accepts in writing. The league does not need to.", x: 54, y: 79, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:infernal-atalin-apology" },
      { id: "infernal-amnesty-passed", name: "Council Vote — Amnesty Passed", description: "On the Council-vote display: twelve to two, three abstentions. Every infernal clause across forty seasons is declared void by the Council in session.", x: 62, y: 79, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:infernal-amnesty-passed" },
      { id: "infernal-advocate-speech", name: "Advocate's Closing Speech — Eleven Minutes", description: "On the closing-rite recording: 'we have been winning by honest paperwork. we will keep winning that way. it is not a glamorous habit, but it is a survivable one.'", x: 70, y: 79, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:infernal-advocate-speech" },
      // Mystery wiring — charter.second_signatory · color (war-room)
      { id: "charter2-delegation", name: "Four-House Delegation at the Council Door", description: "On the Council-chamber door log: four people in working clothes. Two old, two young. They will not give names until they have read theirs into the record.", x: 86, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:charter2-delegation" },
      { id: "charter2-kassel-speaks", name: "Kassel's Council-Floor Speech", description: "On the Council-floor recording: 'we are asking the charter to admit it had eight names from the start. there is a difference, and the charter knows the difference.'", x: 6, y: 79, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:charter2-kassel-speaks" },
      { id: "charter2-kassel-response", name: "Kassel's Silence-as-Vote Response", description: "Pinned beside: Kassel's recorded response. 'The schism is asking for the seventh's silence to be heard correctly, four epochs late.'", x: 14, y: 79, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:charter2-kassel-response" },
      { id: "charter2-council-ratifies-three", name: "Council Vote — Option Three Passes", description: "On the Council-vote display: eleven votes to four, with two abstentions. Two of the four nay-voters apologise from the floor.", x: 22, y: 79, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:charter2-council-ratifies-three" },
      { id: "charter2-three-options", name: "Three-Option Council Ballot", description: "Beside the ratification: (1) ratify the schism, (2) close the schism, (3) ratify backward AND keep the original intact. Drafted by the player and the Antiquarian.", x: 30, y: 79, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:charter2-three-options" },
      // Mystery wiring — charter.missing_signatory · e5 (Council briefing pack)
      { id: "charter-council-briefing", name: "Foundation-Day Council Briefing Pack", description: "On the Council-briefing board: the Antiquarian's pack — everything except the name. The Council can ratify, amend, or contest. None of the three options name the seventh.", x: 78, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:charter-council-briefing" },
      // Mystery wiring — severance.bound_champion · color (war-room)
      { id: "severance-attendance-record", name: "Severance Roster — Two Hundred Sixteen Names", description: "On the Severance roster-board: two hundred sixteen names every season. The first three are the same three names in the same order, every season since Year 1.", x: 46, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:severance-attendance-record" },
      { id: "severance-vex-three-names", name: "Vex's Three-Name Confirmation", description: "Pinned beside the roster: Vex confirms the three first names are the inheritor (different each year) and two fixed witnesses. 'That part is the bond's, not mine.'", x: 54, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:severance-vex-three-names" },
      { id: "severance-klessa-role", name: "Klessa's Failsafe — Thirty-Nine Wax-Pours", description: "On the failsafe-role board: if a season passes without a successor, Klessa pours the candle wax across the bond's table-line. She has done this thirty-nine times.", x: 62, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:severance-klessa-role" },
      { id: "severance-written-protocol", name: "Written Protocol — Eleven Lines", description: "On the closing-rite display: eleven lines hand-copied from the apprentice oath, ratified by Vex Maestro and Auditor Klessa, witnessed by the Architect's Console.", x: 70, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:severance-written-protocol" },
      // Mystery wiring — mechronis.missing_professor · color (war-room)
      { id: "tarn-faculty-meeting-minutes", name: "Faculty Meeting Minutes — Week Before", description: "On the curriculum-affairs board: three faculty heads in violent disagreement, then a quiet hour, then unanimous agreement on 'Tarn must speak.' Tarn was not at the meeting.", x: 6, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:tarn-faculty-meeting-minutes" },
      { id: "tarn-trial-proposal", name: "Trial Faculty Proposal — Roen", description: "Beside the minutes: five modules, ritual-heavy, citing Tarn's authority-trial framework. Signed by Roen. Proposes a celebration-trial co-requisite.", x: 14, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:tarn-trial-proposal" },
      { id: "tarn-dean-choice-brief", name: "Dean's Council-Brief Draft", description: "On the Council-brief board: ratify the curriculum and let Tarn go, or summon Tarn back and tell the Academy the truth about the vote. The brief is unsigned.", x: 22, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:tarn-dean-choice-brief" },
      { id: "tarn-faculty-apologies", name: "Three Faculty Apologies", description: "On the rite-record board: Othmar, Veth, and the Dean each wrote a public apology. Roen has not — Roen kept Tarn's confidence and was the only one not in the wrong.", x: 30, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:tarn-faculty-apologies" },
      { id: "tarn-player-authorship-choice", name: "Curriculum-Authorship Motion", description: "On the closing-rite ballot display: 'curriculum by Professor Tarn' or 'curriculum, anonymous.' Both motions ratify the same modules. The choice is the player's.", x: 38, y: 71, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:tarn-player-authorship-choice" },
      // Mystery wiring — memorial.seven_watchers · color (war-room)
      { id: "watchers-witness-one-response", name: "Plaza-Audience Watcher-Line Tallies", description: "On the plaza-audience board: three players confirm Idris's voice; two confirm Verel's; five remain unconfirmed. The unconfirmed five are the four other named Watchers' work, plus the seventh's silence.", x: 73, y: 63, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:watchers-witness-one-response" },
      { id: "watchers-player-first-question", name: "Player's First Question — Year-Vault Draft", description: "On the year-vault-archive board: the player's hand-written first question for the silent seventh, sealed in an envelope to be opened next Memorial Day.", x: 81, y: 63, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:watchers-player-first-question" },
      // Mystery wiring — akai_shi.red_death · e1 (Thaloria battle logs)
      { id: "akai-thaloria-battle-logs", name: "Thaloria Battle Logs — Akai Shi's Last Hours", description: "On the Thaloria archive board: energy-manipulation discharges, healing applied to seven Potentials, then 'subject consumed' at hour four. Jericho intercepted at hour seven.", x: 65, y: 63, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:akai-thaloria-battle-logs" },
      // Mystery wiring — advocate.blood_weave · e5 (Empire current-status)
      { id: "advocate-empire-status-current", name: "Empire of Shadows — Current Status", description: "On the Empire-status board: the charter holds. The bindings on all ten named demon lords are operationally intact. The Advocate has not retired the charter.", x: 57, y: 63, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:advocate-empire-status-current" },
      // Mystery wiring — advocate.blood_weave · e1 + e2 (acquisition log + Riri'Ahlia's siege)
      { id: "advocate-acquisition-attempt-log", name: "Hierarchy Acquisition-Attempt Log", description: "On the defensive display: seven centuries of Hierarchy attempts against Advocate-sheltered souls. Every outcome where the countersignature held: NULL.", x: 41, y: 63, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:advocate-acquisition-attempt-log" },
      { id: "advocate-riri-ahlia-account", name: "Riri'Ahlia's Siege Account", description: "Pinned beside the log: the Hierarchy COO's surviving account of the seven-dimensions siege. 'The Advocate had MORE only in one resource: she was willing to spend herself.' A retreat at a moment her instruments could still have continued.", x: 49, y: 63, width: 6, height: 6, type: "interact", action: "room-mystery:war-room:advocate-riri-ahlia-account" },
      // Re-anchored 2026-05-24 against the AAA Final war-room render
      // (9-variant audit). The 2026-04-25 anchoring described "TERRAN
      // FLEET COMMAND blast doors + holographic globe-dome" — actual
      // AAA Final is a council-style war room: central ROUND war-table
      // with cosmic star-map projection, 5 faction BANNERS standing
      // on the table edge (red/orange/cyan/green/purple), 3 overhead
      // holographic UI panels (green/cyan/purple), left-wall bookshelf
      // with bound folios, right-wall white text panel with brass
      // frame, foreground chairs with seated figures.
      //
      // Major re-anchors:
      //   • battle-map → actual round war-table (28,52,44,38)
      //   • tactical-archives → right white text panel (76,28,22,38),
      //     was at y=8 ceiling
      //   • guild-war-console → left-wall bookshelf (0,52,14,40),
      //     was at y=8 ceiling
      //   • faction-war-map → 3 overhead holo panels (28,18,44,16),
      //     was at y=6 on blank ceiling
      //   • door-bridge → invisible bottom-left walkout (0,92,10,6)
      //
      // The 67 architect-channel mystery rectangles in the lower
      // 60-90% of the screen overlay the visible foreground (war-table
      // edge, banners, side benches, archive racks). Their positions
      // were left in place — most map plausibly to the visually dense
      // foreground area. A full per-rect re-anchor would be a separate
      // audit pass.
      ...
      // Mystery wiring — Riri'Ahlia arc: the siege filed as a quarter, the reorganization doctrine, the procedural question, and the Taskmaster's priced after-action ledger
      { id: "the-taskmasters-siege-portfolio", name: "The Taskmaster's Siege Portfolio", description: "A captured Hierarchy operations file on the document rack — the siege of seven dimensions filed not as a campaign but as a portfolio entry with a populated remediation field, and the Taskmaster's own status-grammar register.", x: 30, y: 24, width: 8, height: 9, type: "interact", action: "room-mystery:war-room:the-taskmasters-siege-portfolio" },
      { id: "riri-ahlia-reorg-doctrine-board", name: "The Reorganization-Doctrine Board", description: "A strategic-assessment panel — Riri'Ahlia's doctrine of reorganizing value off a position she cannot take, her silence as her most active state, and Fenra's post-siege seventeen-dimension commendation.", x: 42, y: 24, width: 8, height: 9, type: "interact", action: "room-mystery:war-room:riri-ahlia-reorg-doctrine-board" },
      { id: "the-procedural-question-file", name: "The Procedural-Question File", description: "A captured Hierarchy procedural filing cross-referenced against the necromancer-castle log — Riri'Ahlia's canonically unanswered question filed to be on the record, and the doctrine that the record is the org chart's edge.", x: 54, y: 24, width: 8, height: 9, type: "interact", action: "room-mystery:war-room:the-procedural-question-file" },
      { id: "the-priced-defense-accounting", name: "The Priced-Defense Accounting", description: "Riri'Ahlia's own filed after-action ledger of the siege — expenditure within projection, the assault vector retired, and the one line that mattered: the cost of the Advocate's defense, now measured and in the portfolio.", x: 66, y: 24, width: 8, height: 9, type: "interact", action: "room-mystery:war-room:the-priced-defense-accounting" },
      { id: "fenra-seventeen-front-manifest", name: "The Seventeen-Front Manifest", description: "Fenra's captured operational record, racked beside the Taskmaster's siege portfolio — the seventeen-dimension invasion filed as a supply manifest, fed from one kitchen, the berserker read struck as the false lead.", x: 30, y: 12, width: 8, height: 9, type: "interact", action: "room-mystery:war-room:fenra-seventeen-front-manifest" },
      { id: "the-wolf-in-the-boardroom-file", name: "The Wolf-in-the-Boardroom File", description: "A captured Hierarchy personnel portrait — the fur-lined coat and the lupine snout filed as one canon, the growl that lands on the bookkeeping not the kill, and the silence that is restraint, not the Taskmaster's reorganization or Varkul's vigil.", x: 42, y: 12, width: 8, height: 9, type: "interact", action: "room-mystery:war-room:the-wolf-in-the-boardroom-file" },
      { id: "fenra-varkul-contrast-record", name: "The Fenra-Varkul Contrast Record", description: "Filed beside the Varkul director-of-security order — the Necromancer's two senior creations read as a matched pair: the still door and the moving engine, the two things any continuity needs.", x: 54, y: 12, width: 8, height: 9, type: "interact", action: "room-mystery:war-room:fenra-varkul-contrast-record" },
    ],
  },
  {
    id: "cipher-den",
