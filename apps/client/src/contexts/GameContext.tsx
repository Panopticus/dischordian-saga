...
export const ROOM_DEFINITIONS: RoomDef[] = [
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "akai-jericho-witness-page", name: "Jericho's Witness Page", description: "On the Thaloria-archive shelf: Jericho Jones's hour-after-mercy witness page. 'Akai Shi was already gone. I did the work she would have asked me to do.'", x: 6, y: 24, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:akai-jericho-witness-page" },
      { id: "akai-targets-list", name: "Red Death — Open Targets List", description: "In the case-files drawer: fourteen entities the Red Death has eliminated. Each entry carries a date, a place, and the chronicler's note.", x: 14, y: 24, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:akai-targets-list" },
      ...
      { id: "wolf-journal-xxxviii", name: "Antiquarian's Journal Entry XXXVIII", description: "On the chronicle-current shelf: 'Anara. My creation. My refuge. My failure.' The Antiquarian's hand-written admission of his pocket-universe's design flaw.", x: 6, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-journal-xxxviii" },
      { id: "wolf-corruption-ledger", name: "Wolf's Predator-Ledger", description: "In the Anara-affairs drawer: the Quarchon-hand ledger matching Lycos's archived sample. Four entries, three 'mercy: n', one 'mercy: y'.", x: 14, y: 16, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:wolf-corruption-ledger" },
      ...
      { id: "storm-dossier-quote", name: "Storm Dossier — Operational Sentence", description: "On the cosmic-archaeology shelf: the Storm's dossier open at its operational sentence. Older than every active Ne-Yon; the dossier does not record who first wrote it.", x: 6, y: 8, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-dossier-quote" },
      { id: "storm-polarity-lyric-record", name: "Polarity — Lyric Record", description: "On the lyric-records shelf: the Book of Daniel 2:47 'Polarity' record, signed in the Enigma's hand. The 12th Ne-Yon's endorsement of the Storm/Silence pairing.", x: 14, y: 8, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:storm-polarity-lyric-record" },
      ...
      { id: "chained-tarn-residency-marginalia", name: "Tarn's Residency Marginalia", description: "On the marginalia shelf: Tarn's Year-Two notebook annotation naming Module 17 as the module the Academy will not teach.", x: 36, y: 38, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:chained-tarn-residency-marginalia" },
      { id: "chained-auro-at-rite", name: "Auro at the Closing Rite", description: "In the case-rite annex: the Antiquarian's hand-written note on Auro's attendance. She nods once when Tarn's name is read. She does not nod when the Dean apologises.", x: 44, y: 38, width: 6, height: 6, type: "interact", action: "room-mystery:antiquarian-library:chained-auro-at-rite" },
