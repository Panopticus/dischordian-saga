...
export const ROOM_DEFINITIONS: RoomDef[] = [
  {
    ...
    hotspots: [
      ...
      { id: "sealed-pods-left", name: "Sealed Pods (Tilted)", description: "Two pods stand upright but tilted — cyan ECG readouts cycle steadily inside. Someone is still in there.", cx: 31.95, cy: 42.6, width: 6.5, height: 11, type: "examine", elaraDialog: "Those pods read warm-gold on the medical side and the heart-trace is still cycling. Whoever's inside is sustaining. Whether that's life or rehearsal-of-life, I genuinely cannot tell from out here.",
      ...
      { id: "sealed-pods-right", name: "Sealed Pods (Right Cluster)", description: "A short column of three or four standing capsules right-of-center. Status indicators are dark.", cx: 64, cy: 40.95, width: 7.6, height: 8.5, type: "examine", elaraDialog: "Those pods are still sealed. Their status indicators went dark when the main power failed. I... I don't want to speculate about what's inside them. Not yet.",
      ...
      { id: "cryo-terminal", name: "Cryo Terminal", description: "An arcade-style terminal on the far-left wall displaying your character data and vital statistics.", cx: 4, cy: 46.55, width: 8, height: 17.1, type: "terminal", action: "/character-sheet", elaraDialog: "This terminal has your biometric data — your species markers, class aptitudes, everything we determined during your awakening. You can review your Citizen profile here.",
        tiers: [
      ...
      { id: "door-medical", name: "Medical Bay Door", description: "A reinforced door leading to the Medical Bay. Green status light.", cx: 80.75, cy: 39.4, width: 7.3, height: 18, type: "door", action: "medical-bay" },
      { id: "door-bridge", name: "Bridge Access", description: "A recessed bulkhead at back-center beneath the Aetheric-crown emblem. A corridor leading up to Deck 2 — the Command deck.", cx: 50, cy: 39.6, width: 7.4, height: 14.2, type: "door", action: "bridge" },
      { id: "ichor-trail", name: "Green Ichor Trail", description: "A trail of luminous green fluid arcs across the floor from the foreground-left, snaking toward the bridge corridor.", cx: 27.7, cy: 78.9, width: 19, height: 12.6, type: "examine", elaraDialog: "That isn't cryo-fluid. The spectrometry matches nothing in my registry — and the registry is comprehensive. Don't step in it, and don't let it touch the locket.",
      ...
      // z-stack above).
      { id: "candle-ring", name: "Lit Candles (Left)", description: "A small flame at the left edge of the central floor seal — recently lit.", cx: 42.1, cy: 46.3, width: 1.6, height: 5, type: "examine", elaraDialog: "The wax is still soft. Whoever lit these was here within the hour. It wasn't me, and it wasn't you, which leaves a question I would rather not answer alone.",
        tiers: [
      ...
      { id: "dead-pod", name: "Sealed Diplomatic Pod", description: "A pod whose status indicator is cold-blue instead of warm-gold. Something is in there.", cx: 37.7, cy: 41.25, width: 2.8, height: 9.5, type: "interact", action: "cryo-mystery:dead-pod" },
      { id: "frosted-glass", name: "Frosted Pod Glass", description: "Wipe the frost — see who's inside.", cx: 82, cy: 68.8, width: 4.8, height: 8.8, type: "interact", action: "cryo-mystery:frosted-glass" },
      { id: "medical-chart", name: "Medical Chart", description: "A printed medical chart magnet-clipped to the wall.", cx: 43, cy: 36.3, width: 3, height: 4, type: "interact", action: "cryo-mystery:medical-chart", elaraDialog: "I wonder what that is. I don't have any record of that." },
      { id: "cracked-panel", name: "Cracked Control Panel", description: "The dark pod's control panel is split along a hairline seam. Sabotage?", cx: 82.85, cy: 59.5, width: 3.1, height: 4.8, type: "interact", action: "cryo-mystery:cracked-panel" },
      { id: "data-slate", name: "Hidden Data Slate", description: "The edge of a data-slate peeks out from under the pod.", cx: 61.9, cy: 92.65, width: 3.8, height: 4.7, type: "interact", action: "cryo-mystery:data-slate" },
      { id: "personal-effect", name: "Fallen Locket", description: "Something small has fallen on the floor — a tarnished locket and a cut ID-tag cord.", cx: 57.55, cy: 88.2, width: 4.7, height: 3.6, type: "interact", action: "cryo-mystery:personal-effect" },
      ...
      { id: "cryo-pod", name: "Your Cryo Pod", description: "Your pod. Fallen on its side, glass spider-webbed. A handprint is smeared on the inside of the glass — yours, from when you broke out.", cx: 72.05, cy: 52.4, width: 12.7, height: 5.8, type: "examine", elaraDialog: "That's your pod. AK-74-0074. You broke the seal from inside, which the engineering spec says is impossible — and yet, here we are. We need to understand how.",
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "medicine-cabinet", name: "Medicine Cabinet", description: "Two stacked dispensary kiosks built into the far-left wall. Each port holds a row of capped vials; most are labeled, several are not.", cx: 7.75, cy: 60.2, width: 11.1, height: 33.8, type: "examine", action: "room-mystery:medical-bay:medicine-cabinet", elaraDialog: "Medical supplies. Most are standard stim-packs and neural stabilizers. But some of these vials... I don't recognize the compounds. They weren't in the original manifest.",
        elaraDialogVoId: "room.medical-bay.hotspot.medicine-cabinet.elara",
      },
      { id: "door-cryo", name: "Cryo Bay Door", description: "Return to the Cryo Bay.", cx: 21.25, cy: 52.75, width: 8.5, height: 30.9, type: "door", action: "cryo-bay" },
      { id: "dna-helix", name: "DNA Analysis Station", description: "A floor-to-ceiling glass column on the far-right wall holds a slow-rotating holographic double helix, marker-bands lighting up in sequence as it turns.", cx: 94.4, cy: 53.65, width: 9, height: 56.3, type: "examine", action: "room-mystery:medical-bay:dna-helix", elaraDialog: "The DNA analysis station. It maps your genetic markers against known species templates. DeMagi, Quarchon, Ne-Yon... your hybrid signature is fascinating.",
      ...
      { id: "autopsy-console", name: "Bio-Bed Autopsy Console", description: "A small subsystem of the bio-bed dedicated to forensic readouts. Slot for an external data-slate.", cx: 43.35, cy: 48.25, width: 4.1, height: 5.7, type: "interact", action: "bio-bed-autopsy-console", elaraDialog: "The autopsy console can read external data-slates. If you have the fragment from the dead pod, slot it in.",
      ...
      { id: "akai-virus-telemetry", name: "Akai Shi — Virus-Consumption Telemetry", description: "On the neural-archive console: post-mortem readings show Akai Shi's consumption-curve as a gradient, not a cliff. She held the Virus inside her body longer than anyone in canonical record.", cx: 41.65, cy: 57.8, width: 2.7, height: 3.8, type: "interact", action: "room-mystery:medical-bay:akai-virus-telemetry" },

      // ── FLOOR ──
      { id: "floor-seal", name: "Medical Bay Floor Seal", description: "Concentric rings inlaid in pale stone span the chamber floor — a calibration mandala the first medics used to align the bio-bed's resonance.", cx: 50.6, cy: 76, width: 26.8, height: 14, type: "examine", elaraDialog: "The calibration mandala. The bio-bed's resonance is tuned against these rings; if the rings drift, the readouts drift with them. The lines look intact to me, but I'm reading slight distortion at the outer band. Worth checking when we have a free hand.",
      ...
      { id: "bio-bed", name: "Bio-Bed Scanner", description: "A pedestal-mounted exam bed in the chamber's center. Holographic readouts ghost above the headrest in pale cyan.", cx: 48.4, cy: 62.7, width: 8.8, height: 6.8, type: "terminal", action: "/character-sheet", elaraDialog: "The bio-bed can give you a full diagnostic. Your stats, your Dream resonance levels, your cellular integrity. Step on and I'll run a scan.",
        elaraDialogVoId: "room.medical-bay.hotspot.bio-bed.elara",
      },
      { id: "mystery-bio-bed", name: "Bio-Bed Trace Marker", description: "A faint trace marker on the bio-bed's diagnostic strip — your DNA's signature, registered without your having sat down.", cx: 47.85, cy: 55.35, width: 2.5, height: 4.5, type: "interact", action: "room-mystery:medical-bay:bio-bed" },
      ...
      { id: "severance-broker-quantum-imaging", name: "Broker's Quantum Body Scan", description: "On the quantum-imaging suite: the Broker of Nilmorg's volunteered scan. An age incompatible with a single spine; a Year-One cellular rest-mark; a continuity with one discontinuity.", cx: 51.85, cy: 47.9, width: 2.5, height: 5.8, type: "interact", action: "room-mystery:medical-bay:severance-broker-quantum-imaging" },
      ...
      { id: "npc-the-source", name: "The Source (Echo)", description: "The bio-bed monitors flicker in unison. A face — or the suggestion of one — resolves on the central display. Patient Zero is awake.", cx: 55.1, cy: 48.4, width: 3.6, height: 4.4, type: "npc", action: "npc:the_source", npcId: "the_source" },
    ],
  },
  {
    id: "bridge",
    ...
    hotspots: [
      ...
      { id: "tactical-display", name: "Tactical Display", description: "A massive corkboard on the right wall, layered with photographs and red string — the living web of intelligence the first crew began to assemble.", cx: 88.5, cy: 47, width: 21, height: 50, type: "terminal", action: "/board", elaraDialog: "The Conspiracy Board. Every entity, every faction, every connection we've mapped in the Dischordian Saga. It's a web of alliances, betrayals, and secrets. The more you explore, the more connections you'll uncover.",
        tiers: [
      ...
      { id: "war-map-display", name: "War Map", description: "The lower section of the Conspiracy Board — pinned faction territories and conflict zones, threaded together in red.", cx: 88.5, cy: 81, width: 21, height: 18, type: "terminal", action: "/war-map", elaraDialog: "The War Map. Faction territories, conflict zones, and strategic objectives are all tracked here. When faction wars erupt, this is where commanders plan their campaigns." },
      { id: "timeline-projector", name: "Timeline Projector", description: "A floating cyan banner-scroll near the top-right ceiling — a holographic timeline of the Ages of the Dischordian Saga.", cx: 83, cy: 20, width: 22, height: 24, type: "terminal", action: "/saga-timeline", elaraDialog: "The Timeline Projector. It maps the entire history of the Dischordian Saga across the Ages — from the Age of Privacy through the Fall of Reality and beyond. Each era tells a different chapter of the story.",
        elaraDialogVoId: "room.bridge.hotspot.timeline-projector.elara",
      },
      { id: "guild-console", name: "Guild Registry", description: "The middle terminal in the far-left Architect-channel column. A console for managing guild operations and alliances.", cx: 7.5, cy: 55.5, width: 15, height: 15, type: "terminal", action: "/guild", elaraDialog: "The Guild Registry. Form alliances with other Potentials, coordinate operations, and compete for dominance. Guilds that work together can tackle challenges no individual could face alone.",
        elaraDialogVoId: "room.bridge.hotspot.guild-console.elara",
      },
      { id: "sealed-memory-board", name: "Sealed Memory Board", description: "The bottom terminal in the far-left Architect-channel column. The Editor sealed memories out of the record; this terminal queues the sealed boards.", cx: 7.5, cy: 70.5, width: 15, height: 15, type: "terminal", action: "/conspiracy-board", elaraDialog: "Not the open Conspiracy Board — the sealed ones. The Editor redacted seven memories out of the saga's record. Each board you solve un-redacts a cutscene and a Soul Stone." },
      ...
      { id: "door-cryo", name: "Cryo Bay Stairs", description: "An arched left-wall door with a blue keypad. Stairs leading down to Deck 1.", cx: 21, cy: 54, width: 10, height: 48, type: "door", action: "cryo-bay" },
      { id: "door-archives", name: "Archives Access", description: "A secured passage leading to the Archives.", cx: 97.5, cy: 55, width: 5, height: 50, type: "door", action: "archives" },
      { id: "door-comms", name: "Comms Array Corridor", description: "A corridor leading to the Communications Array.", cx: 51, cy: 97, width: 26, height: 4, type: "door", action: "comms-array" },
      ...
      { id: "severance-architect-acknowledge", name: "Architect — Apprentice Oath Acknowledgment", description: "On the Nilmorg Architect-channel: 'noted. the post is recognised. the post was always recognised.' The Console did not need a vote.", cx: 4, cy: 35, width: 6, height: 6, type: "interact", action: "room-mystery:bridge:severance-architect-acknowledge" },
      { id: "severance-council-ratification", name: "Council Ratification — Inheritance Protocol", description: "On the Council-vote terminal: ratified unanimously, with one abstention — the seventh founding Watcher's empty seat.", cx: 11, cy: 35, width: 6, height: 6, type: "interact", action: "room-mystery:bridge:severance-council-ratification" },
      { id: "charter-architect-response", name: "Architect's Recovery Response", description: "On the Architect-channel terminal: 'Do you wish to know.' An invitation, not an interrogation. The Console does not answer the inverse — what knowing costs.", cx: 4, cy: 43, width: 6, height: 6, type: "interact", action: "room-mystery:bridge:charter-architect-response" },
      { id: "charter2-architect-record-correction", name: "Architect Record Correction — Seventh's No", description: "On the Architect-channel: the eighth-epoch record correction — 'the seventh founding watcher did not consent to the fourth-epoch scrub. the record is corrected.'", cx: 11, cy: 43, width: 6, height: 6, type: "interact", action: "room-mystery:bridge:charter2-architect-record-correction" },
      //
      // Mid-left terminal (guild-console parent — these win sub-clicks):
      { id: "charter2-architect-acknowledgment", name: "Architect Closing — Eight Signatures Legible", description: "On the closing-rite Architect-channel: 'the founding now has eight signatures legible. the silence remains. the architect notes the correction with thanks.' Third use of 'thanks' in eight epochs.", cx: 4, cy: 52.5, width: 6, height: 5, type: "interact", action: "room-mystery:bridge:charter2-architect-acknowledgment" },
      { id: "infernal-architect-acknowledges", name: "Architect — Trap-Acknowledgment", description: "On the Architect-channel terminal: 'noted. the clauses are void. the trap was an honest one. the architect thanks the writer.' Fourth use of 'thanks' in eight epochs.", cx: 11, cy: 52.5, width: 6, height: 5, type: "interact", action: "room-mystery:bridge:infernal-architect-acknowledges" },
      { id: "chained-dean-silence-on-bridge", name: "Dean's Silence on the Bridge", description: "On the command-deck pedestal: the Dean's hand resting on the apprentice-protection-protocol document. Ratified, sealed, untouched since.", cx: 4, cy: 58.5, width: 6, height: 5, type: "interact", action: "room-mystery:bridge:chained-dean-silence-on-bridge" },
      { id: "chained-architect-correction", name: "Architect Correction — Module 17", description: "On the Architect-channel terminal: 'the absence of Module 17 was an honest argument that became a wrong outcome. the architect will not vote on the amendment.'", cx: 11, cy: 58.5, width: 6, height: 5, type: "interact", action: "room-mystery:bridge:chained-architect-correction" },
      //
      // Bottom-left terminal (sealed-memory-board parent — these win sub-clicks):
      { id: "chained-architect-rite-acknowledgment", name: "Architect Closing-Rite Acknowledgment", description: "On the closing-rite log: 'the architect notes the thirty-one names. the architect notes the teacher who taught anyway. the case is closed.'", cx: 4, cy: 67.5, width: 6, height: 5, type: "interact", action: "room-mystery:bridge:chained-architect-rite-acknowledgment" },
      { id: "watchers-architect-record", name: "Architect's Silence-Break Record", description: "On the Architect-channel terminal: 'six watchers have spoken to six audiences. each line is real. the seventh has not spoken. the architect will not name the seventh.'", cx: 11, cy: 67.5, width: 6, height: 5, type: "interact", action: "room-mystery:bridge:watchers-architect-record" },
      { id: "watchers-architect-role-naming", name: "Architect — Seventh-Role Boundary", description: "Pinned to the Architect-channel: 'the role waits to be named by the Ark itself, not by the architect. the silence will continue until the ark has spoken.'", cx: 4, cy: 73.5, width: 6, height: 5, type: "interact", action: "room-mystery:bridge:watchers-architect-role-naming" },
      //
      // Right corkboard (tactical-display parent — these win sub-clicks):
      { id: "watchers-architect-closing-thanks", name: "Architect's Closing Thanks", description: "On the closing-rite log: 'six Watchers spoken; one silent; the architect thanks the players for asking the question they sealed.' Fifth use of 'thanks' in eight epochs.", cx: 81.5, cy: 42.5, width: 5, height: 5, type: "interact", action: "room-mystery:bridge:watchers-architect-closing-thanks" },
      { id: "tarn-destination-acknowledged", name: "Architect's Record — Tarn's Departure", description: "On the Architect-channel terminal: 'noted. she may return at her own discretion.' Tarn has left the Ark; Roen knows where but will not say.", cx: 87.5, cy: 42.5, width: 5, height: 5, type: "interact", action: "room-mystery:bridge:tarn-destination-acknowledged" },
      { id: "tarn-architect-vote-note", name: "Architect — Closing-Rite Marginal Note", description: "Pinned to the Architect-channel for the closing rite: 'either choice closes the case. one keeps her name; one keeps her promise. the architect will not pick.'", cx: 93.5, cy: 42.5, width: 5, height: 5, type: "interact", action: "room-mystery:bridge:tarn-architect-vote-note" },
      { id: "memorial-architect-silence-on-torn", name: "Architect Silence — Torn Page", description: "On the Architect-channel terminal: asked to identify the torn-page imprint, the Console returns 'i decline.' Second decline in eight epochs.", cx: 81.5, cy: 49.5, width: 5, height: 5, type: "interact", action: "room-mystery:bridge:memorial-architect-silence-on-torn" },
      { id: "memorial-architect-closing-thanks", name: "Architect's Closing — Grateful", description: "On the closing-rite Architect-channel: 'noted. the plaza was the answer. the architect is grateful.' Second use of 'grateful' in eight epochs.", cx: 87.5, cy: 49.5, width: 5, height: 5, type: "interact", action: "room-mystery:bridge:memorial-architect-closing-thanks" },
      { id: "memorial-architect-sealed-note", name: "Architect's Sealed Note on I-1", description: "On the Architect-channel terminal: the keeper's sealed note opened only when the plaza asks. 'I-1 is the imprint that began the Ark. I will not name them. The plaza may.'", cx: 93.5, cy: 49.5, width: 5, height: 5, type: "interact", action: "room-mystery:bridge:memorial-architect-sealed-note" },
      ...
      { id: "mystery-tactical-display", name: "Conspiracy Marginalia", description: "Faint annotations along the Conspiracy Board's edge — read carefully and the editor's voice resolves.", cx: 82, cy: 58, width: 6, height: 6, type: "interact", action: "room-mystery:bridge:tactical-display" },
      { id: "mystery-timeline-projector", name: "Timeline Drift", description: "The two post-launch entries on the Timeline Projector's lower edge drift one minute forward on every read.", cx: 91, cy: 25, width: 6, height: 6, type: "interact", action: "room-mystery:bridge:timeline-projector" },
      { id: "mystery-nav-console", name: "Nav Console Sequence", description: "The previous crew's last unfinished glyph entry, frozen mid-attempt.", cx: 33, cy: 90.5, width: 6, height: 5, type: "interact", action: "room-mystery:bridge:nav-console" },
      { id: "mystery-diplomacy-table", name: "Empty Delegate Seat", description: "The chair beside the empty seat at the Diplomacy Table — pulled out by Lyra's hand, in the seconds before the cryo order.", cx: 67, cy: 84, width: 6, height: 8, type: "interact", action: "room-mystery:bridge:diplomacy-table" },
      { id: "captains-coffee", name: "Captain's Coffee", description: "A mug, half-full, on the dais beside the captain's chair. Two and a half centuries old. The handle still points toward the chair.", cx: 42.5, cy: 53.5, width: 5, height: 7, type: "interact", action: "room-mystery:bridge:captains-coffee" },
      ...
      { id: "npc-elara", name: "Elara (Holographic)", description: "Elara's holographic projection flickers beside the captain's chair. She seems to be waiting for you to address her directly.", cx: 63.5, cy: 35, width: 7, height: 18, type: "npc", action: "npc:elara", npcId: "elara" },
    ],
  },
  {
    id: "archives",
    ...
    hotspots: [
      ...
      { id: "data-banks", name: "Data Banks", description: "The far-left wall is a floor-to-ceiling catalog drawer system — every drawer a tier of the Saga's record. Petabytes of data.", cx: 7, cy: 53, width: 14, height: 70, type: "examine", action: "room-mystery:archives:data-banks", elaraDialog: "Petabytes of data. Ship logs, personnel records, scientific research, intercepted transmissions. Most of it is corrupted or encrypted. I'm still trying to recover what I can." },
      { id: "codex-shelf", name: "The Codex", description: "Floor-to-ceiling cyan-lit bookshelves along the right wall, scaled by a rolling ladder. Ancient tomes and data crystals containing deep lore.", cx: 84, cy: 44, width: 28, height: 78, type: "terminal", action: "/codex", elaraDialog: "The Codex. These are the deeper lore entries — the histories, the prophecies, the classified files. Some entries are locked until you discover enough connections to piece them together." },
      { id: "search-terminal", name: "Search Terminal", description: "A floating celestial orb on a stone pedestal at center-back — the chamber's database query interface. Speak any name, alias, or keyword and the orb scans every indexed record.", cx: 42, cy: 44, width: 18, height: 32, type: "terminal", action: "/search", elaraDialog: "The main search terminal. Type any name, alias, or keyword and it will scan our entire database. Characters, locations, factions, songs — everything is indexed and cross-referenced." },
      { id: "clue-journal-desk", name: "Clue Journal", description: "An open journal at the center of the reading table. Ten investigative arcs; the Two Witnesses record what you deduce.", cx: 32, cy: 84, width: 14, height: 12, type: "terminal", action: "/clue-journal", elaraDialog: "The Clue Journal. Ten arcs, the_watcher through fenra. The Two Witnesses log every reading you file — the canon is partly written by what you conclude." },
      ...
      { id: "corrupted-scroll-rack", name: "Corrupted Scroll Rack", description: "The lower bay of the left-wall drawer catalog — twenty-eight scrolls behind frosted glass, each in two registers: warm-gold underlayer and a slightly out-of-register indigo overlayer.", cx: 7, cy: 80, width: 14, height: 16, type: "interact", action: "room-mystery:archives:corrupted-scroll-rack" },
      { id: "rewritten-ledger", name: "Rewritten Ledger", description: "An open ledger on the reading table — two entries scrubbed to blanks, one margin annotation surviving in your own younger hand.", cx: 21.5, cy: 77, width: 7, height: 8, type: "interact", action: "room-mystery:archives:rewritten-ledger" },
      { id: "indigo-glow-lectern", name: "Indigo-Glow Lectern", description: "The orb's stone pedestal at center-back is ringed in a faint halo in the colour you cannot name. Someone is logged in right now.", cx: 42, cy: 63, width: 12, height: 14, type: "interact", action: "room-mystery:archives:indigo-glow-lectern" },
      { id: "unnameable-hue-cabinet", name: "Unnameable-Hue Cabinet", description: "The tall glass cabinet right-of-center — a hand-stitched label dyed in an unnameable hue. One scroll inside is undyed and untouched.", cx: 54.5, cy: 44, width: 11, height: 38, type: "interact", action: "room-mystery:archives:unnameable-hue-cabinet" },
      ...
      { id: "charter-silt-stratigraphy", name: "Charter Silt-Core Extraction", description: "The lower-deck silt-core on a brass tripod in the Foundation-tier wing — eight strata, the charter sitting in stratum six, two later burials closed over it.", cx: 3, cy: 22.5, width: 4, height: 5, type: "interact", action: "room-mystery:archives:charter-silt-stratigraphy" },
      { id: "charter-per-m-preservation-orders", name: "Per. M.'s Preservation-Order File", description: "Forty-three preservation orders on the standing-order vault, one identical signature across eight epochs: 'Per. M.' The inks shift; the hand does not.", cx: 7, cy: 22.5, width: 4, height: 5, type: "interact", action: "room-mystery:archives:charter-per-m-preservation-orders" },
      { id: "severance-no-protocol-on-file", name: "Empty Inheritance-Protocol Vault", description: "In the Severance-tier records: the inheritance-protocol vault, empty since the league's founding. The slot exists; the protocol does not.", cx: 11, cy: 22.5, width: 4, height: 5, type: "interact", action: "room-mystery:archives:severance-no-protocol-on-file" },
      // Row 2 (y=27) — Severance / Infernal envelopes
      { id: "severance-forty-season-envelopes", name: "Forty Sealed Season Envelopes", description: "Beside the empty vault: forty sealed envelopes, one per Severance. Each contains an attendance list, a death certificate, and Vex Maestro's one-line 'inheritor accepted.' No name on any of them.", cx: 3, cy: 29.5, width: 4, height: 5, type: "interact", action: "room-mystery:archives:severance-forty-season-envelopes" },
      ...
      { id: "infernal-atalin-history", name: "Atalin's Personnel History", description: "In the personnel-archive tier: hired two weeks before the first season, dismissed two weeks after. Cause: 'inability to satisfy the Hierarchy ledger-keeper's role concurrently.'", cx: 11, cy: 29.5, width: 4, height: 5, type: "interact", action: "room-mystery:archives:infernal-atalin-history" },
      ...
      { id: "tarn-letter-to-dean", name: "Tarn's Letter to the Dean", description: "On the classified-correspondence shelf: Tarn's sealed letter to the Dean. Explains the request to Roen, the planned silence, the Dean's choice now.", cx: 74.5, cy: 13, width: 5, height: 6, type: "interact", action: "room-mystery:archives:tarn-letter-to-dean" },
      { id: "chained-thirty-one-names-read", name: "Thirty-One Names Read at Rite", description: "On the rite-record shelf: the transcript of the thirty-one apprentice-failure names read aloud. Fifteen sent notes; sixteen sent silence. Both are read.", cx: 80.5, cy: 13, width: 5, height: 6, type: "interact", action: "room-mystery:archives:chained-thirty-one-names-read" },
      { id: "storm-final-correlation-table", name: "Storm Case-Closure Correlation Table", description: "On the closing-record shelf: seven peak flux periods, seven calms, seven cosmic-consequential moments. The Storm's work as the chronicle's permission to be consequential.", cx: 86.5, cy: 13, width: 5, height: 6, type: "interact", action: "room-mystery:archives:storm-final-correlation-table" },
      { id: "infernal-box-owner", name: "Forge-Workshop Box Ownership Log", description: "In the forge-workshop annex log: the PRELIMINARIES box logged to Atalin, ledger-keeper, Year One. One season; never replaced.", cx: 74.5, cy: 31, width: 5, height: 6, type: "interact", action: "room-mystery:archives:infernal-box-owner" },
      { id: "resur-protocol-authoring-signature", name: "Resurrection-Protocol Authoring Chain", description: "On the cult-protocols shelf: every canonical resurrection-protocol signed in the Resurrectionist's four-part cipher — Sanctuary, Red Death, Anara — firing in his hand long after his canonical vanishing.", cx: 80.5, cy: 31, width: 5, height: 6, type: "interact", action: "room-mystery:archives:resur-protocol-authoring-signature" },
      ...
      { id: "resur-twin-glyph", name: "Resurrectionist Twin-Glyph Reference", description: "In the Ne-Yon-glyph reference tier: two mirrored crescents joined at a central axis. The cult reads 'death-bound'; the pre-Empire archaeology reads 'twin-bound.' Two readings; one editorial.", cx: 52.5, cy: 32.5, width: 5, height: 5, type: "interact", action: "room-mystery:archives:resur-twin-glyph" },
      { id: "storm-inventors-heist-window", name: "Inventor's Casino Heist Accounting", description: "On a shelf inside the freestanding glass cabinet: the Casino Heist's post-event accounting, opening line in the Inventor's hand: 'the Storm's grace allowed the window.'", cx: 52.5, cy: 42.5, width: 5, height: 5, type: "interact", action: "room-mystery:archives:storm-inventors-heist-window" },
      ...
      { id: "npc-antiquarian", name: "The Antiquarian", description: "A figure half-out-of-time stands beside the orb, removing his goggles to look at you.", cx: 54.5, cy: 47, width: 7, height: 18, type: "npc", action: "npc:the_antiquarian", npcId: "the_antiquarian" },
      ...
      { id: "npc-shadow-tongue", name: "Shadow Tongue (Presence)", description: "The orb pedestal's indigo halo deepens. A reflection in the cabinet glass doesn't match yours. Someone else is editing — right now.", cx: 42, cy: 63, width: 8, height: 10, type: "npc", action: "npc:shadow_tongue", npcId: "shadow_tongue" },
    ],
  },
  {
    id: "comms-array",
    ...
    hotspots: [
      ...
      { id: "door-bridge", name: "Bridge Corridor", description: "Return to the Command Bridge.", cx: 2, cy: 55, width: 4, height: 50, type: "door", action: "bridge" },
      { id: "door-observation", name: "Observation Deck", description: "A passage to the Observation Deck.", cx: 98, cy: 55, width: 4, height: 50, type: "door", action: "observation-deck" },
      ...
      { id: "voice-in-the-static", name: "Voice in the Static", description: "The static on the left-wall screen has begun to organise itself — vertical bands of indigo arranging into the silhouette of a person speaking, then dissolving.", cx: 14, cy: 39, width: 8, height: 12, type: "interact", action: "room-mystery:comms-array:voice-in-the-static" },
      ...
      { id: "charter-bell-log", name: "Lower-Deck Bell Log — Three Pulls", description: "On the maintenance-broadcast shelf: three bell-pulls in the last century. Severance Year 3, a date no one will name, and this morning. The Antiquarian's name on the third.", cx: 3.5, cy: 25, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:charter-bell-log" },
      { id: "severance-first-witness-klessa", name: "Auditor Klessa — Forty-Severance Witness", description: "On the witness-attendance board: she has attended every Severance since Year 1. Brings a single white candle and lights it during the spoken name.", cx: 3.5, cy: 33, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:severance-first-witness-klessa" },
      { id: "akai-voice-mid-hunt", name: "Red Death — Voice Mid-Hunt", description: "On the Matrix-residue intercept board: a field-recording from the third retreat chamber. 'I am the chronicle's correction. I do not hate. I do not pity.'", cx: 3.5, cy: 41, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:akai-voice-mid-hunt" },
      { id: "akai-word-to-the-chronicle", name: "Red Death — Word to the Chronicle", description: "Pinned beside: the Red Death's closing line. 'I do not know if that nod was forgiveness or recognition or the body's last grammar. I do not need to know.'", cx: 3.5, cy: 49, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:akai-word-to-the-chronicle" },

      // ── CENTRAL PEDESTAL MYSTERY SUB-RECTS (4 desk/voice channels) ──
      // Authored AFTER training-console so they win clicks on specific
      // pedestal surfaces.
      { id: "tarn-erasure-vote-audio", name: "The Erasure-Vote Audio", description: "On the transmission desk: forty-three minutes from the war-room's spillover recorder. Three voices, three ayes, three pauses long enough to have been refusals.", cx: 43.5, cy: 55, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:tarn-erasure-vote-audio" },
      ...
      { id: "watchers-first-trumpet", name: "First Trumpet — Twenty-Two Seconds", description: "On the upper-bands intercept board: twenty-two seconds of Idris's band-three trumpet. The post-launch content slot Phase 4 scaffolded; tonight's first sound.", cx: 81, cy: 24.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:watchers-first-trumpet" },
      { id: "wolf-meme-show-transmission", name: "Meme-Show Transmission Intercept", description: "On the intercept board: Locke's adjudicar has pinned the Inventor-voiced transmission naming the Wolf as a predator wearing trust like a mask. The Antiquarian has not denied the framing.", cx: 85, cy: 24.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:wolf-meme-show-transmission" },
      { id: "storm-voice-fragment", name: "Storm — Voice-Fragment Intercept", description: "On the flux-frequency intercept board: a fragment captured during an uncorrelated calm. 'A calm is not the absence of weather. It is weather's permission for what otherwise could not be planned.'", cx: 81, cy: 32.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:storm-voice-fragment" },
      { id: "storm-closing-transmission", name: "Storm — Closing-Case Transmission", description: "Pinned beside: a second fragment from the case-closure interval, signed in the Storm's flux signature. 'The case will close on the correct side of that difference.'", cx: 85, cy: 32.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:storm-closing-transmission" },
      ...
      { id: "advocate-register-three-broadcast", name: "Advocate Broadcast — Register Three", description: "On the Empire-of-Shadows transmission shelf: the Advocate's register-three liturgical broadcast. 'If a soul comes under my charter, the chronicle has accepted the soul as its own.'", cx: 91, cy: 24.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:advocate-register-three-broadcast" },
      { id: "advocate-defection-response", name: "Advocate's Response to the Defections", description: "Pinned beside: the Advocate's register-three reply to the three-general defection. 'They walk under my charter still. I advocate for what they were when they chose.'", cx: 96, cy: 24.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:advocate-defection-response" },
      { id: "advocate-walk-in-power-lyric", name: "'Walk in Power' — Lyric Record", description: "On the album-records shelf: the canonical Silence in Heaven duet between the Advocate and the Human. The Empire's most-broadcast resistance anthem.", cx: 91, cy: 32.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:advocate-walk-in-power-lyric" },
      { id: "advocate-position-current-broadcast", name: "Advocate's Current-Position Broadcast", description: "On the most-recent-broadcasts shelf: 'I have not stopped. I will not stop. I continue. The Empire continues. The walk continues.'", cx: 96, cy: 32.5, width: 4, height: 5, type: "interact", action: "room-mystery:comms-array:advocate-position-current-broadcast" },

      // ── BOT MONITOR ROW (Thaloria archive + trace/signature buffers) ──
      { id: "akai-last-recorded-words", name: "Akai Shi's Last Recorded Words", description: "On the Thaloria-archive shelf — bot-left monitor: the helm-comm field-recording from forty-seven seconds before Jericho reached her. 'It was always going to be a mercy. We just have to live with which kind.'", cx: 71.5, cy: 51, width: 5, height: 6, type: "interact", action: "room-mystery:comms-array:akai-last-recorded-words" },
      { id: "miras-dual-thread-transmission", name: "Mira's Dual-Thread Transmission", description: "A personal-channel buffer on the bot-left monitor — Mira Halen's letter home with a carrier clean of any duress marker, and her later answer refusing the question of which thread to cut.", cx: 76, cy: 51, width: 4, height: 6, type: "interact", action: "room-mystery:comms-array:miras-dual-thread-transmission" },
      { id: "shadow-tongue-signal-trace", name: "Shadow Tongue Signal Trace", description: "A signature buffer on the bot-mid monitor — the Shadow Tongue's operational signature, subtraction without trace across the chronicle layer.", cx: 82, cy: 51.5, width: 6, height: 7, type: "interact", action: "room-mystery:comms-array:shadow-tongue-signal-trace" },
      { id: "resur-host-wyrmhole-signature", name: "Plague Dragon Corpse Signature", description: "On the bot-mid monitor's signal-analysis read-out: the Plague Dragon's energy-trace, consistent with the Host's canonical wyrmhole technology. The Virus's path through the breach, settled.", cx: 82, cy: 63.5, width: 6, height: 7, type: "interact", action: "room-mystery:comms-array:resur-host-wyrmhole-signature" },
      { id: "egg-comms-signal", name: "Anomalous Frequency", description: "A barely audible signal on a frequency that shouldn't exist — registering on the bot-mid monitor's edge meter.", cx: 87.5, cy: 52, width: 3, height: 4, type: "examine", action: "room-mystery:comms-array:egg-comms-signal", elaraDialog: "That frequency... it's not on any standard band. The signal is repeating a pattern: three short, three long, three short. An SOS. But the origin coordinates point to a location that doesn't exist in normal space. Someone — or something — is calling for help from between dimensions. The signal is tagged with an identifier: 'MEME-PRIME.'" },
      ...
      { id: "ocularum-relay-trace", name: "Ocularum Relay Trace", description: "A trace buffer printed onto the right-foreground bench — identity-shift signatures the official record does not index. The Senne→Locke transition resolves here.", cx: 82, cy: 83, width: 8, height: 10, type: "interact", action: "room-mystery:comms-array:ocularum-relay-trace" },
      { id: "dead-drop-cadence-log", name: "Dead-Drop Cadence Log", description: "A cadence log on the bench's right edge — shipping traffic the antenna passively records as it crosses New Babylon. One monthly Locke-signed package repeats.", cx: 92, cy: 83, width: 8, height: 10, type: "interact", action: "room-mystery:comms-array:dead-drop-cadence-log" },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "viewport", name: "Panoramic Viewport", description: "The vast expanse of space stretches before you through a curved glass wall — stars, a small distant planet, the chamber's only window onto the void.", cx: 50, cy: 47, width: 50, height: 50, type: "interact", action: "room-mystery:observation-deck:panoramic-viewport", elaraDialog: "Look at the stars. They're beautiful, aren't they? But they're wrong. The constellations don't match any known configuration from any of the mapped universes. Either we've traveled very, very far... or we're somewhere that shouldn't exist." },
      { id: "music-terminal", name: "Music Terminal", description: "A glowing earth-globe on a brass-rimmed table at right-foreground. The complete discography of Malkia Ukweli & the Panopticon is keyed into its base.", cx: 87, cy: 75, width: 18, height: 20, type: "terminal", action: "/discography", elaraDialog: "The complete discography. Four albums spanning the entire narrative — Dischordian Logic, The Age of Privacy, The Book of Daniel 2:47, and the upcoming Silence in Heaven. Every song is a piece of the puzzle." },
      { id: "bond-resonance-altar", name: "Bond Resonance Altar", description: "A low circular altar set into the floor's compass-star tiling — brass-rimmed, oxblood-leather kneeler.", cx: 50, cy: 93, width: 20, height: 10, type: "interact", action: "room-mystery:observation-deck:bond-resonance-altar" },
      { id: "purification-crystal-cradle", name: "Crystal Cradle", description: "The pedestal beneath the globe-table. A brass plaque reads, in Lyra's hand: 'For the crystal that has not yet been chosen.'", cx: 88, cy: 89, width: 16, height: 8, type: "interact", action: "room-mystery:observation-deck:purification-crystal-cradle" },
      ...
      { id: "door-comms", name: "Comms Array", description: "Return to the Communications Array.", cx: 12.5, cy: 95, width: 15, height: 6, type: "door", action: "comms-array" },
      { id: "door-engineering", name: "Engineering Access", description: "A maintenance hatch leading down to Engineering.", cx: 97.5, cy: 57.5, width: 5, height: 55, type: "door", action: "engineering" },
      ...
      { id: "egg-obs-constellation", name: "Strange Constellation", description: "A pattern of stars in the viewport's upper-left that seems to form a face.", cx: 30.5, cy: 27, width: 5, height: 6, type: "examine", elaraDialog: "Do you see it? That cluster of stars... if you connect them, they form a face. Not just any face — it looks like the Watcher. The all-seeing eye of the Panopticon's surveillance network. But we're light-years from Panopticon space. How can the stars themselves form his likeness? Unless... the stars were arranged. By someone with the power to move suns." },
      { id: "akai-cycle-fold-anomalies", name: "Matrix Cycle-Fold Anomalies", description: "Telemetry overlaid on the viewport's left quadrant — discontinuous folds during the Red Death's hunt. Seven folds, seven retreat chambers, seven encounters. The Necromancer running into his own decisions.", cx: 37, cy: 30.5, width: 6, height: 5, type: "interact", action: "room-mystery:observation-deck:akai-cycle-fold-anomalies" },
      { id: "storm-weather-telemetry", name: "Five-Century Cosmic-Weather Console", description: "Telemetry overlaid on the viewport center — five centuries of slow oscillation between two equilibria, with Storm-active intervals pinned exactly to the mid-line crossings.", cx: 49, cy: 30.5, width: 6, height: 5, type: "interact", action: "room-mystery:observation-deck:storm-weather-telemetry" },
      { id: "storm-full-calms-register", name: "Register of Nine Calms", description: "Pinned beside the telemetry on the viewport's right quadrant — the full register of nine documented calm intervals; each one a permission interval.", cx: 63, cy: 30.5, width: 6, height: 5, type: "interact", action: "room-mystery:observation-deck:storm-full-calms-register" },

      // ── LEFT-WALL MYSTERY RECT (architect channel on bar shelves) ──
      { id: "charter-upper-band-calibration", name: "Upper-Band Calibration Slip", description: "On the upper-band reference shelf, tucked between the bar's backlit bottles: a wafer of metal calibrated to the upper-band frequency, folded into the founding-Watcher's letter. Per. M. had access to the upper bands.", cx: 3.5, cy: 52.5, width: 5, height: 5, type: "interact", action: "room-mystery:observation-deck:charter-upper-band-calibration" },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "door-forge", name: "Forge Workshop", description: "A heavy blast door to the left of the central forge. Heat warnings; the air shimmers.", cx: 35.5, cy: 43, width: 5, height: 32, type: "door", action: "forge-workshop" },
      { id: "door-observation", name: "Observation Deck", description: "Return to the Observation Deck.", cx: 2, cy: 70, width: 4, height: 40, type: "door", action: "observation-deck" },
      { id: "door-armory", name: "Armory Access", description: "A reinforced door at the right edge leading to the Armory.", cx: 97, cy: 52.5, width: 4, height: 45, type: "door", action: "armory" },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "spectator-screen", name: "Spectator Screen", description: "The front edge of the right-side workbench — a wide screen showing live battles between other Potentials.", cx: 86, cy: 88, width: 24, height: 12, type: "terminal", action: "/spectate", elaraDialog: "The Spectator Screen. Watch live battles between other Potentials. Study their strategies, learn from their mistakes, and prepare for your own encounters." },
  ...
  },
  {
    ...
    hotspots: [
      ...
      // ── FEATURE / CONTAINER HOTSPOTS ──
      { id: "trade-terminal", name: "Trade Empire Terminal", description: "The raised central dais with a mannequin standing in the middle of a flag-ring — the main terminal for the interstellar trade simulation.", cx: 51, cy: 50, width: 22, height: 50, type: "terminal", action: "/trade-empire", elaraDialog: "Trade Empire. An interstellar trade simulation based on the actual trade routes of the Dischordian universe. Buy low, sell high, avoid pirates, and build your trading empire. The credits you earn here are real — they can be spent in the store." },
      { id: "store-counter", name: "Requisitions Counter", description: "The red-curtained trading alcove right-of-center — a trading post where you can buy items with Dream tokens and credits.", cx: 69, cy: 57.5, width: 18, height: 45, type: "terminal", action: "/store", elaraDialog: "The Requisitions Counter. You can spend your Dream tokens and credits here on upgrades, card packs, cosmetics, and more. Some items are only available through the store." },
      { id: "marketplace-board", name: "Marketplace Board", description: "The ring of small flags above the central dais — a bustling exchange board showing buy and sell orders from Potentials across the Ark.", cx: 51, cy: 26, width: 28, height: 8, type: "terminal", action: "/marketplace", elaraDialog: "The Marketplace. A peer-to-peer exchange where Potentials trade cards, materials, and equipment. Prices fluctuate based on supply and demand. A shrewd trader can make a fortune here." },
      { id: "inventory-locker", name: "Personal Locker", description: "The left-wall recessed display cases — your secured locker containing collected items and equipment.", cx: 7, cy: 50, width: 14, height: 50, type: "terminal", action: "/inventory", elaraDialog: "Your personal inventory locker. Everything you've collected — weapons, armor, materials, consumables, and artifacts — is stored here. Organize your gear before heading into battle." },
      { id: "fleet-dock", name: "Fleet Docking Bay", description: "The right-wall recessed display cases — a viewport showing the Ark's auxiliary fleet of smaller vessels.", cx: 92, cy: 50, width: 14, height: 50, type: "terminal", action: "/fleet", elaraDialog: "The Fleet Docking Bay. Your auxiliary vessels are moored here — scout ships, cargo haulers, and combat frigates. Manage your fleet to expand your reach across the trade routes and war zones of the Saga." },
      { id: "mystery-crate", name: "Sealed Crate", description: "The stack of blue brass-cornered crates at left-center. The largest crate has claw marks on it — something was trying to get in... or out.", cx: 29, cy: 55, width: 28, height: 50, type: "examine", elaraDialog: "That crate... the claw marks are on the inside. Something was sealed in there and tried to get out. The manifest says it contained 'biological samples from Sector 7.' I've locked it down. Don't touch it." },

      // ── DOORS ──
      { id: "door-armory", name: "Armory Stairs", description: "Stairs leading up to the Armory.", cx: 2.5, cy: 87, width: 5, height: 18, type: "door", action: "armory" },
      { id: "door-captains", name: "Captain's Quarters", description: "A restricted access corridor to the Captain's Quarters.", cx: 97.5, cy: 87, width: 5, height: 18, type: "door", action: "captains-quarters" },
      ...
      { id: "resur-ark-passenger-manifest", name: "Inception Ark Passenger Manifest (Redacted)", description: "On the top crate's lid: the passenger-records page — seven names visible; eighth name redacted to a black bar of structural length. Not a casual erasure; a positioned occupant.", cx: 20.5, cy: 37.5, width: 5, height: 5, type: "interact", action: "room-mystery:cargo-hold:resur-ark-passenger-manifest" },
      { id: "charter2-house-marek", name: "House Marek — Toolmakers' Workshops", description: "On a side-crate stencilled 'HOUSE MAREK': three families, one tool-room, four epochs of continuous output. Same scrubber's hand on the charter-signature erasure.", cx: 32.5, cy: 37.5, width: 5, height: 5, type: "interact", action: "room-mystery:cargo-hold:charter2-house-marek" },
      { id: "the-cursed-forest-depot", name: "The Cursed-Forest Depot Placard", description: "A captured Hierarchy operations placard wired to the central crate — Fenra's domain filed not as a battlefield but as a logistics hub, the throughput corrupted souls, the depot dying under its own load.", cx: 28, cy: 58, width: 6, height: 6, type: "interact", action: "room-mystery:cargo-hold:the-cursed-forest-depot" },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "deck-builder", name: "Strategic Table", description: "The glass coffee table at the center of the chair circle — a large surface with holographic card projections for deck building.", cx: 49, cy: 75.5, width: 18, height: 15, type: "terminal", action: "/deck-builder", elaraDialog: "The Strategic Table. Dr. Vox used this to plan... well, officially it was 'neural network deployment patterns.' But the formations look military. She designed the nanobot operating system that runs every Ark — and the patterns suggest she knew exactly what those nanobots could really do. Now you can use it to build and refine your card decks. A well-built deck is the difference between victory and oblivion." },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "orb-of-worlds", name: "The Orb of Worlds", description: "The bronze candle-lamp at the center of the reading table — a golden orb hovering above a leather glove. Inside, a miniature city glows with warm light, its tiny streets and buildings shifting as you watch.", cx: 50, cy: 47, width: 10, height: 18, type: "terminal", action: "/conexus", elaraDialog: "The Orb of Worlds. The Antiquarian uses it to observe every timeline simultaneously. That city inside — it's not a model. It's a real city, compressed into a pocket of folded space. Touch it and the CoNexus portal opens. You can step into any story from the Dischordian Saga and live it yourself. The AI adapts to your choices. No two journeys are ever the same." },
      { id: "ancient-tomes", name: "Ancient Tomes", description: "The floor-to-ceiling left-wall bookshelves — leather-bound books pulsing with faint inner light. Each spine bears a title from the Dischordian Saga.", cx: 7.5, cy: 47.5, width: 15, height: 85, type: "terminal", action: "/conexus", elaraDialog: "These aren't ordinary books. Each one is a gateway to a CoNexus story game. The Necromancer's Lair, Awaken the Clone, Sundown Bazaar... the Antiquarian has catalogued every major event in the Saga as an interactive narrative. Pick one up and you'll be pulled into the story." },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "demon-contract-altar", name: "Contract Altar", description: "The Hierarchy answers by contract. Every summon is a clause.", cx: 79, cy: 39, width: 14, height: 22, type: "terminal", action: "/demon-packs", elaraDialog: "A summoning altar bound to the Hierarchy's contract law. Every demon you call owes exactly what was signed — not one clause more. Mol'Garath audits the ledger quarterly." },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "world-projector", name: "Syndicate World Projector", description: "The right-wall pink/purple star-chart display — a holographic display of your guild's capital world.", cx: 84, cy: 47, width: 28, height: 50, type: "terminal", action: "/syndicate-world", elaraDialog: "The Syndicate World Projector. Your guild's capital is displayed here. Your civil skills in Architecture and Engineering reduce build costs and times. Your class mastery unlocks special buildings only available to certain classes." },
      { id: "prestige-altar", name: "Prestige Altar", description: "The left-wall tall sigil plaque — a glowing altar where Potentials undertake quest chains to unlock prestige classes.", cx: 11, cy: 47, width: 22, height: 50, type: "terminal", action: "/prestige-quests", elaraDialog: "The Prestige Altar. Undertake quest chains that unlock prestige classes — advanced specializations that grant powerful bonuses to everything you do. Each requires specific base classes, species, and skill levels." },
      ...
      { id: "conexus-governance-shell", name: "CoNexus Governance Shell", description: "The central-back desk where the figure stands — the governance shell the Architect's dismantled CoNexus left behind.", cx: 50, cy: 46, width: 20, height: 28, type: "terminal", action: "/governance", elaraDialog: "The CoNexus governance shell. When the Architect dismantled the constructed CoNexus it left this voting chamber empty. The saga's nexus decisions are how the playerbase fills it." },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "comm-terminal", name: "Communications Terminal", description: "The left-wall cork board (upper) — send messages, manage friends, and stay connected.", cx: 7, cy: 30.5, width: 14, height: 25, type: "terminal", action: "/social", elaraDialog: "The Communications Terminal. Send friend requests, exchange direct messages, and manage your social connections. A strong network is essential for guild operations and cooperative raids." },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "mastery-wall", name: "Boss Mastery Wall", description: "Track your mastery levels for each boss.", cx: 73, cy: 29, width: 22, height: 38, type: "terminal", action: "/boss-mastery", elaraDialog: "The Boss Mastery Wall. Each boss you defeat earns mastery XP. Higher mastery unlocks exclusive cosmetics and titles. Compete on the mastery leaderboard." },
      { id: "replay-screen", name: "Replay Archive", description: "Watch recordings of past battles.", cx: 24, cy: 29, width: 24, height: 38, type: "terminal", action: "/replays", elaraDialog: "The Replay Archive. Watch recordings of past card battles and raids. Study strategies, share memorable moments, and learn from the best players." },
      ...
      { id: "quarters-door", name: "Personal Quarters", description: "Your private quarters aboard the Ark.", cx: 92, cy: 60, width: 14, height: 60, type: "terminal", action: "/personal-quarters", elaraDialog: "Your Personal Quarters. Decorate your private space with items earned through gameplay. Your class and species unlock unique decorations. Visitors can tour your quarters." },
