...
const BALANCED_PALETTE: ThemePalette = {
  neonCyan: "var(--energy-primary)",
  electricBlue: "var(--electric-blue)",
  orbOrange: "var(--energy-premium)",
  deepPurple: "var(--energy-system)",
  signalGreen: "#00E055",
  alertRed: "#FF3C40",
  brandGradient: "linear-gradient(135deg, var(--energy-primary) 0%, var(--electric-blue) 100%)",
  primary: "var(--energy-primary)",
  primaryForeground: "var(--bg-void)",
  accent: "var(--energy-premium)",
  accentForeground: "var(--bg-void)",
  ring: "var(--energy-primary)",
  glassBorder: "var(--glass-border)",
  glassShine: "color-mix(in oklch, var(--energy-primary) 15%, transparent)",
  sidebarPrimary: "var(--energy-primary)",
  sidebarPrimaryForeground: "var(--bg-void)",
  chart1: "var(--energy-primary)",
  chart2: "var(--energy-premium)",
};
...
const HUMANITY_PALETTE: ThemePalette = {
  neonCyan: "var(--energy-success)",
  electricBlue: "#3B82F6",
  orbOrange: "var(--energy-accent)",
  deepPurple: "#06B6D4",
  signalGreen: "#10B981",
  alertRed: "var(--energy-error)",
  brandGradient: "linear-gradient(135deg, var(--energy-success) 0%, #06B6D4 100%)",
  primary: "var(--energy-success)",
  primaryForeground: "var(--bg-void)",
  accent: "var(--energy-accent)",
  accentForeground: "var(--bg-void)",
  ring: "var(--energy-success)",
  glassBorder: "color-mix(in oklch, var(--energy-success) 20%, transparent)",
  glassShine: "color-mix(in oklch, var(--energy-success) 15%, transparent)",
  sidebarPrimary: "var(--energy-success)",
  sidebarPrimaryForeground: "var(--bg-void)",
  chart1: "var(--energy-success)",
  chart2: "var(--energy-accent)",
};
