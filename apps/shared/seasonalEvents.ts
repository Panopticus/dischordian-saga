...
export const SEASONAL_EVENTS: SeasonalEventDef[] = [
  ...
  /* ─── THE FALL OF REALITY — Anniversary Event ─── */
  {
    key: "fall_of_reality",
    name: "The Fall of Reality",
    description: "One year ago, the Architect's grand experiment collapsed. Reality itself fractured across every dimension, and the Panopticon's surveillance grid went dark for exactly 47 seconds. In that window, the Inception Arks launched. Now, on the anniversary of the Fall, echoes of that cataclysm are rippling through the ship's systems. Memory fragments from the old universe are materializing in every room \u2014 shards of a world that no longer exists. Collect them before they decay, and piece together the truth of what really happened the day everything ended.",
    icon: "Flame",
    color: "#dc2626",
    category: "lore",
    durationDays: 21,
    tokenName: "Reality Shard",
    tokenIcon: "Gem",
    bonusClass: "oracle",
    element: "void",
    moralityPath: "humanity",
    globalObjective: {
      ...
      rewardAll: { tokenName: "Reality Shard", amount: 750 },
    },
    milestones: [
      {
        threshold: 50,
        reward: { type: "token", key: "reality_shard", amount: 30 },
        label: "Echo Listener",
      },
      {
        threshold: 200,
        reward: { type: "xp", key: "xp", amount: 1500 },
        label: "Fragment Collector",
      },
      {
        threshold: 600,
        reward: { type: "cosmetic", key: "fractured_halo", amount: 1 },
        label: "Reality Walker",
      },
      {
        threshold: 1500,
        reward: { type: "card", key: "the_architect_fall", amount: 1 },
        label: "Witness to the Fall",
      },
      {
        threshold: 3000,
        reward: { type: "dream", key: "dream", amount: 500 },
        label: "Keeper of Memory",
      },
      {
        threshold: 5000,
        reward: { type: "cosmetic", key: "void_crown", amount: 1 },
        label: "Architect's Heir",
      },
    ],
    shopItems: [
      {
        key: "fractured_reality_skin",
        name: "Fractured Reality Aura",
        description: "A shimmering cosmetic aura of broken dimensional glass that surrounds your character",
        icon: "Sparkles",
        cost: 400,
        rarity: "legendary",
        category: "cosmetic",
      ...
      {
        key: "architects_journal",
        name: "The Architect's Journal",
        description: "A classified document revealing the Architect's final thoughts before the Fall. Unlocks exclusive lore entries in the Loredex.",
        icon: "BookOpen",
        cost: 300,
        rarity: "rare",
        category: "cosmetic",
      ...
      {
        key: "memory_amplifier",
        name: "Memory Amplifier",
        description: "+40% Reality Shard collection rate for 4 hours",
        icon: "Zap",
        cost: 60,
        rarity: "common",
        category: "consumable",
      ...
      {
        key: "void_echo_card_pack",
        name: "Void Echo Card Pack",
        description: "Contains 3 event-exclusive cards depicting key moments from the Fall of Reality",
        icon: "Layers",
        cost: 200,
        rarity: "rare",
        category: "card",
      ...
      {
        key: "panopticon_fragment",
        name: "Panopticon Fragment",
        description: "A piece of the Panopticon's core surveillance crystal. Quarters decoration that pulses with red light.",
        icon: "Eye",
        cost: 500,
        rarity: "legendary",
        category: "decoration",
      ...
      },
      {
        key: "reality_anchor",
        name: "Reality Anchor",
        description: "Stabilizes dimensional echoes near you, revealing hidden event hotspots for 1 hour",
        icon: "Anchor",
        cost: 100,
        rarity: "rare",
        category: "consumable",
      ...
      {
        key: "fall_memorial_title",
        name: "\"Survivor of the Fall\" Title",
        description: "An exclusive title displayed on your character profile, marking you as a participant in the anniversary event",
        icon: "Award",
        cost: 150,
        rarity: "rare",
        category: "title",
      ...
      {
        key: "architects_blueprint",
        name: "Architect's Blueprint",
        description: "A schematic of the original Inception Ark design. Grants +15% XP from all lore tutorials for 24 hours.",
        icon: "FileText",
        cost: 120,
        rarity: "rare",
        category: "consumable",
        maxPurchases: 3,
        requiredCivilSkill: { skill: "lore", level: 2 },
      },
    ],
  },
];
