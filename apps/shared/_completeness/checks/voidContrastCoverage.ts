...
const MEASURED: Pair[] = [
  ...
  { fg: "--energy-accent", bg: "--bg-surface", measuredRatio: 8.3, threshold: 4.5 },
  { fg: "--energy-primary-hc", bg: "--bg-void-hc", measuredRatio: 21, threshold: 4.5 },
  { fg: "--energy-error-hc", bg: "--bg-surface-hc", measuredRatio: 8.68, threshold: 4.5 },
  { fg: "--energy-success-hc", bg: "--bg-surface-hc", measuredRatio: 14.26, threshold: 4.5 },
];
