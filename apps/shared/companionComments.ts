...
import {
  COMPANION_COMMENTS_MORALITY,
  COMPANION_COMMENTS_CLASS,
  COMPANION_COMMENTS_CRAFT_TRADE,
} from "./companionCommentsChoices";
import {
  COMPANION_COMMENTS_FACTIONS,
  COMPANION_COMMENTS_IDLE,
  COMPANION_COMMENTS_AMBIENT,
} from "./companionCommentsAmbient";
