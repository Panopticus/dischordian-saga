...
export const PROPHECY_VISIONS: readonly ProphecyVision[] = [
  ...
  /* ═══════════════════════════════════════════════════════
     EXPANSION — Album 1 (Dischordian Logic) album-track variants

     Every Album 1 producer-drop track gets a binding via its
     slideshow completion flag. Bound as Whisper or Static so
     they don't dream-mode interrupt — watching the song from
     AlbumPage triggers an echo / unlocks the Index entry.
     ═══════════════════════════════════════════════════════ */
  {
    id: "pv_album1_t01_enigma",
    flagId: "slideshow_album1_t01_the_enigma_s_lament_complete",
    spine: "insurgency_rise",
    intensity: "whisper",
    playerAct: 1,
    albumSlug: "dischordian-logic",
    trackId: "T01",
    slideshowId: "album1-t01-the-enigma-s-lament",
    openingProphecyId: "dc_prophecy_002",
    closingProphecyId: "dc_prophecy_006",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 3 },
    oracleCardSlug: "architect",
  },
  {
    id: "pv_album1_t02_dischordian_logic",
    flagId: "slideshow_album1_t02_dischordian_logic_complete",
    spine: "insurgency_rise",
    intensity: "whisper",
    playerAct: 1,
    albumSlug: "dischordian-logic",
    trackId: "T02",
    slideshowId: "album1-t02-dischordian-logic",
    openingProphecyId: "dc_prophecy_001",
    closingProphecyId: "dc_prophecy_006",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 3 },
  ...
  {
    id: "pv_album1_t03_seeds",
    flagId: "slideshow_album1_t03_seeds_of_inception_complete",
    spine: "insurgency_rise",
    intensity: "static",
    playerAct: 1,
    albumSlug: "dischordian-logic",
    trackId: "T03",
    slideshowId: "album1-t03-seeds-of-inception",
    openingProphecyId: "dc_prophecy_005",
    closingProphecyId: "dc_prophecy_007",
    reward: { xp: 5, soulBoundDream: 1 },
    gate: { minAwareness: 3 },
  },
  {
    id: "pv_album1_t04_authority",
    flagId: "slideshow_album1_t04_the_authority_complete",
    spine: "insurgency_rise",
    intensity: "whisper",
    playerAct: 2,
    albumSlug: "dischordian-logic",
    trackId: "T04",
    slideshowId: "album1-t04-the-authority",
    openingProphecyId: "dc_prophecy_026",
    closingProphecyId: "dc_prophecy_079",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 3 },
    oracleCardSlug: "hierophant",
  },
  {
    id: "pv_album1_t05_politicians_reign",
    flagId: "slideshow_album1_t05_the_politician_s_reign_complete",
    spine: "insurgency_rise",
    intensity: "static",
    playerAct: 2,
    albumSlug: "dischordian-logic",
    trackId: "T05",
    slideshowId: "album1-t05-the-politician-s-reign",
    openingProphecyId: "dc_prophecy_078",
    closingProphecyId: "dc_prophecy_077",
    reward: { xp: 5, soulBoundDream: 1 },
    gate: { minAwareness: 3 },
    oracleCardSlug: "emperor_locke",
  },
  {
    id: "pv_album1_t06_insurgency",
    flagId: "slideshow_album1_t06_the_insurgency_complete",
    spine: "insurgency_rise",
    intensity: "whisper",
    playerAct: 2,
    albumSlug: "dischordian-logic",
    trackId: "T06",
    slideshowId: "album1-t06-the-insurgency",
    openingProphecyId: "dc_prophecy_037",
    closingProphecyId: "dc_prophecy_006",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 7, minAct: 2 },
    oracleCardSlug: "potentials",
  },
  {
    id: "pv_album1_t07_human_track",
    flagId: "slideshow_album1_t07_to_be_the_human_complete",
    spine: "insurgency_rise",
    intensity: "static",
    playerAct: 2,
    albumSlug: "dischordian-logic",
    trackId: "T07",
    slideshowId: "album1-t07-to-be-the-human",
    openingProphecyId: "dc_prophecy_046",
    closingProphecyId: "dc_prophecy_011",
    reward: { xp: 5, soulBoundDream: 1 },
    gate: { minAwareness: 3 },
  },
  {
    id: "pv_album1_t08_rent_free",
    flagId: "slideshow_album1_t08_rent_free_complete",
    spine: "insurgency_rise",
    intensity: "static",
    playerAct: 3,
    albumSlug: "dischordian-logic",
    trackId: "T08",
    slideshowId: "album1-t08-rent-free",
    openingProphecyId: "dc_prophecy_034",
    closingProphecyId: "dc_prophecy_006",
    reward: { xp: 5, soulBoundDream: 1 },
    gate: { minAwareness: 3 },
  },
  {
    id: "pv_album1_t09_i_love_war",
    flagId: "slideshow_album1_t09_i_love_war_complete",
    spine: "insurgency_rise",
    intensity: "whisper",
    playerAct: 3,
    albumSlug: "dischordian-logic",
    trackId: "T09",
    slideshowId: "album1-t09-i-love-war",
    openingProphecyId: "dc_prophecy_032",
    closingProphecyId: "dc_prophecy_011",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 7, minAct: 3 },
    oracleCardSlug: "jailer",
  },

  /* ═══════════════════════════════════════════════════════
     EXPANSION — Named cinematics (cross-album curation)
     ═══════════════════════════════════════════════════════ */
  {
    id: "pv_last_words",
    flagId: "slideshow_last_words_complete",
    spine: "insurgency_rise",
    intensity: "whisper",
    playerAct: 1,
    albumSlug: "dischordian-logic",
    ...
    openingProphecyId: "dc_prophecy_050",
    closingProphecyId: "dc_prophecy_014",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 3 },
    oracleCardSlug: "engineer",
  },
  {
    id: "pv_welcome_to_celebration",
    flagId: "slideshow_welcome_to_celebration_complete",
    spine: "insurgency_rise",
    intensity: "whisper",
    playerAct: 1,
    albumSlug: "dischordian-logic",
    ...
    openingProphecyId: "dc_prophecy_045",
    closingProphecyId: "dc_prophecy_006",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 3 },
    oracleCardSlug: "collector",
  },
  {
    id: "pv_it_aint_been_the_same",
    flagId: "slideshow_it_aint_been_the_same_complete",
    spine: "reality_fall",
    intensity: "whisper",
    playerAct: 4,
    albumSlug: "west-by-god",
    ...
    openingProphecyId: "dc_prophecy_053",
    closingProphecyId: "dc_prophecy_064",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 7, minAct: 4 },
  },
  {
    id: "pv_helmet_in_the_grass",
    flagId: "slideshow_the_helmet_in_the_grass_complete",
    spine: "reality_fall",
    intensity: "whisper",
    playerAct: 5,
    albumSlug: "west-by-god",
    ...
    openingProphecyId: "dc_prophecy_054",
    closingProphecyId: "dc_prophecy_021",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 13, minAct: 5 },
    oracleCardSlug: "balance",
  },
  {
    id: "pv_two_witnesses_part_2",
    flagId: "slideshow_two_witnesses_part_2_complete",
    spine: "reality_fall",
    intensity: "whisper",
    playerAct: 6,
    albumSlug: "silence-in-heaven",
    ...
    openingProphecyId: "dc_prophecy_061",
    closingProphecyId: "dc_prophecy_062",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 13, minAct: 6 },
    oracleCardSlug: "wheel",
  },

  /* ═══════════════════════════════════════════════════════
     EXPANSION — Act-intro cinematics (already authored)
     Each act intro gets a Marquee binding so the cinematic
     onset of each chapter lands as a dream.
     ═══════════════════════════════════════════════════════ */
  {
    id: "pv_act4_revelation_intro",
    flagId: "slideshow_act_4_revelation_intro_complete",
    spine: "insurgency_rise",
    intensity: "marquee",
    playerAct: 4,
    albumSlug: "book-of-daniel",
    ...
    albumInternalAct: 1,
    openingProphecyId: "dc_prophecy_003",
    closingProphecyId: "dc_prophecy_073",
    reward: { xp: 60, soulBoundDream: 6 },
    gate: { minAwareness: 7, minAct: 4 },
    oracleCardSlug: "source",
  },
  {
    id: "pv_act4_5_intro",
    flagId: "slideshow_act_4_5_intro_complete",
    spine: "insurgency_rise",
    intensity: "whisper",
    playerAct: 4.5,
    albumSlug: "book-of-daniel",
    ...
    albumInternalAct: 2,
    openingProphecyId: "dc_prophecy_038",
    closingProphecyId: "dc_prophecy_007",
    reward: { xp: 10, soulBoundDream: 1 },
    gate: { minAwareness: 7, minAct: 4 },
  },
  {
    id: "pv_act5_map_intro",
    flagId: "slideshow_act_5_map_intro_complete",
    spine: "insurgency_rise",
    intensity: "marquee",
    playerAct: 5,
    albumSlug: "book-of-daniel",
    ...
    albumInternalAct: 3,
    openingProphecyId: "dc_prophecy_070",
    closingProphecyId: "dc_prophecy_014",
    reward: { xp: 60, soulBoundDream: 6 },
    gate: { minAwareness: 13, minAct: 5 },
    oracleCardSlug: "vote",
  ...
  {
    id: "pv_act6_confession_intro",
    flagId: "slideshow_act_6_confession_intro_complete",
    spine: "reality_fall",
    intensity: "marquee",
    playerAct: 6,
    albumSlug: "silence-in-heaven",
    ...
    albumInternalAct: 1,
    openingProphecyId: "dc_prophecy_068",
    closingProphecyId: "dc_prophecy_059",
    reward: { xp: 75, soulBoundDream: 8 },
    gate: { minAwareness: 23, minAct: 6 },
    oracleCardSlug: "hanged_one",
  },
];
