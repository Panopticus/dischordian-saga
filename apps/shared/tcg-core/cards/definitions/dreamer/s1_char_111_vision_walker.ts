...
export const cardDef: CardDefinition = {
  ...
  verdict_delta: 1,
  balanceException: {
    reason: "Ability-driven design: 2/3 flier + on-deploy random buff (+1/+1 to a friendly). Sub-curve printed stats compensate for board-presence + buff value at 3 mana.",
    reviewer: "panopticus",
  },
};
