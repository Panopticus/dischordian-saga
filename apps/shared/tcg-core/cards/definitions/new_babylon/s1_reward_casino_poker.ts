...
export const cardDef: CardDefinition = {
  ...
  verdict_delta: 2,
  balanceException: {
    reason: "Reward-tier card from the casino-poker grant. On-deploy opponent-discard is the value. Stats held below ladder curve so reward-pool cards don't dominate ladder.",
    reviewer: "panopticus",
  },
};
