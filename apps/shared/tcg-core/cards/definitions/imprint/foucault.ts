...
export const foucault_t1: CardDefinition = {
  ...
  keywords: [], abilities: [],
  art: assetUrl("art/cards/imprint/s1_imprint_foucault_t1.webp"),
...
export const foucault_t2: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_foucault_t2.webp"),
...
export const foucault_t3: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_foucault_t3.webp"),
...
export const foucault_t4: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_foucault_t4.webp"),
...
export const foucault_t5: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_foucault_t5.webp"),
  flavorText:
