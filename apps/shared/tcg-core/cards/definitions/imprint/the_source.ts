...
export const the_source_t1: CardDefinition = {
  ...
  keywords: [], abilities: [],
  art: assetUrl("art/cards/imprint/s1_imprint_the_source_t1.webp"),
...
export const the_source_t2: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_the_source_t2.webp"),
...
export const the_source_t3: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_the_source_t3.webp"),
...
export const the_source_t4: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_the_source_t4.webp"),
...
export const the_source_t5: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_the_source_t5.webp"),
  flavorText:
