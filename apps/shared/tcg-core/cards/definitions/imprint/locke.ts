...
export const locke_t1: CardDefinition = {
  ...
  keywords: [], abilities: [],
  art: assetUrl("art/cards/imprint/s1_imprint_locke_t1.webp"),
...
export const locke_t2: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_locke_t2.webp"),
...
export const locke_t3: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_locke_t3.webp"),
...
export const locke_t4: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_locke_t4.webp"),
...
export const locke_t5: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_locke_t5.webp"),
  flavorText:
