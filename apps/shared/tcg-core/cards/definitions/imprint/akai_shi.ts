...
export const akai_shi_t1: CardDefinition = {
  ...
  keywords: [], abilities: [],
  art: assetUrl("art/cards/imprint/s1_imprint_akai_shi_t1.webp"),
...
export const akai_shi_t2: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_akai_shi_t2.webp"),
...
export const akai_shi_t3: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_akai_shi_t3.webp"),
...
export const akai_shi_t4: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_akai_shi_t4.webp"),
...
export const akai_shi_t5: CardDefinition = {
  ...
  art: assetUrl("art/cards/imprint/s1_imprint_akai_shi_t5.webp"),
  flavorText:
