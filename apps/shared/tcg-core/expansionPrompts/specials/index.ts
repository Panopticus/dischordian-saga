 ...
 *
 * Will hold 10 cards: Founder's Bundle alt-art (1) + Author's Edition
 * set-completion master (1) + Battle Pass tier-50 alt-art (1) + 7
 * lore-discovery secrets (THE ASSISTANT unlock model from
 * apps/shared/darrenMemorial.ts). Authored incrementally.
 */
