...
The actual outcome: **the Meme left the Oracle for dead and assumed his identity.** The White Oracle who emerged from the Panopticon was the Meme wearing the Re-Awakened Jailer's face — which was, per the canon update at §4.1 above, the **False Prophet** (the cloned Oracle made by the Collector). The Meme therefore replaced *a copy*, which is twice-false by structure: the Meme's disguise is a forged duplicate of an existing forgery. The Insurgency did not know. The Architect did not (publicly) know. The real Oracle himself was *imprisoned*, his mind held captive by the Warden — until the Enigma and the Programmer's later raid on the Panopticon destroys the Warden and frees him. (Canon ambiguous on which point in the eleven-year impersonation the raid occurs; see Oracle bible, slot #10, for the resolution.)
...
3. **The end was the Meme's choice.** *"I wanted you to beat me the way you want morning to beat night."* The player (experiencing the Oracle's memories of pursuing the Meme — see §4.1 canon update) was *let through*. The Meme could have prolonged the disguise. Canon shows it chose not to. The *"you"* the Meme addresses in this line is the Oracle whose memories the player is moving through; the Meme is closing the chapter with the entity it stole, not with the witness who is currently receiving the memory. The witness/receiver framing makes this line *more* unsettling, not less — the player is overhearing a conversation between a thief and a god.
...
- **Chapter 6 (saga present)**: the player, *moving through the Oracle's memories during the Collectors' Arena story-run* (per §4.1 canon update), catches up to the Meme as a witness to the Oracle's pursuit. The Meme drops the disguise. Hints at Act III return *"with my real face on... pink, mostly."* (The pre-update reading framed the player AS the real Oracle; the corrected reading is that the player has been *receiving the Oracle's memories*, not embodying the Oracle.)
...
> **CANON UPDATE (2026-04-25)** — the Oracle's identity arc has been canonized by the user and supersedes earlier framings in this bible. **The Oracle is *he*, not she.** **The player is NOT the Oracle.** The full Oracle timeline — Thalorian debater → Collector harvest → Prisoner (amnesiac) → Jailer (experimented on) → cloned as the False Prophet → Meme replaces him → mind freed when Enigma + Programmer raid the Panopticon and destroy the Warden → returns to bring about the Fall of Reality and the Revelation → disappears at the end of time — is held authoritative by the Oracle bible (slot #10, upcoming). Earlier this bible's prose framed the Oracle as *her* and asserted the player is the Oracle's identity-restored self at Chapter 6. **Both framings are retracted.** Pronoun corrections (her → his / she → he) and identity-restoration framing are flagged for a follow-up cleanup pass; the load-bearing claims are corrected in this section now. See `wraith_calder.md` §4.10 for the parallel Hierophant correction. See plan file Step 5 for the full Oracle canon.

The deepest relationship in the bible. Per `storyModeChapters.ts` Ch6 post-fight:

> "I gave orders. I signed death warrants. I lied to the Insurgency with your voice and they believed me because your voice was the only thing they still trusted."

For eleven years, the Meme wore the Oracle's face, spoke with his voice, signed death warrants, commanded the Insurgency. The Insurgency trusted the Oracle's voice because the Oracle's voice was the *only* thing they still trusted. The Meme weaponized that trust at faction scale.

**The corrected Chapter 6 reveal (per the canon update above)**: the player has *not* been the Oracle. The player has been **moving through the Oracle's memories** during the story-run of the Collectors' Arena. Chapter 6 is the moment the player catches up with the Meme *as a witness to the Oracle's pursuit*, not as the Oracle's identity-restored self. The Ch6 post-fight lines (*"I lied to the Insurgency with your voice"*) read post-correction as the Meme addressing the Oracle (whom the player is currently *experiencing as* — receiving his memories) — but the player is the receiver, not the body. This is the saga's deepest structural innovation, and the Oracle's bible (slot #10) takes ownership of articulating *what kind of witness the player has been* and how the Chapter 6 confrontation is the Oracle's memory of that confrontation, replayed through a witness-channel.

**Cross-bible obligation** (urgent, Stage 0): the Oracle's *real* state at Chapter 6 timing — per the new canon, the Oracle's mind was freed by the Enigma + Programmer raid on the Panopticon (which destroys the Warden). After the raid, the Oracle goes into hiding. The Hierophant (post-rite Wraith Calder) is *building up the faith of the faithful and preparing for the Oracle's return*. The Meme continues running the Insurgency in the False Prophet's voice. The Enigma at the end of Epoch 1 sees the White Oracle on Thaloria (which is the Meme wearing the False Prophet face) and **mistakenly believes it is the Oracle who has lost his memories again**. She does not realize it is the Meme. This is canonical and load-bearing for `wraith_calder.md` §4.10 and the upcoming Oracle bible.
...
- **The Oracle ↔ Meme**: the eleven-year identity theft is the Oracle's bible's central trauma. Oracle's bible (slot #10) takes ownership of the **player-as-witness-to-Oracle-memories** reveal arc (per §4.1 canon update — the player is NOT the Oracle; the player has been moving through the Oracle's memories during the Collectors' Arena story-run). The Meme replaced not the Oracle directly but the **False Prophet** — the cloned Oracle made by the Collector — which makes the disguise twice-false by structure.
