...
- **DMC Clone Companion** (Companion bible **shipped at `eb782e9`**, per `dmc_clone_companion.md` §§4.7, 7.3 DCB-O7): a companion-via-ritual, structurally parallel to Jericho (companion-via-recruitment) in that both arrive into their roles through another character's deliberate placement. The placement-broker structural parallel is canonically ratified by the Companion bible — both characters canonically *exist as the saga-time consequence of another character's institutional choice* (Degen for Jericho, Nilmorg for Companion). The Degen canonically *recognises the Companion as kin-by-placement* (the Degen has canonically *been* a placement-broker for Jericho; the Degen canonically *understands* placement-broker rituals). The Degen canonically *does not envy* the Companion's existence and canonically *does not pity* the Companion (placement-as-existence is canonically dignified in the Degen's worldview). Stage 4 weave: a Companion-Degen scene may canonically reference the placement-broker parallel.
- **The Oracle** (Oracle bible **shipped at `40fb771`**): unseen entity. The Degen's dual-category membership (Ne-Yon + Potential) may make him more aware of Oracle-substrate whispers than most. Oracle's bible decides whether he hears them. **RESOLVED per `the_oracle.md` §§4.11, 7.3 OCB-O10**: canonical Degen canonically does NOT canonically hear canonical Oracle-content directly. Bible-asserted reasoning: per Oracle §1.2 disambiguation, canonical waking-substrate-whispers are canonically *Meme-residue or Seer-recordings*, NOT canonical Oracle-content; canonical Degen canonically operates in canonical Trench-environment and canonical does NOT canonically have canonical access to canonical Oracle-dream-substrate or canonical memory-residue-substrate (the canonical Oracle's canonical-only canonical-channels per Oracle §1.1). Bible-load-bearing: canonical Degen canonically *receives canonical Meme-residue* and canonical *misattributes canonical-Meme-residue to canonical-Oracle-canonically-without-canonical-knowledge*. Canonical Degen canonically *thinks he hears the canonical Oracle*; canonical Degen canonically *actually hears canonical Meme-residue*. The canonical confusion canonically operates per the canonical Silence-era canonical voice-stolen canon — canonical Empire-era of canonical voice-theft canonically deformed canonical-substrate-recognition-pattern across canonical-multiple-actors. Stage 4 weave: canonical Degen canonically *might canonically eventually canonically realise* the canonical confusion via canonical Stage-4-weave canonical-narrative-event; bible-deferred. The canonical confusion canonically persists in canonical Acts 1-7. **OCB-O10 satisfied.**
