...
**Updated per `the_oracle.md` §§4.10, 7.3 OCB-O9 (Oracle bible shipped at `40fb771`)**: the Oracle bible canonically establishes two sub-claims for this section to acknowledge.

(a) **Echo detects Oracle-dream-substrate-RESIDUE, not waking-substrate-whispers.** Per Oracle bible §1.2 substrate-disambiguation canon: canonical waking-substrate-whispers are canonically *Meme-residue or Seer-recordings*, NOT canonical Oracle-content. Per Oracle bible §4.10: canonical Echo canonically *detects canonical Oracle-dream-substrate-residue* — the canonical-residue canonical Oracle-dreams canonically leave in canonical-saga-time-substrate post-canonical-dream. Bible-load-bearing: the canonical Echo-prior-warning canon (canonical *Echo reports the whisper before the player consciously registers it*) canonically operates per canonical *Echo registering canonical-residue-pattern* of canonical Oracle-dream-events; canonical Echo canonically *signals to the player* canonical-imminent or canonical-recent-Oracle-dream-activity. The canonical Echo-Oracle-attunement canon canonically *operates on canonical dream-substrate-residue specifically*, not on canonical waking-substrate-whispers.

(b) **Three-source-type reaction-distinguishing canon.** Per Oracle bible §4.10: canonical Echo canonically detects canonical *three canonical-source-types* of canonical-substrate-events: canonical Seer-transmissions (per `the_seer.md` §4.7), canonical Companion's canonical pre-verbal-channel-events (per `dmc_clone_companion.md` §4.9), canonical Oracle-dream-substrate-residue (this section). Bible-load-bearing canonical Echo canonical-multi-source-substrate-detector canon. Stage 1 architects: canonical Echo's canonical reaction-types canonically distinguish among canonical-three-source-types — canonical Seer-transmission-Echo-reaction operates with canonical-recognition-vocabulary; canonical Companion-event-Echo-reaction operates with canonical-kin-by-form-vocabulary; canonical Oracle-dream-residue-Echo-reaction operates with canonical-temporal-anomaly-vocabulary.

**Cross-bible obligation OCB-O9 satisfied.**
