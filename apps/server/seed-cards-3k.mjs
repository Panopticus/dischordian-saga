...
const loredexRaw = JSON.parse(readFileSync("apps/client/src/data/loredex-data.json", "utf-8"));
...
const CHARACTER_DETAILS = {
  ...
  "The White Oracle": { cls: "oracle", species: "human", rarity: "legendary", power: 7, health: 9, element: "water", alignment: "order", ability: "Face Changer: Once per turn, become a copy of any character in play until end of turn. Some say it is the Meme, wearing a new face — but the truth is contested.", season: "Season 3" },
