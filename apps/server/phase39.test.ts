...
describe("Phase 39: Draft Tournament Router", () => {
  ...
  describe("Router structure", () => {
    ...
    it("should import from the db schema", () => {
      // Router uses a relative import (`../../db/schema` after the
      // apps/* split); we just assert it touches the schema module.
      expect(draftRouter).toContain("db/schema");
    });
  });
