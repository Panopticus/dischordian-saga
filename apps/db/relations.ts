...
export const cardGameMatchesRelations = relations(cardGameMatches, ({ one }) => ({
  player1: one(users, { fields: [cardGameMatches.player1Id], references: [users.id], relationName: "cardGameMatches_player1" }),
  player2: one(users, { fields: [cardGameMatches.player2Id], references: [users.id], relationName: "cardGameMatches_player2" }),
}));
...
export const cardTradesRelations = relations(cardTrades, ({ one }) => ({
  sender: one(users, { fields: [cardTrades.senderId], references: [users.id], relationName: "cardTrades_sender" }),
  receiver: one(users, { fields: [cardTrades.receiverId], references: [users.id], relationName: "cardTrades_receiver" }),
}));
