#!/usr/bin/env python3
"""ANTIQUARIAN VO GENERATOR
Voice: yAKlvHIsuj4SvnKQ6Mk4
Run: python3 scripts/generate_antiquarian_vo.py"""
import json, os, sys, time, requests, boto3

ELEVENLABS_KEY = os.environ.get("ELEVENLABS_API_KEY", "")
VOICE_ID = "yAKlvHIsuj4SvnKQ6Mk4"
BUCKET = "dgrsvoices"
REGION = "us-east-2"
S3_PREFIX = "Antiquarian Voices"
...
EMOTIONS = {
    "warm": {
        ...
        "style": 0.35,
        "prefix": "*warm grandfatherly wisdom, choosing each word carefully* "
    },
    "grave": {
        "stability": 0.4,
        "similarity_boost": 0.78,
        "style": 0.45,
        "prefix": "*grave, delivering devastating news with infinite kindness* "
    },
    "wondering": {
        "stability": 0.35,
        "similarity_boost": 0.75,
        "style": 0.5,
        "prefix": "*quiet wonder, seeing something beautiful in the timeline* "
    },
    "whispered": {
        "stability": 0.3,
        "similarity_boost": 0.72,
        "style": 0.4,
        "prefix": "*near whisper, the weight of all endings* "
    },
    "proud": {
        "stability": 0.45,
        "similarity_boost": 0.8,
        "style": 0.45,
        "prefix": "*proud, the teacher watching the student surpass them* "
    }
}
...
def main():
    with open(os.path.join(os.path.dirname(__file__), "antiquarian-lines.json")) as f:
        lines = json.load(f)
    ...
    manifest_path = os.path.join(os.path.dirname(__file__), "..", "shared", f"antiquarianVoManifest.json")
