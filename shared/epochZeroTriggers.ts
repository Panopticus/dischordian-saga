...
export const EPOCH_ZERO_DISCOVERIES: EpochZeroDiscovery[] = [
  ...
  },
  {
    ...
    npcDialogUnlocks: [
      {
        ...
        minTrust: 2,
        dialog:
          "The Meme pretended to defect to infiltrate the Insurgency — because it found deception more useful than loyalty. I have never " +
          "been able to decide if that is brilliant or terrifying.",
      },
    ],
    companionReactions: [
    ...
    yearOneConnections: [
      ...
      "PAC News Network broadcasts in Epoch 2 carry echoes of The Meme's feigned defection — dismissed as echoes of a ghost, a program running past its creator, but possibly something more.",
    ],
  },
  {
    episodeId: "ep0-3",
