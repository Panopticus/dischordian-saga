...
lines.push("];");
lines.push("");
lines.push("const TRACK_BY_ID = new Map(ALBUM1_TRACKS.map((t) => [t.id, t] as const));");
lines.push("");
...
lines.push("  const t = TRACK_BY_ID.get(id);");
...
lines.push("  return ALBUM1_TRACKS.filter((t) => t.act === act);");
lines.push("}");
lines.push("");
