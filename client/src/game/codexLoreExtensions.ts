...
const systemLoreEntries: CodexLoreExtension[] = [
  ...
  },
  {
    ...
    category: "multiverse",
    content: [
      "An intergalactic gambling station in Ne-Yon space — the only",
      "open zone. Stakes are Dream tokens, the currency of unrealized",
      "potential. Games include Pazaak-style card duels, dice of",
      "probability, and the Roulette of Realities.",
      "",
      "The proprietor is a charismatic host known only as 'The Degen.'",
      "His eyes are ancient and knowing. He pours drinks, deals cards,",
      "and speaks of entropy with the familiarity of an old friend.",
      "Some patrons swear the casino itself responds to his moods —",
      "lights flickering when he laughs, dice running cold when he",
      "grows quiet. Ne-Yon #8's domain is corruption and entropy.",
      "The house edge is just entropy wearing a suit.",
      "",
      "The house always wins — except when a Ne-Yon sits at the table.",
      "But what happens when a Ne-Yon IS the table?",
    ].join("\n"),
