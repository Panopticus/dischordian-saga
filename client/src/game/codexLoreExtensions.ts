...
const systemLoreEntries: CodexLoreExtension[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "the only open zone in Ne-Yon space. The Degen (Ne-Yon #8,",
      "domain: corruption and entropy) runs the house. Stakes are",
      ...
      "",
      "The proprietor is a charismatic host whose eyes betray an age",
      "no mortal barkeep should possess. He pours drinks, deals cards,",
      ...
      "grows quiet. The house edge is just entropy wearing a suit.",
      "",
