...
export const LOREDEX_UNLOCKS: LoredexUnlock[] = [
  ...
  {
    loredexEntryId: "entity_105",
    loredexEntryName: "Collector Clone-007",
    unlockType: "commentator",
    unlockId: "clone007_arena_host",
    unlockName: "Clone-007 Arena Commentary",
    description: "Collector Clone-007's theatrical commentary replaces default arena narration. Every bout becomes a showman's spectacle.",
  },
  {
    loredexEntryId: "entity_106",
    loredexEntryName: "Malkia Ukweli",
    unlockType: "enemy_theme",
    unlockId: "queen_of_truth_music",
    unlockName: "Queen of Truth Battle Theme",
    description: "Malkia Ukweli's voice unlocks as an alternate battle theme — her songs disrupt enemy formations and boost ally morale.",
  },
  {
    loredexEntryId: "entity_127",
    loredexEntryName: "The Mascoteers",
    unlockType: "chess_puzzle",
    unlockId: "celebration_puzzles",
    unlockName: "Celebration Chess Puzzles",
    description: "Gary the Ninth's shifting puzzle boxes become playable chess problems — solve them in ten moves or fewer.",
  },
  {
    loredexEntryId: "entity_120",
    loredexEntryName: "The Necromancer Returns",
    unlockType: "enemy_variant",
    unlockId: "risen_dead_variants",
    unlockName: "Risen Dead Enemy Variants",
    description: "The Necromancer's risen dead appear across all combat modes — spectral warriors, bone-armored tanks, and soul-drained healers.",
  },
  {
    loredexEntryId: "entity_124",
    loredexEntryName: "The Grand Edit",
    unlockType: "enemy_theme",
    unlockId: "corrupted_text_combat",
    unlockName: "Shadow Tongue Combat Corruption",
    description: "During The Grand Edit, enemy names and ability descriptions corrupt in real-time — you must fight what you cannot reliably read.",
  },
  {
    loredexEntryId: "entity_129",
    loredexEntryName: "Forge World",
    unlockType: "enemy_variant",
    unlockId: "forge_world_enemies",
    unlockName: "Forge World Automaton Enemies",
    description: "Industrial automaton enemies from Forge World's foundries appear in Terminus Swarm — heat-resistant, relentless, forge-tempered.",
  },
];
