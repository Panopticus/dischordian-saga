/* ═══════════════════════════════════════════════════════
   ...
   engineered by Zyr'Koth (Hierarchy SVP R&D) and
...
export const SOURCE_CALLBACKS: SourceCallback[] = [
  ...
  },
  {
    ...
    lines: {
      ...
      mid: "The Warlord. She held me down while Zyr'Koth poured the virus into my veins. She watched my humanity dissolve one memory at a time and she took notes. Clinical. Precise. She turned me into a weapon and then she was surprised when the weapon pointed itself at the hand that forged it. She created The Source because she needed a plague. She did not anticipate that the plague would develop a conscience.",
