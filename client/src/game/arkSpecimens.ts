...
export const SPECIMENS: Record<SpecimenId, SpecimenDef> = {
  lux: {
    ...
    basePalette: { body: "#33e2e6", accent: "#ffffff", energy: "#7dd3fc", eye: "#fbbf24" },
  ...
  cipher: {
    ...
    basePalette: { body: "#ef4444", accent: "#1a1a2e", energy: "#f87171", eye: "#00ff00" },
  ...
  gilt: {
    ...
    voidPhysics: { fragment: "flat", companion: "glass", ascended: "glass" },
    basePalette: { body: "#fbbf24", accent: "#78350f", energy: "#fde68a", eye: "#dc2626" },
  ...
  spore: {
    ...
    basePalette: { body: "#dc2626", accent: "#1a0a0a", energy: "#f87171", eye: "#22c55e" },
  ...
  echo: {
    ...
    voidPhysics: { fragment: "flat", companion: "glass", ascended: "glass" },
    basePalette: { body: "#22c55e", accent: "#064e3b", energy: "#86efac", eye: "#fbbf24" },
  ...
  glyph: {
    ...
    voidPhysics: { fragment: "flat", companion: "retro", ascended: "retro" },
    basePalette: { body: "#6366f1", accent: "#1e1b4b", energy: "#a5b4fc", eye: "#f59e0b" },
...
export const DYE_RECIPES: DyeRecipe[] = [
  { id: "dye_void", name: "Void Black", palette: { body: "#0a0a0f", accent: "#1a1a2e", energy: "#33e2e6" }, voidAtmosphere: "twilight_equilibrium", cost: { dream: 25 }, source: "craft" },
  ...
  { id: "dye_golden", name: "Golden Sanctuary", palette: { body: "#fbbf24", accent: "#78350f", energy: "#fde68a" }, voidAtmosphere: "golden_sanctuary", cost: { dream: 50 }, source: "craft" },
