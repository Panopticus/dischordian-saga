...
export const ARCHONS: ArchonDef[] = [
  ...
  { id: "meme", name: "The Meme", number: 5, yearCreated: "298 A.A.", status: "Contested", domain: "Internet control, cultural manipulation, thought influence", celebrationAlias: "Minnie", mechronisGuild: "The Influencers", appearance: "Neon-fused avatar with ever-changing fashion and glitching features", destroyedBy: "Believed destroyed by the White Oracle at the Panopticon, 10 years before the Fall — though the broadcasts never stopped", connections: ["The Warlord", "The Architect"], },
...
export const NEYONS: NeyonDef[] = [
  ...
  { id: "degen", name: "The Degen", era: "Late Empire", yearAppeared: "15,800 A.A.", status: "Active", domain: "Corruption, entropy, creating conditions for Ne-Yon dominance", appearance: "Chaotic, unpredictable presence — often manifests as a charismatic casino host with ancient, knowing eyes. His preferred mortal guise is the proprietor of an intergalactic gambling station in Ne-Yon space, where he deals cards and entropy in equal measure.", psychology: "An ancient cosmic entity who found gambling to be the purest expression of his domain. Believes entropy is the most honest game — every roll of the dice is a microcosm of universal decay. Chose to manifest as a casino owner because the house edge is just entropy wearing a suit. Creates chaos so the Ne-Yons can flourish in the aftermath. Players who earn his trust may begin to glimpse the god behind the bartender.", connections: ["The Ne-Yons", "Degen's Casino"], },
...
export const IDENTITY_CHAINS: IdentityChain[] = [
  ...
  },
  {
    ...
    chain: [
      ...
      { name: "Kael", era: "Fall Era (16,800 A.A.)", description: "Captured, imprisoned in Panopticon, infected via Project Vector (becoming Patient Zero), then escaped and stole Ark 1047" },
      { name: "The Source", era: "Fall Era (16,900 A.A.)", description: "Fully consumed by the Thought Virus he already carried. Sovereign of Terminus." },
    ],
  ...
  },
  {
    ...
    chain: [
      ...
      { name: "The White Oracle", era: "Fall of Reality (17,000 A.A.)", description: "Regained memories, destroyed the Warden and confronted the Meme at the Panopticon — the Meme's fate remains contested" },
    ],
    faction: "Insurgency",
  },
  {
...
export const HIERARCHY: HierarchyDemonDef[] = [
  ...
  { id: "nykoth", name: "Zyr'Voth", title: "The Flayer", rank: "SVP R&D", domain: "Thought Virus Engineering", mirrorsArchon: "The Necromancer", opposesNeyon: "The Human", color: "#10b981" },
...
export const MECHRONIS_GUILDS: MechronisGuildDef[] = [
  ...
  { name: "The Influencers", archonNumber: 5, leader: "The Meme",
    ...
    darkTruth: "They make people believe anything they want. The Meme was believed destroyed for feeling too much — though some say the shapeshifter simply found a new face. Graduates learn not to feel at all.",
    notableStudents: [],
    canonical: true },
  ...
  { name: "The Grey Gamers", archonNumber: 9, leader: "The Game Master",
    ...
    darkTruth: "They don't fight with fists. They twist reality, rewrite the rules. You live inside the Game Master's puzzle.",
    notableStudents: [],
    canonical: true },
...
export const ARK_1047 = {
  ...
  stolenBy: "Kael (already Patient Zero via Project Vector), during his escape from the Panopticon",
  viralContamination: "Thought Virus carried aboard by Kael himself — already infected by the Warlord through Project Vector before the theft. His presence contaminated the life support, cryo fluid, and water recycling systems from day one.",
