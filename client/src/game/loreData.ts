...
export const NEYONS: NeyonDef[] = [
  ...
  { id: "degen", name: "The Degen", era: "Late Empire", yearAppeared: "15,800 A.A.", status: "Active — the only Ne-Yon still in the known universe", domain: "Corruption, entropy, gambling, creating conditions for Ne-Yon dominance", appearance: "Chaotic, unpredictable presence — manifests as the owner and bartender of a floating casino on the edge of the Shield. His eyes betray an age no mortal barkeep should possess.", psychology: "An ancient cosmic entity (Ne-Yon #8) who found gambling to be the purest expression of his domain. Believes entropy is the most honest game — every roll of the dice is a microcosm of universal decay. Chose to manifest as a casino owner because the house edge is just entropy wearing a suit. Creates chaos so the Ne-Yons can flourish in the aftermath. Players gradually discover the bartender is a god — a major trust-gated reveal.", connections: ["The Ne-Yons", "Degen's Casino", "The Shield"], },
