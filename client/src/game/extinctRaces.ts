...
export const EXTINCT_RACES: ExtinctRace[] = [
  ...
  {
    id: "iron_bloods",
    name: "The Iron Bloods",
    homeworld: "Ferrus Prime (consumed)",
    era: "Foundation Era (~12,000 A.A.)",
    extinction: "Iron Lion's people. A warrior race with literal iron in their blood — their hemoglobin was ferromagnetic. The Warlord conquered them not through war but through magnetic weapons that turned their own blood against them. Iron Lion is the last survivor.",
    remnants: [
      { id: "iron_artifact", type: "artifact", name: "Ferromagnetic Heart", description: "An Iron Blood heart, still beating after 5,000 years. The iron in it responds to magnetic fields.", foundIn: "Agent Zero trust 40 investigation chain", revelation: "Iron Lion's mace is forged from the hearts of fallen Iron Bloods. Each swing carries the weight of an extinct civilization." },
      { id: "iron_dna", type: "dna", name: "Ferrous DNA", description: "DNA saturated with bioavailable iron. Their cells were natural magnets.", foundIn: "Cloning pod after collecting Iron Lion's Mace", revelation: "The Collector preserved enough Iron Blood DNA to rebuild the entire race. Iron Lion doesn't know." },
    ],
    aesthetic: "Metallic skin with natural iron patina, magnetic field auras, weapons grown from their own blood. Their architecture was grown from iron-rich soil.",
    uniqueTrait: "Ferromagnetic Biology — could manipulate metal through their blood. Natural armor. Natural weapons. Natural forges.",
    discoverableIn: ["armory", "agent_zero_trust", "fight_game", "cloning_pods"],
    expansionPotential: "Playable faction with magnetic/metal manipulation. Units pull enemy units toward them. Armor self-repairs.",
    palette: { primary: "#78350f", secondary: "#b45309", glow: "#f59e0b" },
  },
  {
    id: "echo_minds",
    name: "The Echo Minds",
