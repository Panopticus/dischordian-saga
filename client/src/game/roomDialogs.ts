...
export const MEDICAL_BAY_DIALOG: RoomDialogDef = {
  ...
  personalLayers: [
    ...
    { minTrust: 80, text: "I've been running comparative analysis on Kael's blood and the Thought Virus in the cryo fluid. They're related but not identical. The virus in the cryo fluid is older. A different strain. Engineered. The blood tells me Kael was already infected when he arrived — but the ship was contaminated before he ever set foot on it. Dr. Lyra Vox built the virus INTO the ship. The life support, the cryo fluid, the water recyclers. This Ark wasn't repurposed as a weapon. It was BUILT as one. And every Potential in those pods has been breathing dormant Thought Virus for centuries. Including you.", speaker: "elara", oneShot: true },
  ],
