...
export const AMBIENT_REFERENCES: AmbientReference[] = [
  ...
  { id: "zero_playbook", npcId: "agent_zero", minTrust: 75,
    context: "shared_silence",
    text: "*long pause* Someone sent me his playbook before Zenon. The Game Master's. Every trap. Every escape route. Forty-two contingencies. I walked through his defenses like I'd built them. *static* I didn't think about who sent it until after. The cover note said 'Compliments of the Hierarchy of the Damned. We always collect.' *pause* They collected his Goggles within the hour. I was just the delivery mechanism.",
    backstoryReference: "The Hierarchy betrayed the Game Master by sending Agent Zero his strategic playbook", oneTime: true },
  { id: "zero_contract", npcId: "agent_zero", minTrust: 85,
    context: "deep_trust",
    text: "*static* He said something before the end. The Game Master. He looked at the playbook in my hands — his own handwriting — and said: 'They honored the contract. Every clause.' *long pause* He wasn't angry at me. He was angry at himself. For not reading Xeth'Raal's fine print. *pause* I've never felt sorry for an Archon before. I felt something close.",
    backstoryReference: "The Game Master's last words — recognizing the Hierarchy's contractual betrayal", oneTime: true },
  ...
  { id: "locke_eye_patch_origin", npcId: "adjudicator_locke", minTrust: 70,
    context: "shared_silence",
    text: "You're wondering about the eye. Everyone wonders. I made one trade I shouldn't have. With someone I trusted. She took the eye as warranty. I got what I wanted. She kept the eye anyway. Now I understand contracts better. Not as well as Xeth'Raal, mind you. That demon once honored every clause of a protection contract while making sure the protected party died anyway. Gave the Game Master a safehouse and Agent Zero the key. Both parties satisfied. That's artistry.",
    backstoryReference: "Locke's eye patch origin story; references Xeth'Raal's betrayal of the Game Master", oneTime: true },
