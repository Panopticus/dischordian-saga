...
export const NPC_HOLIDAY_DIALOG: Record<string, NpcHolidayLines> = {
  degen: {
    ...
    onWin: "Winner winner, CHRISTMAS DINNER! Now — here's the part where I make my pitch. You COULD keep that. OR — you could give it to someone. The look on someone's face when they get an unexpected gift? That's worth more than anything in my casino. And I know the value of EVERYTHING. I've been appraising things since before your calendar started counting.",
  ...
  antiquarian: {
    welcome: "The Degen invited me to his casino. I attended. I did not gamble. I sat in the corner and watched — as I always do — and I saw something I have not seen in five Ages. I saw people giving things away without calculating the return. I saw generosity without strategy. I saw joy deployed as a weapon against despair. I also saw the host's eyes. I have catalogued every being in the known galaxy. Those eyes do not belong to a bartender. They belong to something far, far older. I received a gift. It was a book. I read it in one sitting. It concerns the transformation of ordinary objects into sacred vessels of meaning. I understand the premise intimately.",
  },
  shadow_tongue: {
