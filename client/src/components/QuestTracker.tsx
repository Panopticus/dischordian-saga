...
const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    description: "Use the Communication Relay in the Comms Array to visit the Comms Array and claim your first Potential's identity card.",
    icon: Radio,
    category: "main",
    order: 2.7,
    ...
    check: (s) => ({
      ...
      max: 1,
      hint: "Go to the Comms Array and interact with the Communication Relay. Explore the Comms Array.",
    }),
  },
  {
    id: "explore_5_rooms",
