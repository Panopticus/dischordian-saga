...
export const CLUES: Clue[] = [
  // ═══ BRIDGE PUZZLES ═══
  {
    ...
    description: "A data crystal containing the Inception Ark's original designation: ARK-1047. The number 1047 appears repeatedly in the Ark's systems — hull plates, corridor junctions, even the cryo pod count. It's not a coincidence.",
  ...
  },
  {
    ...
    description: "A partial binary sequence: 10000010111. When decoded, it reads '1047' in decimal. The Ark's power relays require a binary authentication code based on the ship's designation.",
