  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-4 sm:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        {dominantGuild && (
          <div className="mb-4 p-3 rounded border border-amber-500/40 bg-amber-500/5">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {r.leadStreak > 0 && (
                      <span className="font-mono text-[8px] text-orange-400" title="Lead streak in weeks">
                        🔥 {r.leadStreak}w
                      </span>
                    )}
                    {isPlayer && (
        ...
        <div className="mt-6 p-3 rounded border border-border/30 bg-background/30">
          ...
          <ul className="space-y-1 font-mono text-[9px] text-muted-foreground/70 leading-relaxed">
            ...
            <li>▸ Leaders fatigue: the longer you lead, the slower you score (<span className="text-yellow-400">-5% per streak week</span>)</li>
            ...
            <div className="space-y-0.5">
              {houseState.winnerHistory.slice(-5).reverse().map(w => (
                <div key={w.week} className="flex items-center justify-between font-mono text-[9px]">
                  ...
                  <span className="text-amber-400 tabular-nums">{w.finalScore.toLocaleString()} pts</span>
                </div>
              ))}
            </div>
          </div>
