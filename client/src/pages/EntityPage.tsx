            ...
            <div className="flex flex-wrap gap-2">
              ...
              {entry.streaming_links.tidal && (
                <a href={entry.streaming_links.tidal} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-muted/50 border border-border text-foreground text-xs font-mono hover:bg-foreground/15 transition-all">
