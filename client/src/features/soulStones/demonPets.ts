...
export const DEMON_PETS: DemonPet[] = [
...

  {
    ...
    description:
      "A sensory organ of Ny'Koth the Flayer. It strips away the veil, revealing enemy health, weaknesses, and hidden abilities. But the Lens sees everything — including your own failures. Expect random 'insight events' replaying your worst moments in vivid detail.",
    necromancerDialog:
      "The Flayer's eye sees all truth. Enemy weaknesses, hidden traps, secret doors — nothing is hidden from it. But Ny'Koth believes that all truth should be seen, including yours. It will show you things you've failed at. Things you've lost. Are you prepared to see clearly?",
    artPrompt:
