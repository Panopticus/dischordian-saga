...
export const ROOM_DEFINITIONS: RoomDef[] = [
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "captains-master-key", name: "Captain's Master Key", description: "A heavy magnetic key hidden in a compartment beneath the captain's armrest.", x: 48, y: 72, width: 6, height: 6, type: "item", action: "captains-master-key", elaraDialog: "The Captain's Master Key! It was hidden in a compartment beneath the armrest — exactly where a captain would keep their most important tool. This key opens the Captain's Quarters, the most restricted area on the ship. Whatever secrets Captain Voss was hiding, they're behind that door." },
