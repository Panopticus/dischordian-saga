...
### 1. LOREDEX DISCOVERY (13 of 18 missing)
Programmer, Architect, CoNexus, Watcher, Collector, Warlord, Enigma, Engineer, Necromancer, Human, Source, Antiquarian, Degen — all have Kling prompts in DiscoveryVideoOverlay.tsx

### 2. STORY MODE FIGHTS (17 of 21 missing)
...
### 3. DEAD MAN'S CIRCUIT (6 missing)
circuit-opens, clone-awakening, the-race, signal-lost, severance-prize, nilmorg-speaks

### 4. LIVING UNIVERSE EVENTS (5 missing)
necromancer-returns, dreamer-awakens, terminus-advance, antiquarian-reveals, shadow-tongue-edits

### 5. CREW AWAKENING (3 missing)
first-clone-born (Elara), 93847-sunrises (Elara solo), the-mandate (Elara + Player)

### 6. PRESTIGE CYCLE (1 missing)
the-reset (Player, Elara, Human, Antiquarian)

### 7. COMPANION DEATH (1 missing)
signal-lost (Any companion, Player)

**TOTAL: 46 cinematics needed. Full Kling prompts in PAGE_BACKGROUND_ART_PROMPTS.md and inline in source code.**

### Characters by appearance count:
Player (24), Elara (5), Nilmorg (4), Necromancer (3), Source/Kael (3), Meme (3), Collector (3), Antiquarian (3), Human (2), Iron Lion (2), Agent Zero (2), Watcher (2), Shadow Tongue (2), Dreamer (2), Game Master (2), Warlord (1), Enigma (1), Engineer (1), Degen (1), Jailer (1)
