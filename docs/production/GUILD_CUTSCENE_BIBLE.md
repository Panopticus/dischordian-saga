...
- **Common-room repaint**: replace the PLACEHOLDER-14 art flagged in
  `docs/production/SHIP_READY_ASSET_BIBLE.md` with 12 finished guild
  common-room paintings (one per Archon Guild) at 1920×1080.
...
- `docs/production/SHIP_READY_ASSET_BIBLE.md` — replace PLACEHOLDER-14 entries
  with the 12 new common-room paintings and the 28 cutscene catalogue rows
...
- **Phase 6**:
  ...
  - Confirm the 12 common-room paintings load on `/guild/common-room` with no layout
    shift; check the PLACEHOLDER-14 entries in
    `docs/production/SHIP_READY_ASSET_BIBLE.md` are gone.
