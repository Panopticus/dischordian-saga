...
# Section 5 — Per-Game-Mode Asset Index

Every game mode from the audit, with inline cross-references to the cutscene/art/VO rows elsewhere in this bible that apply to it. Use this as the quick lookup when you're producing assets for a specific mode.

| # | Game mode | Route | Completion | Cutscenes | Art | VO | Ship status |
|---|---|---|---|---|---|---|---|
| 1 | Main Arena / Collector's Arena | `/fight` | 90% | §2.1 CIN-005, CIN-006, §2.2 CIN-017, CIN-021 | §3.1 all fighter sheets, §3.3 ART-E19 to E22 | VP-11 Collector Clone-007 lines | P0 |
| 2 | Chess (Architect's Gambit) | `/chess` | 95% | PLACEHOLDER-02 intro | §3.6 ART-CH01 chess pieces | — | READY |
| 3 | Dischordia Card Game | `/duelyst` | 95% | PLACEHOLDER-01 intro | — | — | READY |
| 4 | PvP Card Arena | `/pvp` | 95% | PLACEHOLDER-06 intro | §3.3 ART-E06 to E08, §3.5.3 rank badges | — | P1 |
| 5 | Trade Empire | `/trade-empire` | 100% | PLACEHOLDER-09 intro | §3.3 ART-E15 to E18 (exist on Cloudinary), §3.5.5 currency icons | VP-04 Locke | READY |
| 6 | Tower Defense / Terminus | `/tower-defense` | 40% | Existing Tower Defense cinematics (already shipped) | §3.5/3.6 sprite fills TBD | — | P1 |
| 7 | Dead Man's Circuit | `/circuit` | 50% | §2.3 CIN-031 to CIN-036 (all 6) | DMC environments exist on Cloudinary | VP-14 Nilmorg (complete) | P0 |
| 8 | Degen's Casino | `/casino` | 30% | CIN-013 Degen discovery | §3.3 ART-E27 permanent floor | VP-10 Degen | P1 |
| 9 | Palimpsest Episodes | `/palimpsest` | 100% | Epoch 0 cinematics (shipped) | §3.7 Witnessing slideshows | VP-09 Meme (complete), Palimpsest Host | READY |
| 10 | Hacking Puzzle | `/hacking` | 70% | PLACEHOLDER-04 intro | §3.6 ART-MG01 hacking grid | — | P2 |
| 11 | Signal Decryption | `/signal-decryption` | 70% | PLACEHOLDER-07 intro | §3.6 ART-MG01 signal waveform | — | P2 |
| 12 | Alliance War | `/alliance-war` | 80% | — | — | — | READY |
| 13 | Gamemaster's Arena | `/gamemasters-arena` | 90% | CIN-020 Game Master intro | §3.1 ART-F03 Game Master | — | P1 |
| 14 | Star Chart | `/star-chart` | 60% | PLACEHOLDER-08 intro | §3.6 ART-PL01 planet thumbnails, §3.6 ART-CN01 constellations | — | P2 |
| 15 | Bestiary / Specimen Collection | `/bestiary` | 85% | — | Existing specimen art | — | READY |
| 16 | Bounty Board | `/bounties` | 80% | — | — | — | READY |
| 17 | Pet Battles | `/pet-battles` | 40% | PLACEHOLDER-05 intro | §3.3 ART-E01 to E05, §3.5.1 ART-PB01 to PB05 | — | P1 |
| 18 | Draft Tournament | `/draft` | 95% | — | — | — | READY |
| 19 | Research Minigame | `/research-minigame` | 75% | — | §3.6 ART-MG01 | — | P2 |
| 20 | Essence Harvest | `/collectors-ledger` | 85% | — | — | — | READY |
| 21 | Faction War | `/faction-wars` | 85% | — | §3.5.5 ART-TR02 faction emblems, §3.6 ART-LG01 | — | READY |
| 22 | CADES FPS | `/cades-fps` | 60% | — | — | (existing cades-lines.json) | P2 |
| 23 | Coop Raids | `/coop-raids` | 80% | — | §3.3 ART-E23 to E26 | — | P1 |
| 24 | Friendly Challenges | `/friendly-challenges` | 95% | — | — | — | READY |
| 25 | Boss Battle / Boss Mastery | `/boss-battle` | 85% | §2.2 CIN-014, CIN-015, CIN-022, CIN-023 | §3.3 ART-E19 to E22 | Boss character VO per §4.2 | P0 |
| 26 | Competitive Arena | `/competitive-arena` | 95% | — | §3.5.3 rank badges | — | READY |
| 27 | Soul Stones | `/soul-stones` | 70% | — | §3.4 soul stones (3) | — | P2 |
| 28 | Seasonal Events (Xmas in July, etc.) | `/seasonal-events` | 85% | — | Existing holiday assets | — | READY |
| 29 | Vortex Incursion | `/vortex-incursion` | 75% | — | — | — | P2 |
| 30 | Card Challenges | `/card-challenge` | 95% | — | — | — | READY |
| 31 | Card Trading | `/trading` | 95% | — | — | — | READY |
| 32 | Witnessing (Community Narrative) | `/witnessing` | 5% ⚠️ | §2.4 CIN-037 to CIN-041 living universe events | §3.7 ALL 73 slideshow frame images | VP-09 Meme, VP-08 Narrator | P0 ⚠️ |
| 33 | Prestige Quests | `/prestige-quests` | 80% | §2.6 CIN-045 the-reset | — | — | P0 |
| 34 | Companion Death (generic) | `/companion` | — | §2.6 CIN-046 signal-lost | — | — | P1 |
| 35 | Crew Awakening | `/awakening` | — | §2.5 CIN-042 to CIN-044 | §3.5 ART-RM01 (awakening room) | VP-01 Elara full awakening sequence | P0 |
| 36 | Bridge Console (Hub) | `/` | 95% | — | Existing bridge art | VP-01 Elara greetings | READY |
| 37 | Deck Builder | `/deck-builder` | 95% | — | — | — | READY |
| 38 | Character Sheet | `/character-sheet` | 95% | — | — | — | READY |
| 39 | Inventory | `/inventory` | 90% | — | — | — | READY |
| 40 | Settings | `/settings` | 100% | — | — | — | READY |
| 41 | Player Profile | `/profile` | 95% | — | §3.5.3 rank badges | — | READY |
| 42 | Marketplace | `/marketplace` | 85% | — | §3.5.5 currency icons | — | READY |
| 43 | Leaderboards | `/leaderboard` | 95% | — | §3.5.3 rank badges | — | READY |
| 44 | Guild Hall / Common Room | `/guild` | 90% | PLACEHOLDER-14 intro | §3.6 ART-LG01 logos | — | READY |
| 45 | Quest Board | `/quests` | 85% | — | — | — | READY |
| 46 | Ark Explorer / Conexus Portal | `/ark` | 80% | §2.7 PLACEHOLDER-29 generic room-enter | §3.6 ART-RM01 8 new rooms | VP-01 Elara room dialogs | P1 |
| 47 | Codex / Lore Journal | `/codex` | 95% | §2.1 CIN-001 to CIN-013 discovery videos | — | Optional narration | READY |
| 48 | Achievements / Trophy Room | `/achievements` | 90% | — | §3.6 ART-RD01 milestone icons | — | READY |

**Legend:**
- **Completion** — from the game mode audit (percent of feature complete)
- **Ship status** — P0 = blocks ship, P1 = degrades experience, P2 = polish, READY = ship-ready now

**Top ship-blockers (P0):** Main Arena (§3.1 fighters), Dead Man's Circuit (§2.3), Witnessing slideshow frames (§3.7), Boss Battle (§2.2 + §3.3 arena art), Crew Awakening (§2.5 + VP-01 Elara), Prestige (§2.6 reset cutscene), Codex discovery videos (§2.1).
