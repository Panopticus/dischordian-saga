...
(sized 2560×1440 and 256×256 respectively). Replacement CADES-themed
artwork is tracked separately — `project.godot` already uses the correct
product name (`CADES UNIT — Inception Ark 1047`).
